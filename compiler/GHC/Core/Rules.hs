...
import GHC.CoreTypes.Id.Info              ( RuleInfo( RuleInfo ) )
...
import qualified GHC.CoreTypes.Type.Unify as Unify
import GHC.CoreTypes.BasicTypes           ( Activation, CompilerPhase, isActive
                                       , pprRuleName )
...
mkRule this_mod is_auto is_local name act fn bndrs args rhs
  ...
  where
        -- Compute orphanhood.
        -- See Note [Orphans] in GHC.CoreTypes.Instance
