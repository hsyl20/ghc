...
import GHC.Types.TyCon      ( tyConDataCons_maybe, isEnumerationTyCon
                                       , isNewTyCon , unwrapNewTyCon_maybe
                                       , tyConDataCons )
import GHC.Types.DataCon      ( DataCon, dataConTagZ, dataConTyCon
                                       , dataConWorkId )
...
import GHC.Utils
import GHC.Types.Coercion (mkUnbranchedAxInstCo,mkSymCo,Role(..))
