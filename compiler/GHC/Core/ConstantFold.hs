...
import GHC.CoreTypes.TyCon      ( tyConDataCons_maybe, isEnumerationTyCon
...
import GHC.CoreTypes.Name                 ( Name, nameOccName )
...
import GHC.Util
import GHC.CoreTypes.Coercion (mkUnbranchedAxInstCo,mkSymCo,Role(..))
...
-- See Note [magicDictId magic] in GHC.CoreTypes.Id.Make
...
tx_lit_con _      _      alt        = pprPanic "caseRules" (ppr alt)
   ...
   -- (See Note [Word/Int underflow/overflow] in GHC.CoreTypes.Literal and #13172).
