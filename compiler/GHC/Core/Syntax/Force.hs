...
import GHC.CoreTypes.Demand         ( seqDemand, seqStrictSig )
import GHC.CoreTypes.BasicTypes     ( seqOccInfo )
import GHC.CoreTypes.Var.Set        ( seqDVarSet )
import GHC.CoreTypes.Var            ( varType, tyVarKind )
import GHC.CoreTypes.Type           ( seqType, isTyVar )
import GHC.CoreTypes.Coercion       ( seqCo )
import GHC.CoreTypes.Id             ( Id, idInfo )
