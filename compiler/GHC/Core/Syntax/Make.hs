...
import GHC.Haskell.TypeCheck.Type ( mkSpecSigmaTy )
import GHC.Types.Type
import GHC.Types.Coercion             ( isCoVar )
import GHC.Builtin.Primitive.Types
import GHC.Types.DataCon      ( DataCon, dataConWorkId )
import GHC.Types.Id.Info              ( vanillaIdInfo, setStrictnessInfo,
                                         setArityInfo )
...
--   See GHC.Core.Syntax Note [Core syntax let/app invariant]
...
-- See Note [WildCard binders] in GHC.Core.Simplify.Environment
...
data FloatBind
  ...
  | FloatCase CoreExpr Id AltCon [Var]
      -- case e of y { C ys -> ... }
      -- See Note [Floating cases] in GHC.Core.LevelSet
