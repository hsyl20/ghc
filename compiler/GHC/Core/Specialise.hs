...
{-# LANGUAGE CPP #-}
module GHC.Core.Specialise ( specProgram, specUnfolding ) where

#include "HsVersions.h"

import GHC.Types.Id
import GHC.Haskell.TypeCheck.Type hiding( substTy )
import GHC.Types.Type                 hiding( substTy, extendTvSubstList )
import GHC.Types.Module              ( Module, HasModule(..) )
import GHC.Types.Coercion            ( Coercion )
...
import GHC.Types.Var.Free            ( InterestingVarFun )
           ...
           ; let
                ...
                (spec_inl_prag, spec_unf)
                  ...
                  = (neverInlinePragma, noUnfolding)
                        -- See Note [Specialising imported functions] in
                        -- GHC.Core.Occurence
