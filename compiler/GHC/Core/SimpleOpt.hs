...
import GHC.Types.Type         hiding ( substTy, extendTvSubst, extendCvSubst
                                      , extendTvSubstList , isInScope
                                      , substTyVarBndr, cloneTyVarBndr )
import GHC.Types.Coercion     hiding ( substCo, substCoVarBndr )
import GHC.Types.TyCon     ( tyConArity )
...
-- GHC.Core.Substitution.substIdBndr carefully does not do)
