...
import GHC.CoreTypes.Type.Internal       -- checks validity of types/coercions
import GHC.CoreTypes.TyCon as TyCon
import GHC.CoreTypes.Coercion.Axiom
import GHC.CoreTypes.BasicTypes
import GHC.Util.Error as Err
import GHC.Data.List.SetOps
import GHC.Builtin.Names
import GHC.Util.Outputable as Outputable
import GHC.Data.FastString
import GHC.Util
import GHC.CoreTypes.Instance     ( instanceDFunId )
import GHC.CoreTypes.Coercion.Optimise ( checkAxInstCo )
import GHC.Data.UniqueSupply
import GHC.Core.Arity   ( typeArity )
import GHC.CoreTypes.Demand            ( splitStrictSig, isBotRes )
...
in, say, GHC.Core.Subst.simpleOptPgm, which in some
circumstances can run immediately before Float Out.

All that said, currently GHC.Core.Subst.simpleOptPgm is
...
lintTyApp fun_ty arg_ty
  ...
  = do  { lintTyKind tv arg_ty
        ...
        -- See Note [The substitution invariant] in GHC.CoreTypes.Type.Internal
...
lint_app doc kfn kas
    = do { in_scope <- getInScope
         ...
         -- Note [The substitution invariant] in GHC.CoreTypes.Type.Internal
       ...
       ; case (splitForAllTy_maybe s, splitForAllTy_maybe t) of
         ...
         { (Just (tc_s, tys_s), Just (tc_t, tys_t))
             ...
             , isInjectiveTyCon tc_s r
                 -- see Note [NthCo and newtypes] in GHC.CoreTypes.Type.Internal
...
~~~~~~~~~~~~~~~~~~~~~~~~~~
See Note [Grand plan for static forms] in GHC.Util.CodeGen.StaticPtrTable for
an overview.
