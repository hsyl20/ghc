...
module GHC.Core.Inliner (
        ...
        -- Reexport from GHC.Core.Substitution (it only live
...
import GHC.Types.BasicTypes           ( Arity, InlineSpec(..)
                                       , inlinePragmaSpec )
...
and similar friends.
See Note [Bottoming floats] in GHC.Core.LevelSet.
...
litSize :: Literal -> Int
-- Used by GHC.Core.Inliner.sizeExpr
