...
in work_fn! See GHC.Core.Inliner.mkWorkerUnfolding.
 ...
 * We want them to be still there at the end of GHC.Core.Demand, so that
...
Note [Final Demand Analyser run] in GHC.Core.Demand).
