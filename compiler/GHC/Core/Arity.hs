...
import GHC.Types.TyCon ( initRecTc, checkRecTc )
...
Why is this important?  Because
  - In GHC.Interface.Tidy we use exprArity to fix the *final
...
GHC.Interface.Tidy, at least for top-level bindings, in which
...
See Note [Dictionary-like types] in GHC.Haskell.TypeCheck.Type for why we
