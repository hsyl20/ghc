...
\section[GHC.Core.Monad]{The core pipeline monad}
-}
...
import GHC.Haskell.TypeCheck   ( initTcForLookup )
import GHC.Core.Syntax
import GHC.Types.Base
import GHC.Types.Module
import GHC.Config.Flags
import GHC.Types.BasicTypes        ( CompilerPhase(..) )
...
-- See comments in GHC.Core.Simplify.Monad
data SimplifierMode
  = SimplMode
