...
\section[GHC.Core.Simplify.Monad]{The simplifier Monad}
-}

{-# LANGUAGE CPP #-}

module GHC.Core.Simplify.Environment (
        -- * The simplifier mode
        setMode, getMode, updMode, seDynFlags,

        -- * Environments
        GHC.Core.Simplify.Environment.SimplEnv(..),
        StaticEnv, pprSimplEnv,   -- Temp not abstract
        mkSimplEnv, extendIdSubst,
        GHC.Core.Simplify.Environment.extendTvSubst,
        GHC.Core.Simplify.Environment.extendCvSubst,
...
import GHC.Types.Type hiding         ( substTy, substTyVar, substTyVarBndr )
import qualified GHC.Types.Coercion as Coercion
import GHC.Types.Coercion hiding     ( substCo, substCoVar, substCoVarBndr )
import GHC.Types.BasicTypes
import GHC.Utils.Monad
import GHC.Utils.Outputable
import GHC.Utils
import GHC.Data.UniqueFM             ( pprUniqFM )
...
-- If you change this function look also at GHC.Core.FloatIn.noFloatFromRhs
