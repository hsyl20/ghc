...
import GHC.CoreTypes.Id              ( Id, mkSysLocalOrCoVar )
import GHC.CoreTypes.Id.Info         ( IdDetails(..), vanillaIdInfo, setArityInfo )
import GHC.CoreTypes.Type            ( Type, mkLamTypes )
...
import GHC.Util.Panic            (throwGhcExceptionIO, GhcException (..))
import GHC.CoreTypes.BasicTypes      ( IntWithInf, treatZeroAsInf, mkIntWithInf )
