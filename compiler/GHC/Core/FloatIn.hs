...
************************************************************************
*                                                                      *
\section[GHC.Core.FloatIn]{Floating Inwards pass}
*                                                                      *
************************************************************************
...
module GHC.Core.FloatIn ( floatInwards ) where
...
import GHC.Types.BasicTypes ( RecFlag(..), isRec )
...
GHC.Core.LevelSet module, which tags things with their level
numbers.
\item
