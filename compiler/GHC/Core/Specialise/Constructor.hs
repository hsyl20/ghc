...
module GHC.Core.Specialise.Constructor (
        specConstrProgram,
...
import GHC.Types.TyCon       ( tyConName )
import GHC.Types.Id
import GHC.Core.Printer              ( pprParendExpr )
import GHC.Core.Syntax.Make          ( mkImpossibleExpr )
...
~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  Note [Auto-specialisation and RULES] in GHC.Core.Specialise.
...
callToPats env bndr_occs (Call _ args con_env)
  ...
  = do  { let in_scope      = substInScope (sc_subst env)
        ...
        ; let pat_fvs       = exprsFreeVarsList pats
                ...
                -- considerations See Note [Unique Determinism] in
                -- GHC.Types.Unique.
...
argToPat env in_scope val_env (Case scrut _ _ [(_, _, rhs)]) arg_occ
  | exprOkForSpeculation scrut  -- See Note [Matching cases] in
                                -- GHC.Core.Rules
