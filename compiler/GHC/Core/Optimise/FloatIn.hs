...
************************************************************************
*                                                                      *
\section[GHC.Core.Optimise.FloatIn]{Floating Inwards pass}
*                                                                      *
************************************************************************
...
module GHC.Core.Optimise.FloatIn ( floatInwards ) where
...
GHC.Core.Optimise.LevelSetting.hs module, which tags things with their level numbers.
\item
  ...
  where
    ...
    go (bind_w_fvs@(FB bndrs bind_fvs bind) : binds) drop_boxes@(here_box : fork_boxes)
        ...
        where
          ...
          new_fork_boxes = zipWithEqual "GHC.Core.Optimise.FloatIn.sepBinds" insert_maybe
