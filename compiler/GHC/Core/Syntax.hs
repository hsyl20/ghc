...
-- | GHC.Core.Syntax holds all the main data types for use by for the Glasgow
...
import GHC.CoreTypes.Name.Environment  ( NameEnv, emptyNameEnv )
...
import GHC.CoreTypes.SrcLoc            ( RealSrcSpan, containsSpan )
...
string bindings; anything else and things break. GHC.Core.Lint
...
See Note [Levity polymorphism checking] in GHC.HaskellToCore.Monad to
...
data Tickish id =
  ...
  | Breakpoint
    ...
    , breakpointFVs    :: [id]  -- ^ the order of this list is important:
                                ...
                                -- appropriate entry in GHC.CoreTypes.Base.ModBreaks.
                                --
...
GHC.Core.Rules, but GHC.Core.FreeVars,
GHC.Core.Subst, GHC.Core.Printer,
...
data CoreRule
  = Rule {
        ...
        ru_auto :: Bool,   -- ^ @True@  <=> this rule is auto-generated
                           ...
                           -- GHC.Interface.Tidy for the sole
...
data Unfolding
  ...
  | BootUnfolding      -- ^ We have no information about the unfolding, because
                       ...
                       -- GHC.CoreToInterface for what this is used
                       -- for.
...
data UnfoldingSource
  ...
  | InlineCompulsory   -- Something that *has* no binding, so you *must* inline it
                       ...
                       -- (see GHC.CoreTypes.Id.Make, calls to mkCompulsoryUnfolding).
...
See also Note [Inlining an InlineRule] in GHC.Core.Inliner.
...
-- 'GHC.Core.Syntax.Make.mkIntExpr'
...
-- 'GHC.Core.Syntax.Make.mkWordExpr'
...
-- 'GHC.Core.Syntax.Make.mkFloatExpr'
...
-- 'GHC.Core.Syntax.Make.mkDoubleExpr'
...
-- use 'GHC.Core.Syntax.Make.mkCoreLets' if possible, which does guarantee
-- the invariant
mkLets        :: [Bind b] -> Expr b -> Expr b
-- | Bind all supplied binders over an expression in a nested lambda expression.
-- Prefer to use 'GHC.Core.Syntax.Make.mkCoreLams' if possible
...
-- "GHC.Core.Syntax#type_let", this can only be used to bind something in a
