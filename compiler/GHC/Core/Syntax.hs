...
but GHC.Core.FreeVars, Subst, GHC.Core.PrettyPrint, CoreTidy also inspect the representation.
-}
...
-- This type should be treated as abstract everywhere except in "GHC.Core.Transform.Unfolding"
data Unfolding
...
data UnfoldingGuidance
  = UnfWhen {   -- Inline without thinking about the *size* of the uf_tmpl
                ...
                -- See Note [INLINE for small functions] in GHC.Core.Transform.Unfolding
...
See also Note [Inlining an InlineRule] in GHC.Core.Transform.Unfolding.
