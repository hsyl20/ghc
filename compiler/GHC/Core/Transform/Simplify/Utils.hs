...
\section[GHC.Core.Transform.Simplify.Utils]{The simplifier utilities}
-}

{-# LANGUAGE CPP #-}

module GHC.Core.Transform.Simplify.Utils (
        -- Rebuilding
...
mkRhsStop :: OutType -> SimplCont       -- See Note [RHS of lets] in GHC.Core.Transform.Unfolding
...
contArgs cont
  ...
  | otherwise = go [] cont
  where
    lone (ApplyToTy  {}) = False  -- See Note [Lone variables] in GHC.Core.Transform.Unfolding
      ...
      = case splitStrictSig (idStrictness fun) of
          (demands, result_info)
                ...
                ->      -- Enough args, use the strictness given.
                        ...
                        -- inlining lone variables, so its ok (see GHC.Core.Transform.Simplify.Utils.analyseCont)
...
interestingCallContext cont
  ...
  where
    ...
    interesting (ApplyToVal {}) = ValAppCtxt
        ...
        -- in GHC.Core.Transform.Unfolding
...
and treat them specially. The real work is done in GHC.Core.Transform.Simplify.Utils.abstractFloats,
