...
\section[GHC.Core.Transform.Simplify.Monad]{The simplifier Monad}
-}

{-# LANGUAGE CPP #-}

module GHC.Core.Transform.Simplify.Environment (
        -- * The simplifier mode
        setMode, getMode, updMode,

        -- * Environments
        GHC.Core.Transform.Simplify.Environment.SimplEnv(..),
        StaticEnv, pprSimplEnv,   -- Temp not abstract
        mkSimplEnv, extendIdSubst,
        GHC.Core.Transform.Simplify.Environment.extendTvSubst,
        GHC.Core.Transform.Simplify.Environment.extendCvSubst,
...
-- If you change this function look also at GHC.Core.Transform.FloatIn.noFloatFromRhs
