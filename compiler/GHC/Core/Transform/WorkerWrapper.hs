...
{-# LANGUAGE CPP #-}
module GHC.Core.Transform.WorkerWrapper ( wwTopBinds ) where

import GHC.Core.Syntax
import GHC.Core.Transform.Unfolding       ( certainlyWillInline, mkWwInlineRule, mkWorkerUnfolding )
...
import GHC.Core.Transform.WorkerWrapper.Utils
import GHC.Utils
...
in work_fn! See GHC.Core.Transform.Unfolding.mkWorkerUnfolding.
...
inline into the worker's unfolding: see GHC.Core.Transform.Simplify.Utils
...
in w/w-ing because we'll simply add (\y:Void#), see GHC.Core.Transform.WorkerWrapper.Utils.mkWorerArgs.
