...
\section[GHC.Core.Transform.WorkerWrapper.Utils]{A library for the ``worker\/wrapper'' back-end to the strictness analyser}
-}

{-# LANGUAGE CPP #-}

module GHC.Core.Transform.WorkerWrapper.Utils
   ( mkWwBodies
   , mkWWstr
   , mkWorkerArgs
