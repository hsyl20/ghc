...
************************************************************************
*                                                                      *
\section[GHC.Core.Transform.FloatIn]{Floating Inwards pass}
*                                                                      *
************************************************************************
...
module GHC.Core.Transform.FloatIn ( floatInwards ) where
...
GHC.Core.Transform.LevelSetting.hs module, which tags things with their level numbers.
\item
  ...
  where
    ...
    go (bind_w_fvs@(FB bndrs bind_fvs bind) : binds) drop_boxes@(here_box : fork_boxes)
        ...
        where
          ...
          new_fork_boxes = zipWithEqual "GHC.Core.Transform.FloatIn.sepBinds" insert_maybe
