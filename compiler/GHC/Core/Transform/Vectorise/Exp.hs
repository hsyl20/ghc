...
module GHC.Core.Transform.Vectorise.Exp
...
import GHC.Core.Transform.Vectorise.Type.Type
import GHC.Core.Transform.Vectorise.Var
import GHC.Core.Transform.Vectorise.Convert
import GHC.Core.Transform.Vectorise.Vect
...
import GHC.Core.Transform.Vectorise.Utils
