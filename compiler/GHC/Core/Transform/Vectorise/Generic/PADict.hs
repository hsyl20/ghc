...
module GHC.Core.Transform.Vectorise.Generic.PADict
  ( buildPADict
  ) where

import GHC.Core.Transform.Vectorise.Monad
import GHC.Core.Transform.Vectorise.Builtins
import GHC.Core.Transform.Vectorise.Generic.Description
import GHC.Core.Transform.Vectorise.Generic.PAMethods ( buildPAScAndMethods )
