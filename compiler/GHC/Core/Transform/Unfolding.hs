...
module GHC.Core.Transform.Unfolding (
...
import GHC.Core.Transform.Simple
...
and similar friends.  See Note [Bottoming floats] in GHC.Core.Transform.LevelSetting.
...
(4) We must be much more cautious about arity-zero things. Consider
    ...
    but it doesn't fire for top-level things; see GHC.Core.Transform.Simplify.Utils
...
litSize :: Literal -> Int
-- Used by GHC.Core.Transform.Unfolding.sizeExpr
