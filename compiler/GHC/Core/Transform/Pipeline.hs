...
\section[GHC.Core.Transform.Pipeline]{Driver for simplifying @Core@ programs}
-}

{-# LANGUAGE CPP #-}

module GHC.Core.Transform.Pipeline ( core2core, simplifyExpr ) where
...
import GHC.Types
import GHC.Core.Transform.CommonSubExpr ( cseProgram )
import GHC.Core.Transform.Rules            ( mkRuleBase, unionRuleBase,
...
import GHC.Core.Analyse.Lint         ( endPass, lintPassResult, dumpPassResult,
                          lintAnnots )
import GHC.Core.Transform.Simplify         ( simplTopBinds, simplExpr, simplRules )
import GHC.Core.Transform.Simplify.Utils       ( simplEnvForGHCi, activeRule )
import GHC.Core.Transform.Simplify.Environment
import GHC.Core.Transform.Simplify.Monad
import GHC.Core.Monad
import qualified GHC.Utils.Error as Err
import GHC.Core.Transform.FloatIn          ( floatInwards )
import GHC.Core.Transform.FloatOut         ( floatOutwards )
...
import GHC.Core.Transform.LiberateCase     ( liberateCase )
import GHC.Core.Transform.StaticArgument   ( doStaticArgs )
import GHC.Core.Transform.Specialise       ( specProgram)
import GHC.Core.Transform.Specialise.Constructor       ( specConstrProgram)
