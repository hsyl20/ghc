...
module GHC.Core.Vectorise.Type.Env (
  vectTypeEnv,
) where
...
import GHC.Core.Vectorise.Type.TyConDecl
import GHC.Core.Vectorise.Type.Classify
import GHC.Core.Vectorise.Generic.PADict
