...
-- question. (See GHC.TypeCheck.Expression.tcArgs.) This argument
...
-- See also Note [ExpType] in GHC.TypeCheck.Util.Monadic
...
* ir_inst = False: do not instantiate
  ...
  We'll call GHC.TypeCheck.Expression.tcInferFun to infer the type
...
GHC.TypeCheck.Solver.Interact, function @occ_check_ok@.

Note [Non-TcTyVars in GHC.TypeCheck.Unify]
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
with "tc" in GHC.TypeCheck.TypeDecl"). By this time,
...
GHC.TypeCheck.Unify.checkTauTvUpdate, which wants to prevent
