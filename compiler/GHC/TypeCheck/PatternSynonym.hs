...
module GHC.TypeCheck.PatternSynonym
...
import GHC.TypeCheck.Signature  ( emptyPragEnv, completeSigFromId )
import GHC.TypeCheck.Environment
import GHC.TypeCheck.Util.Monadic
import GHC.TypeCheck.Syntax     ( zonkTyVarBindersX, zonkTcTypeToTypes
