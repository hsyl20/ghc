...
module GHC.TypeCheck.Splice where

import GHC.Prelude
import GHC.CoreTypes.Name
import GHC.Syntax.Expression   ( PendingRnSplice )
import GHC.TypeCheck.Util   ( TcM, SpliceType )
import GHC.TypeCheck.Util.CoreType    ( ExpRhoType )
import GHC.CoreTypes.Annotation              ( Annotation, CoreAnnTarget )
import GHC.Syntax.Extension    ( GhcTcId, GhcRn, GhcPs )

import GHC.Syntax ( HsSplice, HsBracket, HsExpr, LHsExpr, LHsType,
