...
tcInstDecls2 tycl_decls inst_decls
  = do  { -- (a) Default methods from class decls
        ...
        ; let dm_ids = collectHsBindsBinders dm_binds
              ...
              -- GHC.TypeCheck.TypeDeclUtil.tcAddImplicits)
 ...
 * Overall instance implication. There is an overall enclosing
   ...
   and superclasses.
   See GHC.TypeCheck.Simplify Note [Tracking redundant
   constraints]
...
GHC.TypeCheck.Validity.sizeTypes.
...
Answer:
  ...
  * (sc2) ScOrigin wanted constraints can't be solved from a
    ...
    implemented by
    GHC.TypeCheck.Solver.Interact.prohibitedSuperClassSolve
  ...
  * When we make a superclass selection from InstSkol we use
    ...
    in GHC.TypeCheck.Solver.Canonicalise.newSCWorkFromFlavored
...
tcMethod
- Make the method bindings, as a [(NonRec, GHC.Syntax.Bind)], one
  per method
