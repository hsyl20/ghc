...
module GHC.TypeCheck.Solver.Monad (
    ...
    -- GHC.TypeCheck.Simplify. I am wondering if the
...
import qualified GHC.TypeCheck.Instantiation as TcM
import GHC.CoreTypes.Instance
import GHC.TypeCheck.FamilyInstance as FamInst
...
import GHC.TypeCheck.Error   ( solverDepthErrorTcS )
...
The InertCans represents a collection of constraints with the following properties:
  ...
  * CTyEqCan equalities: see Note [Applying the inert substitution]
                         in GHC.TypeCheck.Solver.Flatten
...
GHC.TypeCheck.Solver.Monad.kickOutRewritable
...
rewrite Wanteds] in GHC.TypeCheck.Util), we may miss some
...
panicTcS doc = pprPanic "GHC.TypeCheck.Solver.Canonicalise" doc
...
-- Getters and setters of GHC.TypeCheck.Environment fields
-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
-- See Note [Bind new Givens immediately] in GHC.TypeCheck.Util
...
-- --------- Check done in GHC.TypeCheck.Solver.Interact.selectNewWorkItem???? ---------
...
from which we get the implication
   (forall a. t1 ~ t2)
See GHC.TypeCheck.Solver.Monad.deferTcSForAllEq
-}
