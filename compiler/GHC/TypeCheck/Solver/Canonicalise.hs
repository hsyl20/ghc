...
module GHC.TypeCheck.Solver.Canonicalise(
     canonicalize,
     unifyDerived,
...
import GHC.TypeCheck.Unify  ( swapOverTyVars, metaTyVarUpdateOK )
...
import GHC.TypeCheck.FamilyInstance   ( tcTopNormaliseNewTypeTF_maybe )
...
(see type Ct in GHC.TypeCheck.Util).
...
1. Eagerly generate superclasses for given (but not wanted)
   ...
   Note [Expanding superclasses] in GHC.TypeCheck.Util.CoreType.
...
3. If we have any remaining unsolved wanteds
   (see Note [When superclasses help] in GHC.TypeCheck.Util)
   ...
   GHC.TypeCheck.Simplify.expandSuperClasses.

4. Go round to (2) again.  This loop (2,3,4) is implemented
   in GHC.TypeCheck.Simplify.simpl_loop.
...
Note [Instance and Given overlap] in GHC.TypeCheck.Solver.Interact.
...
See Note [Rewrite insolubles] in GHC.TypeCheck.Solver.Monad.
And if we don't do this there is a bad danger that
GHC.TypeCheck.Simplify.applyTyVarDefaulting will find
