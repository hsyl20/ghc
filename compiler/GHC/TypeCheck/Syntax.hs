...
Specialisations of the @GHC.Syntax@ for the typechecker

This module is an extension of @GHC.Syntax@, for use in the type
checker.
-}
...
************************************************************************
*                                                                      *
\subsection[BackSubst-HsBinds]{Running a substitution over @GHC.Syntax.Bind@}
*                                                                      *
************************************************************************
...
GHC.TypeCheck.Util.Monadic.instSkolTyCoVarX.)
