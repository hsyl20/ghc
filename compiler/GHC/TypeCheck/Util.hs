...
Various types used during typechecking, please see GHC.TypeCheck.Monad as
...
*                                                                      *
    ...
    All the combinators for the monad can be found in GHC.TypeCheck.Monad
*                                                                      *
************************************************************************
...
type ThLevel = Int
    -- NB: see Note [Template Haskell levels] in GHC.TypeCheck.Splice
...
--    GHC.TypeCheck.Expression.checkClosedInStaticForm and
...
-- GHC.TypeCheck.Simplify uses them, and
-- GHC.TypeCheck.Simplify is fairly low down in the
-- module hierarchy
...
It happens, too!  See Note [Polymorphic methods] in GHC.TypeCheck.Class.
...
data Ct
  ...
  | CTyEqCan {  -- tv ~ rhs
       ...
       --     equalities] in GHC.TypeCheck.Solver.Canonicalise
  ...
  | CFunEqCan {  -- F xis ~ fsk
      ...
      cc_fsk    :: TcTyVar  -- [Given]  always a FlatSkolTv
        ...
        -- See Note [The flattening story] in GHC.TypeCheck.Solver.Flatten
    }

  | CNonCanonical {        -- See Note [NonCanonical Semantics] 
                           -- in GHC.TypeCheck.Solver.Monad
      cc_ev  :: CtEvidence
    }
...
built (in GHC.TypeCheck.Solver.Canonicalise).
...
*                                                                      *
                Wanted constraints
     These are forced to be in GHC.TypeCheck.Util because
...
the implication in
GHC.TypeCheck.Simplify.floatEqualities or
GHC.TypeCheck.Simplify.approximateImplications
...
a coercion that is used in a type. (See the comments in Note [Flattening] in GHC.TypeCheck.Solver.Flatten
...
"shadow" [D] in GHC.TypeCheck.Solver.Monad.maybeEmitShadow.
...
-- Note [Flavours with roles] in GHC.TypeCheck.Solver.Monad
...
data SkolemInfo
  ...
  | ArrowSkol           -- An arrow form (see GHC.TypeCheck.Arrow)
...
* Then when tidying in GHC.TypeCheck.Util.Monadic.tidySkolemInfo, we
