...
module GHC.TypeCheck.Util.CoreType (
  --------------------------------
  -- Types
...
-- See Note [ExpType] in GHC.TypeCheck.Util.Monadic, where you'll
...
-- GHC.TypeCheck.Expression .hs-boot file.
data SyntaxOpType
  = SynAny     -- ^ Any type
...
smart-app checking code --- see GHC.TypeCheck.Expression.tcIdApp
...
-- Called only in GHC.TypeCheck.Error; see Note [Runtime skolems]
-- there
isRuntimeUnkSkol x
...
-- GHC.TypeCheck.Solver.Canonicalise for details.
...
-- This function is here rather than in GHC.TypeCheck.Validity
-- because it is called from GHC.TypeCheck.Simplify,
-- which itself is imported by GHC.TypeCheck.Validity
...
See also GHC.TypeCheck.TypeDeclUtil.checkClassCycles.
...
-- GHC.TypeCheck.Solver.Canonicalise for the motivation for
-- this function.
