...
module GHC.TypeCheck.Util.Monadic (
...
-- as it's used in GHC.TypeCheck.Syntax in the presence of knots.
...
See Note [TcLevel assignment] in GHC.TypeCheck.Util.CoreType.
-}
  ...
  = ASSERT2( isMetaTyVar tv, ppr tv )
    do  { when debugIsOn (check_empty tv)
        ...
        ; let uniq        = getUnique tv
                ...
                -- important for GHC.TypeCheck.Type.splitTelescopeTvs to work properly
...
GHC.TypeCheck.Simplify.tcSimplifyInferCheck).
...
simplifier by GHC.TypeCheck.Module.tcRnSrcDecls calling
GHC.TypeCheck.Simplify.tcSimplifyTop.
...
zonkTyCoVar tv | isTcTyVar tv = zonkTcTyVar tv
   ...
   -- GHC.TypeCheck.Type.tcTyClTyVars, but it seems
...
Why?, for example:
- For CDictCan, the
  @GHC.TypeCheck.Simplify.expandSuperClasses@ step,
...
@GHC.TypeCheck.Solver.Canonicalise@ even if they come in as
...
-- See Note [SigSkol SkolemInfo] in GHC.TypeCheck.Util
