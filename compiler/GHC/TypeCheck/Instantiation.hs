...
module GHC.TypeCheck.Instantiation (
       deeplySkolemise,
...
import {-# SOURCE #-} GHC.TypeCheck.Expression( tcPolyExpr, tcSyntaxOp )
import {-# SOURCE #-} GHC.TypeCheck.Unify     ( unifyType, unifyKind )

import GHC.CoreTypes.BasicTypes ( IntegralLit(..), SourceText(..) )
...
import GHC.CoreTypes.Id.Make           ( mkDictFunId )
import GHC.CoreTypes.Id
import GHC.CoreTypes.Name
import GHC.CoreTypes.Var               ( EvVar, mkTyVar, tyVarName, TyVarBndr(..) )
...
-- See Note [DFunInstType: instantiating types] in GHC.CoreTypes.Instance
...
-- newOverloadedLit in GHC.TypeCheck.Unify
...
newClsInst overlap_mode dfun_name tvs theta clas tys
  = do { (subst, tvs') <- freshenTyVarBndrs tvs
       ...
       ; let tys' = substTys subst tys
             ...
             --     an InstInfo, and in
             --     GHC.TypeCheck.Environment.pprInstInfoDetails
