...
module GHC.TypeCheck.Environment(
...
-- See Note [Bindings with closed types] in GHC.TypeCheck.Util
...
to the environment. Then GHC.TypeCheck.Type.tcTyVar will find A
...
-- See Note [Placeholder PatSyn kinds] in GHC.TypeCheck.Bind
