...
import GHC.TypeCheck.Expression
...
import GHC.Driver.Finder
        -- These imports are the reason that GHC.TypeCheck.Splice
...
import GHC.CoreTypes.DataCon as DataCon
import GHC.TypeCheck.Evidence( TcEvBinds(..) )
import GHC.CoreTypes.Id
import GHC.CoreTypes.Id.Info
import GHC.HaskellToCore.Expression
...
import qualified GHC.CoreTypes.BasicTypes as BasicTypes
import GHC.Data.Maybe( MaybeErr(..) )
import GHC.Config.Flags
import GHC.Util.Panic as Panic
...
In both cases, desugaring happens like this:
  * HsTcBracketOut is desugared by GHC.HaskellToCore.Splice.dsBracket.  It
  ...
  * When GHC.HaskellToCore.Splice (used to desugar the body of the
    ...
    (GHC.HaskellToCore.Splice.repSplice).
...
tcSpliceExpr splice@(HsTypedSplice _ name expr) res_ty
  = addErrCtxt (spliceCtxtDoc splice) $
    ...
    ; case stage of
          ...
          RunSplice _          ->
            -- See Note [RunSplice ThLevel] in GHC.TypeCheck.Util
...
like that.  Here's how it's processed:
  ...
  * The TcM monad is an instance of Quasi (see
    GHC.TypeCheck.Splice), and it implements (qReport True s) by
...
-- GHC.TypeCheck.Environment.tcLookup; specialised mainly in that
...
annotThType :: Bool   -- True <=> annotate
            -> GHC.CoreTypes.Type.Internal.Type -> TH.Type -> TcM TH.Type
...
------------------------------
reifyType :: GHC.CoreTypes.Type.Internal.Type -> TcM TH.Type
...
reify_for_all :: GHC.CoreTypes.Type.Internal.Type -> TcM TH.Type
reify_for_all ty
  = do { cxt' <- reifyCxt cxt;
       ; tau' <- reifyType tau
       ; tvs' <- reifyTyVars tvs
...
reifyTyLit :: GHC.CoreTypes.Type.Internal.TyLit -> TcM TH.TyLit
...
reifyPred :: GHC.CoreTypes.Type.Internal.PredType -> TcM TH.Pred
reifyPred ty
