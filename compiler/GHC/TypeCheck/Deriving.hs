...
import GHC.TypeCheck.Validity         ( allDistinctTyVars )
import GHC.TypeCheck.Class ( instDeclCtxt3, tcATDefault, tcMkDeclCtxt)
...
import GHC.CoreTypes.BasicTypes                  ( DerivStrategy(..) )
...
import GHC.CoreTypes.Name.Set as NameSet
...
import qualified GHC.CoreTypes.Var.Free as FV
...
when the dict is constructed in GHC.TypeCheck.Instance.tcInstDecl2
...
tcDeriving deriv_infos deriv_decls
  = recoverM (do { g <- getGblEnv
    ...
    do  {       -- Fish the "deriving"-related information out of the GHC.TypeCheck.Environment
    ...
    do { traceTc "Standalone deriving decl for" (ppr deriv_ty)
       ...
       ; traceTc "Standalone deriving;" $ vcat
              ...
              , text "tys:" <+> ppr inst_tys ]
                -- C.f. GHC.TypeCheck.Instance.tcLocalInstDecl1
...
GHC.TypeCheck.Instance to handle the empty instance declaration case).
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Much of the code in GHC.TypeCheck.Deriving assumes that deriving
