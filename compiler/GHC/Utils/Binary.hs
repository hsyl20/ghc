...
import {-# SOURCE #-} GHC.Entity.Name (Name)
...
--
-- yes, we need Binary Integer and Binary Rational in GHC.Entity.Literal
...
--   [Symbol table representation of names] in GHC.IR.Interface.Binary).
--
