...
-- GHC.IR.Haskell.TypeChecker.FunctionalDependency.checkClsFD
...
GHC.IR.Haskell.TypeChecker.Unify, and the constraint solver itself in
GHC.IR.Haskell.TypeChecker.Constraint.Canonicaliser), the pure unifier It does
/not/ work up to ~.
