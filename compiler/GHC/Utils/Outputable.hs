...
import {-# SOURCE #-} GHC.Entity.Module ( UnitId, Module, ModuleName, moduleName )
import {-# SOURCE #-} GHC.Entity.OccName ( OccName )
...
-- Also see Note [Binding-site specific printing] in GHC.IR.Core.Printer
data BindingSite
...
-- See Note [Printing of literals in Core] in `GHC.Entity.Literal`.
