...
-- exported. This is done in GHC.IR.Core.Transformer.LevelSetter.newLvlVar.
--
...
module GHC.Utils.CodeGen.StaticPtrTable
...
* The typechecker verifies that all free variables occurring in the
  ...
  GHC.IR.Haskell.TypeChecker.Types).  In our example, 'k' is closed, even though
  it is bound in a nested let, we are fine.
