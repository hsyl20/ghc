...
-- exported. This is done in GHC.Core.LevelSet.newLvlVar.
--
...
* The typechecker verifies that all free variables occurring in the
  ...
  IdBindingInfo] in GHC.Haskell.typeChecker.Types).  In our example, 'k' is
  floatable, even though it is bound in a nested let, we are fine.
