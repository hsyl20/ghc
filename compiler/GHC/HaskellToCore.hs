...
The Desugarer: turning GHC.Haskell into Core.
-}

{-# LANGUAGE CPP #-}
{-# LANGUAGE TypeFamilies #-}

module GHC.HaskellToCore (
...
import GHC.HaskellToCore.Foreign.Declaration
...
import GHC.CoreTypes.Coercion               ( mkCoVarCo )
...
import GHC.CoreTypes.BasicTypes             ( Activation(.. ), competesWith
                                         , pprRuleName )
...
import GHC.HaskellToCore.Coverage
import GHC.Util
...
See GHC.HaskellToCore.Expression.dsExplicitList.
