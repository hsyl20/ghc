...
import GHC.CoreTypes.Id        ( Id, idType, isLocalId, isJoinId )
...
import GHC.CoreTypes.Literal   ( literalType )
import GHC.Data.Maybe
import GHC.CoreTypes.Name      ( getSrcLoc )
import GHC.Util.Error     ( MsgDoc, Severity(..), mkLocMessage )
