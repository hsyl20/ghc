...
import GHC.Haskell.TypeCheck.Type ( TcType, tcEqType )
import GHC.Types.TyCon      ( TyCon, FamTyConFlav(..), mkFamilyTyCon
                                       , Injectivity(..) )
import GHC.Types.Coercion             ( Role(..) )
import GHC.Haskell.TypeCheck.Types ( Xi )
import GHC.Types.Coercion.Axiom       ( CoAxiomRule(..), BuiltInSynFamily(..)
                                       , TypeEqn )
import GHC.Types.Name                 ( Name, BuiltInSyntax(..) )
import GHC.Builtin.Types
import GHC.Builtin.Primitive.Types     ( mkTemplateAnonTyConBinders )
...
import GHC.Data.FastString             ( FastString, fsLit, nilFS, nullFS
                                       , unpackFS, mkFastString, appendFS
                                       )
