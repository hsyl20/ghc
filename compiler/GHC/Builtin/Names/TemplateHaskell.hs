...
import GHC.Entity.Module( Module, mkModuleNameFS, mkModule, thUnitId )
import GHC.Entity.Name( Name )
import qualified GHC.Entity.OccName as OccName
import GHC.Entity.RdrName( RdrName, nameRdrName )
...
-- Should stay in sync with the import list of GHC.Compiler.HaskellToCore.Splices
