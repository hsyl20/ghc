...
~~~~~~~~~~~~~~~~~~~~~~~~~~~
The RuntimeRep type (and friends) in GHC.Entity.Types has a bunch of constructors,
...
in GHC.Entity.Types. All places where such lists exist should contain a reference
...
It has these properties:
  ...
  * It is defined in module GHC.Entity.Types, and exported so that it is
...
* When looking up an OccName in the original-name cache
  (GHC.IR.Interface.Environment.lookupOrigNameCache), we spot the tuple OccName to make sure
...
GHC supports both boxed and unboxed one-tuples:
 ...
 - A boxed one-tuple is used by GHC.Compiler.HaskellToCore.Utils.mkSelectorBinds, when
