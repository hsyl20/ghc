...
import {-# SOURCE #-} GHC.Types.ConLike
import GHC.Types.TyCon
import GHC.Types.Class            ( Class, mkClass )
import GHC.Types.RdrName
import GHC.Types.Name as Name
import GHC.Types.Name.Environment ( NameEnv, mkNameEnv, lookupNameEnv )
import GHC.Types.Name.Set         ( NameSet, mkNameSet, elemNameSet )
import GHC.Types.BasicTypes       ( Arity, Boxity(..), TupleSort(..), ConTagZ,
                                     SourceText(..) )
...
mk_tuple Unboxed arity = (tycon, tuple_con)
  where
    ...
    -- See Note [Unboxed tuple RuntimeRep vars] in GHC.Types.TyCon
