...
-- homogeneous equality. See Note [The equality types story] in GHC.Builtin.Primitive.Types
eqTyConName :: Name
...
-- KnownNat: see Note [KnowNat & KnownSymbol and EvLit] in GHC.IR.Haskell.TypeChecker.Evidence
knownNatClassNameKey :: Unique
knownNatClassNameKey = mkPreludeClassUnique 42

-- KnownSymbol: see Note [KnownNat & KnownSymbol and EvLit] in GHC.IR.Haskell.TypeChecker.Evidence
