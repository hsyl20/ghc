...
[Coercion holes] in GHC.Entity.TypeAndCoercion.) But see also Note [Deferred
errors for coercion holes] in GHC.IR.Haskell.TypeChecker.Error to see how
...
GHC.IR.Haskell.TypeChecker.Constraint.Interact.matchClassInst to pretend that
...
Within GHC, ~ is called eqTyCon, and it is defined in GHC.Builtin.Names. Note
...
Within GHC, ~R# is called eqReprPrimTyCon, and it is defined in
GHC.Builtin.Primitive.Types.
