...
import GHC.Types.Var              ( TyVar, TyVarBndr(TvBndr), mkTyVar )
...
import GHC.Types.TypeAndCoercion
        ...
        -- import loops which show up if you import GHC.Types.Type instead
...
[Coercion holes] in GHC.Types.TypeAndCoercion.) But see also Note [Deferred
...
GHC.Haskell.TypeCheck.Constraint.Interact.matchClassInst to pretend that
