...
\section[GHC.Builtin.Primitive.Types]{Wired-in knowledge about primitive types}
-}
...
module GHC.Builtin.Primitive.Types(
...
import GHC.Entity.Var              ( TyVar, TyVarBndr(TvBndr), mkTyVar )
...
import GHC.Entity.TypeAndCoercion   -- Doesn't need special access, but this is easier to avoid
                 -- import loops which show up if you import GHC.Entity.Type instead
...
************************************************************************
*                                                                      *
\subsection[GHC.Builtin.Primitive.Types-basic]{Basic primitive types (@Char#@, @Int#@, etc.)}
*                                                                      *
************************************************************************
-}
...
************************************************************************
*                                                                      *
\subsection[GHC.Builtin.Primitive.Types-state]{The @State#@ type (and @_RealWorld@ types)}
*                                                                      *
************************************************************************
...
(See Note [Coercion holes] in GHC.Entity.TypeAndCoercion.) But see also
Note [Deferred errors for coercion holes] in GHC.IR.Haskell.TypeChecker.Error to see how
equality constraints are deferred.

Within GHC, ~# is called eqPrimTyCon, and it is defined in GHC.Builtin.Primitive.Types.
...
equalities. There is some special-casing in GHC.IR.Haskell.TypeChecker.Constraint.Interact.matchClassInst to
...
Within GHC, ~R# is called eqReprPrimTyCon, and it is defined in GHC.Builtin.Primitive.Types.
...
************************************************************************
*                                                                      *
\subsection[GHC.Builtin.Primitive.Types-synch-var]{The synchronizing variable type}
*                                                                      *
************************************************************************
-}
...
************************************************************************
*                                                                      *
\subsection[GHC.Builtin.Primitive.Types-stm-var]{The transactional variable type}
*                                                                      *
************************************************************************
-}
...
************************************************************************
*                                                                      *
\subsection[GHC.Builtin.Primitive.Types-stable-ptrs]{The stable-pointer type}
*                                                                      *
************************************************************************
-}
...
************************************************************************
*                                                                      *
\subsection[GHC.Builtin.Primitive.Types-stable-names]{The stable-name type}
*                                                                      *
************************************************************************
-}
...
************************************************************************
*                                                                      *
\subsection[GHC.Builtin.Primitive.Types-compact-nfdata]{The Compact NFData (CNF) type}
*                                                                      *
************************************************************************
-}
...
************************************************************************
*                                                                      *
\subsection[GHC.Builtin.Primitive.Types-BCOs]{The ``bytecode object'' type}
*                                                                      *
************************************************************************
-}
...
************************************************************************
*                                                                      *
\subsection[GHC.Builtin.Primitive.Types-Weak]{The ``weak pointer'' type}
*                                                                      *
************************************************************************
-}
...
************************************************************************
*                                                                      *
\subsection[GHC.Builtin.Primitive.Types-thread-ids]{The ``thread id'' type}
*                                                                      *
************************************************************************
