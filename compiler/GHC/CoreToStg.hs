...
module GHC.CoreToStg ( coreToStg, coreExprToStg ) where
...
import GHC.CoreTypes.Demand          ( isUsedOnce )
  ...
  where
    vars_alt (con, binders, rhs)
      ...
      = -- This case is a bit smelly.
        -- See Note [Nullary unboxed tuple] in GHC.CoreTypes.Type
