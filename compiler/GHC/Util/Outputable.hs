...
import {-# SOURCE #-} GHC.CoreTypes.Module
                                   ( UnitId, Module, ModuleName, moduleName )
import {-# SOURCE #-} GHC.CoreTypes.OccName
                                   ( OccName )

import GHC.Util.Handle.BufferedWrite (BufHandle)
...
import GHC.Util.PrettyPrint           ( Doc, Mode(..) )
...
-- Also see Note [Binding-site specific printing] in GHC.Core.Printer
data BindingSite
...
-- See Note [Printing of literals in Core] in GHC.CoreTypes.Literal.
