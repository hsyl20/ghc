...
{-
Note [Differences between libraries/pretty and GHC.Util.PrettyPrint]
 ...
 * `compiler/GHC.Util/PrettyPrint.hs` (this module). It is used by GHC only.
...
ghc git tree:
    ...
    $ cd -
    $ vimdiff compiler/GHC.Util/PrettyPrint.hs \
...
-- Don't import GHC.Util( assertPanic ) because it makes a loop in the module
-- structure
