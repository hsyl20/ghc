...
--
-- yes, we need Binary Integer and Binary Rational in GHC.CoreTypes.Literal
...
--   [Symbol table representation of names] in GHC.Interface.Binary).
--
