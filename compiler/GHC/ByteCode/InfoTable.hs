...
import GHC.CoreTypes.Name               ( Name, getName )
import GHC.CoreTypes.Name.Environment
import GHC.CoreTypes.DataCon    ( DataCon, dataConRepArgTys
                                     , dataConIdentity )
import GHC.CoreTypes.TyCon    ( TyCon, tyConFamilySize, isDataTyCon
                                     , tyConDataCons )
