...
-- | GHC.ByteCode.Linker: Bytecode assembler and linker
module GHC.ByteCode.Assembler (
...
import GHC.Compiler.StgToCmm.Layout     ( ArgRep(..) )
...
assembleI dflags i = case i of
  ...
  where
    ...
    literal LitInteger{}       = panic "GHC.ByteCode.Assembler.literal: LitInteger"
