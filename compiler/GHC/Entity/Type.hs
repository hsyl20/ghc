...
-- We import the representation and primitive functions from GHC.Entity.TypeAndCoercion.
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
As noted in Note [Forall coercions] in GHC.Entity.TypeAndCoercion, a ForAllCo is a bit redundant.
...
some variant of the dreaded KPush algorithm (c.f. GHC.IR.Core.Transformer.pushCoDataCon).
