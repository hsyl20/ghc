...
They only get converted into real Core,
    mkInteger [c1, c2, .., cn]
during the CorePrep phase, although GHC.IR.Interface.Transformer.Tidier looks ahead at what the
...
--      c.f. GHC.IR.Core.Utils.exprIsTrivial
...
--      c.f. GHC.IR.Core.Utils.exprIsDupable
