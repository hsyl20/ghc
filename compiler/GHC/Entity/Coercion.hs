...
%*                                                                      *
     ...
     -- See [Coercion axioms applied to coercions] in GHC.Entity.TypeAndCoercion
...
-- Outputable instances are in GHC.Entity.TypeAndCoercion, to avoid orphans
...
-- of Coercion and the Note [Refl invariant] in GHC.Entity.TypeAndCoercion.
