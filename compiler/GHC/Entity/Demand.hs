...
import GHC.Entity.Type            ( Type, isUnliftedType )
import GHC.Entity.TypeConstructor           ( isNewTyCon, isClassTyCon )
import GHC.Entity.DataConstructor ( splitDataProductType_maybe )
...
we pin a demand on a binder, in GHC.IR.Core.Analyser.Demand.findBndrDmd.
...
-- Equality needed for fixpoints in GHC.IR.Core.Analyser.Demand
...
-- See Note [IO hack in the demand analyser] in GHC.IR.Core.Analyser.Demand
