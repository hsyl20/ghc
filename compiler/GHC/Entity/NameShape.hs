...
-- The 'NameShape' type is defined in GHC.IR.Haskell.TypeChecker.Types, because
-- GHC.IR.Haskell.TypeChecker.Types needs to refer to NameShape, and having
-- GHC.IR.Haskell.TypeChecker.Types import NameShape (even by SOURCE) would
