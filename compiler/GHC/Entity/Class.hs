...
import {-# SOURCE #-} GHC.Entity.TypeAndCoercion   ( Type, PredType, pprType )
...
(in GHC.IR.Haskell.TypeChecker.TypeAndClassDeclaration) when checking a class's roles.
