...
import GHC.Entity.SrcLoc ( Located,unLoc )
...
--  fib 100     has arity 0
--  \x -> fib x has arity 1
-- See also Note [Definition of arity] in GHC.IR.Core.Analyser.Arity
type Arity = Int
...
-- instance. See Note [Safe Haskell isSafeOverlap] (in GHC.Entity.ClassInstance)
...
data TyPrec   -- See Note [Precedence in types] in GHC.Entity.TypeAndCoercion
  = TopPrec         -- No parens
...
data Activation = NeverActive
                ...
                deriving( Eq, Data )
                  -- Eq used in comparing rules in GHC.IR.Haskell.Syntax.Declaration
...
If you want to know where InlinePragmas take effect: Look in
GHC.Compiler.HaskellToCore.Binding.makeCorePair
...
The main effects of CONLIKE are:
    ...
    - The rule matcher consults this field.  See
      Note [Expanding variables] in GHC.IR.Core.Transformer.Rules
-}
