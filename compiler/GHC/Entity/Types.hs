...
Where do interactively-bound Ids come from?
  ...
  - GHCi REPL Stmts   e.g.
    ...
    GHC.IR.Haskell.TypeChecker.Module.externaliseAndTidyId, so they get Names like Ghic4.foo.
...
Also see Note [Typechecking Complete Matches] in GHC.IR.Haskell.TypeChecker.Binding for a more detailed
