...
module GHC.Entity.Coercion.Axiom (
...
import {-# SOURCE #-} GHC.Entity.TypeAndCoercion ( Type, pprType )
...
can unify. See also [Apartness] in GHC.Entity.FamilyInstance
...
~~~~~~~~~~~~~~~~~~~~~~
See also Note [Implicit TyThings] in GHC.Entity.Types
...
-- mkRoleAnnotDecl in GHC.IR.Haskell.Parser.Syntax
