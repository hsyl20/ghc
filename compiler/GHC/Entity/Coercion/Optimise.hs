...
module GHC.Entity.Coercion.Optimise ( optCoercion, checkAxInstCo ) where
...
import GHC.Entity.Type hiding( substTyVarBndr, substTy )
import qualified GHC.Entity.Type as Type
import GHC.IR.Haskell.TypeChecker.Type ( exactTyCoVarsOfType )
...
etaTyConAppCo_maybe tc co
  ...
  , tc1 == tc2
  , isInjectiveTyCon tc r  -- See Note [NthCo and newtypes]
  , let n = length tys1    -- in GHC.Entity.TypeAndCoercion
  = ASSERT( tc == tc1 )
