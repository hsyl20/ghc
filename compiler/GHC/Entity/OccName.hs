...
-- see also: Note [Data Constructor Naming] in GHC.Entity.DataConstructor
--
-- $real_vs_source_data_constructors
-- There are two forms of data constructor:
--
--  * [Source data constructors] The data constructors mentioned in Haskell
--    source code
--
--  * [Real data constructors] The data constructors of the representation type,
--    which may not be the same as the source type
--
-- For example:
--
-- > data T = T !(Int, Int)
...
-- See Note [Demotion] in GHC.IR.Haskell.Renamer.Environment
...
See Note [Unique OccNames from Template Haskell] in
...
-- TyConRepName stuff; see Note [Grand plan for Typeable] in GHC.IR.Haskell.Deriver.Typeable
...
(See GHC.IR.Haskell.TypeChecker.ClassDeclaration.tcMethodBind)
...
*                                                                      *
                Binary instance
    Here rather than GHC.IR.Interface.Binary because OccName is abstract
*                                                                      *
************************************************************************
-}
