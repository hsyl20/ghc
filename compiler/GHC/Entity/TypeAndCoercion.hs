...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  GHC.Entity.TypeAndCoercion  imports Class, CoAxiom, TyCon
  GHC.Builtin.Primitive.Types  imports GHC.Entity.TypeAndCoercion ( including mkTyConTy )
...
import {-# SOURCE #-} GHC.Entity.DataConstructor ( dataConFullSig
                             , dataConUnivTyVarBinders, dataConExTyVarBinders
                             , DataCon, filterEqSpec )
import {-# SOURCE #-} GHC.Entity.Type( isPredTy, isCoercionTy, mkAppTy, mkCastTy
...
-- thing but in the *local* context.  See 'GHC.IR.Haskell.TypeChecker.Environment' for how to retrieve
...
equality types story] in GHC.Builtin.Primitive.Types for background on equality constraints.
...
For unboxed equalities:
  - Generate a CoercionHole, a mutable variable just like a unification
    variable
  - Wrap the CoercionHole in a Wanted constraint; see GHC.IR.Haskell.TypeChecker.Types.TcEvDest
...
-- they expect/preserve the ArgFlag argument. Thes belong to GHC.Entity.Type, but
