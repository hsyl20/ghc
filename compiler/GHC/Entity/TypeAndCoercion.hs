...
\section[GHC.Entity.TypeAndCoercion]{Type and Coercion - friends' interface}
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  GHC.Builtin.Primitive
    .Types           imports GHC.Entity.TypeAndCoercion ( including mkTyConTy )
  GHC.Entity
...
module GHC.Entity.TypeAndCoercion (
...
import {-# SOURCE #-} GHC.Entity.Coercion
import {-# SOURCE #-} GHC.Entity.ConstructorLike ( ConLike(..), conLikeName )
import {-# SOURCE #-} GHC.Compiler.CoreToInterface
...
-- others
import GHC.Entity.BasicTypes ( LeftOrRight(..), TyPrec(..), maybeParen, pickLR )
...
It is also SOURCE-imported into GHC.Entity.Name
...
For unboxed equalities:
  ...
  - Wrap the CoercionHole in a Wanted constraint; see
    GHC.IR.Haskell.TypeChecker.Types.TcEvDest
...
-- GHC.Entity.Type, but how should they be named?
