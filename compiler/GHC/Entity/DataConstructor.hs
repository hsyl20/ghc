...
import {-# SOURCE #-} GHC.Entity.Id.Make ( DataConBoxer )
import GHC.Entity.Type as Type
import GHC.Entity.ForeignCall ( CType )
...
data DataCon
  = MkData {
        ...
        -- used in GHC.IR.Core.Analyser.Lint.
 ...
 * Each argument flag is Inferred or Specified.
   ...
   Note [No Required TyBinder in terms] in GHC.Entity.TypeAndCoercion.)
