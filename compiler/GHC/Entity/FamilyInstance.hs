...
module GHC.Entity.FamilyInstance (
...
All this is done in GHC.IR.Haskell.TypeChecker.Instance.tcDataFamInstDecl.
...
parameter. The axiom is loaded lazily, via a forkM, in GHC.IR.Interface.TypeChecker. Sometime
...
apartnessCheck :: [Type]     -- ^ /flattened/ target arguments. Make sure
                             ...
                             -- "flat" than is used in GHC.IR.Haskell.TypeChecker.Flatten.)
