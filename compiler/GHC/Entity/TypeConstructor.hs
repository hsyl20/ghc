...
import {-# SOURCE #-} GHC.Entity.TypeAndCoercion    ( Kind, Type, PredType, pprType )
import {-# SOURCE #-} GHC.Builtin.Types ( runtimeRepTyCon, constraintKind
                                 , vecCountTyCon, vecElemTyCon, liftedTypeKind
                                 , mkFunKind, mkForAllKind )
import {-# SOURCE #-} GHC.Entity.DataConstructor ( DataCon, dataConExTyVars
...
import GHC.Utils
import GHC.Entity.Unique( tyConRepNameUnique, dataConRepNameUnique )
...
~~~~~~~~~~~~~~~~~~~~~~~~~
See also Note [Wrappers for data instance tycons] in GHC.Entity.Id.Make
...
* The axiom ax_ti may be eta-reduced; see
  Note [Eta reduction for data family axioms] in GHC.IR.Haskell.TypeChecker.Instance
...
* The tyConTyVars of the representation tycon are the tyvars that the
  user wrote in the patterns. This is important in GHC.IR.Haskell.TypeChecker.Deriving, where we
...
Data and class tycons have their roles inferred (see inferRoles in GHC.IR.Haskell.TypeChecker.TypeDeclaration),
...
See also:
 * [Injectivity annotation] in GHC.IR.Haskell.Syntax.Declaration
 * [Renaming injectivity annotation] in GHC.IR.Haskell.Renamer
 * [Verifying injectivity annotation] in FamInstEnv
 * [Type inference for type families with injectivity] in GHC.IR.Haskell.TypeChecker.Constraint.Interact
...
* tyConBinders gives the telescope of type variables on the LHS of the
  ...
  See Note [TyBinders and ArgFlags] in GHC.Entity.TypeAndCoercion for what
...
data TyCon
  ...
  | FamilyTyCon {
        ...
        tyConArity   :: Arity,            -- ^ Arity
            ...
            -- with its parent class; see GHC.IR.Haskell.TypeChecker.Validity.checkConsistentFamInst
...
data AlgTyConFlav
  ...
  -- See Note [ATyCon for classes] in GHC.Entity.TypeAndCoercion
  | ClassTyCon
  ...
  | DataFamInstTyCon          -- See Note [Data type families]
        (CoAxiom Unbranched)  -- The coercion axiom.
               ...
               --
               -- BUT may be eta-reduced; see GHC.IR.Haskell.TypeChecker.Instance
...
2.  When checking a type/class declaration (in module GHC.IR.Haskell.TypeChecker.TypeAndClassDeclaration), we come
    ...
    environment in GHC.IR.Haskell.TypeChecker.TypeAndClassDeclaration, until the real full TyCons can be created
    ...
    GHC.IR.Haskell.TypeChecker.UserType.splitTelescopeTvs!) Instead of trying, we just store the list
    ...
    brought into scope in kcTyClTyVars and tcTyClTyVars, both in GHC.IR.Haskell.TypeChecker.UserType.
...
-- See Note [Grand plan for Typeable] in 'GHC.IR.Haskell.Deriver.Typeable'
...
Roughly in order of "includes more information":
 ...
 - A Width (GHC.IR.Cmm.Syntax.Type) is simply a binary value with the specified
...
-- corresponding 'TyCon'. It is recomended to use 'GHC.Entity.TypeAndCoercion.funTyCon' if you want
-- this functionality
...
-- GHC.IR.Haskell.TypeChecker.Error sometimes calls typeKind.
-- See also Note [Kind checking recursive type and class declarations]
-- in GHC.IR.Haskell.TypeChecker.TypeAndClassDeclaration.
mkTcTyCon :: Name
          -> [TyConBinder]
...
-- See also Note [Decomposing equality] in GHC.IR.Haskell.TypeChecker.Constraint.Canonicaliser
