...
The bits common to GHC.IR.Haskell.TypeChecker.Instance and GHC.IR.Haskell.Deriver.
-}

{-# LANGUAGE CPP, DeriveDataTypeable #-}

module GHC.Entity.ClassInstance (
...
import GHC.IR.Haskell.TypeChecker.Type -- InstEnv is really part of the type checker,
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  (see GHC.IR.Interface.Utils.instanceToIfaceInst, which implements this)
...
-- We use this when we do signature checking in GHC.IR.Haskell.TypeChecker.Module
...
(See `GHC.Entity.Id.Make.mkDictFunId' for the code in question.  Search for
