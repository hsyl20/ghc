...
import GHC.Entity.Var      ( Var, TyVar, CoVar, TyCoVar, Id )
import GHC.Entity.Unique
import GHC.Entity.Name     ( Name )
import GHC.Entity.Unique.Set
import GHC.Entity.Unique.DeterSet
import GHC.Entity.Unique.FiniteMap( disjointUFM, pluralUFM, pprUFM )
import GHC.Entity.Unique.DeterFiniteMap( disjointUDFM, udfmToUfm, anyUDFM, allUDFM )
