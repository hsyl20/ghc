...
module GHC.Entity.Unique.DeterFiniteMap (
...
import GHC.Entity.Unique           ( Uniquable(..), Unique, getKey )
...
import GHC.Entity.Unique.FiniteMap (UniqFM, listToUFM_Directly, nonDetUFMToList, ufmToIntMap)
