...
module GHC.HaskellToCore.Match
   ( match
   , matchEquations
   , matchWrapper
   , matchSimply
...
import GHC.HaskellToCore.Match.Constructor
...
import GHC.CoreTypes.BasicTypes           ( isGenerated, il_value, fl_value )
...
\item @do@ patterns, but if the @do@ can fail
      ...
      (see @GHC.HaskellToCore.Expression.doDo@ function)
