...
import GHC.CoreTypes.Name( isInternalName )
...
In fact, even GHC.Core.Subst.simplOptExpr will do this,
...
mkPatSynCase var ty alt fail = do
  ...
  where
    ...
    -- GHC.CoreTypes.PatternSynonym on these extra Void# arguments
...
mkSelectorBinds :: [[Tickish Id]] -- ^ ticks to add, possibly
                ...
                -- GHC.HaskellToCore.Bind) and all the desugared
                -- binds
