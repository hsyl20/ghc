...
@GHC.HaskellToCore.Monad@: monadery used in desugaring
-}

{-# LANGUAGE FlexibleInstances, FlexibleContexts #-}
{-# OPTIONS_GHC -fno-warn-orphans #-}  -- instance MonadThings is necessarily an orphan

module GHC.HaskellToCore.Monad (
...
import GHC.TypeCheck.Util.Monadic ( checkForLevPolyX
                                              , formatLevPolyErr )
...
of cases; see calls to GHC.HaskellToCore.Monad.dsNoLevPoly and friends.
...
but we can't, because of the fixM in GHC.HaskellToCore.Arrow. It's all
...
-- of the fixM used in GHC.HaskellToCore.Arrow. See Note [Levity polymorphism checking]
...
-- Very like GHC.TypeCheck.Environment.tcLookupGlobal
dsLookupGlobal name
  = do  { env <- getGblEnv
