...
module GHC.HaskellToCore.Match.Expression (
...
impact of this is the following:
  ...
  * We have instant equality check for overloaded literals (we do not rely on
    ...
    `uncovered` and `divergent` in GHC.HaskellToCore.Match.Check and
...
-- GHC.HaskellToCore.Monad:397:dsLookupDataCon :: Name -> DsM DataCon
--
...
GHC.HaskellToCore.Match.Check) to be more precice.
-}
