...
import GHC.CoreTypes.Id.Make(proxyHashId)
...
GHC.HaskellToCore.Expression.ds_val_bind.
...
The restrictions are:
  ...
  2. Unlifted binds must also be banged. (There is no trouble to compile an unbanged
     ...
     of GHC.HaskellToCore.Expression.ds_val_bind.
...
See Note [Rules for seq] in GHC.CoreTypes.Id.Make for the details.
