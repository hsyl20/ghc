...
module GHC.HaskellToCore.Expression
   ( dsExpr
   , dsLExpr
   , dsLExprNoLP
   , dsLocalBinds
...
ds_val_bind (NonRecursive, hsbinds) body
  ...
  = putSrcSpanDs loc $
     -- see Note [Strict binds checks] in GHC.HaskellToCore.Bind
...
************************************************************************
*                                                                      *
\subsection[GHC.HaskellToCore.Expression-vars-and-cons]{Variables, constructors, literals}
*                                                                      *
************************************************************************
-}
...
ds_expr _ (PArrSeq _ _)
  = panic "GHC.HaskellToCore.Expression.dsExpr: Infinite parallel array!"
...
-- GHC.Haskell constructs that just shouldn't be here:
...
GHC.HaskellToCore.ListComp).  Basically does the translation given in
