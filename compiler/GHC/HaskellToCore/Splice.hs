...
module GHC.HaskellToCore.Splice ( dsBracket ) where
...
-- the import of GHC.CoreTypes.Name below and by using a qualified import of OccName.
import qualified GHC.CoreTypes.OccName as OccName

import GHC.CoreTypes.Module
import GHC.CoreTypes.Id
import GHC.CoreTypes.Name hiding( isVarOcc, isTcOcc, varName, tcName )
