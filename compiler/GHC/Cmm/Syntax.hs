...
data CmmStackInfo
   = StackInfo {
       arg_space :: ByteOff,
               ...
               -- the proc.  This is filled in by GHC.Compiler.StgToCmm.codeGen,
               -- and used by the stack allocator later.
...
-- C_SRT is what GHC.Stg.Syntax.SRT gets translated to...
