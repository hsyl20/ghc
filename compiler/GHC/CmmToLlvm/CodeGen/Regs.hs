...
module GHC.CmmToLlvm.CodeGen.Regs (
...
lmGlobalReg dflags suf reg
  = case reg of
        ...
        _other         -> panic $ "GHC.CmmToLlvm.CodeGen.Reg: GlobalReg (" ++ (show reg)
                                ++ ") not supported!"
...
rootN  = getUnique (fsLit "GHC.CmmToLlvm.CodeGen.Regs.rootN")
topN   = getUnique (fsLit "GHC.CmmToLlvm.CodeGen.Regs.topN")
stackN = getUnique (fsLit "GHC.CmmToLlvm.CodeGen.Regs.stackN")
heapN  = getUnique (fsLit "GHC.CmmToLlvm.CodeGen.Regs.heapN")
rxN    = getUnique (fsLit "GHC.CmmToLlvm.CodeGen.Regs.rxN")
baseN  = getUnique (fsLit "GHC.CmmToLlvm.CodeGen.Regs.baseN")
