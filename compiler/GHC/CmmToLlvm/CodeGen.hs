...
--
module GHC.CmmToLlvm.CodeGen ( llvmCodeGen, llvmFixupAsm ) where
...
import GHC.CmmToLlvm.CodeGen.Proc
import GHC.CmmToLlvm.CodeGen.Data
import GHC.CmmToLlvm.CodeGen.PrettyPrint
...
import GHC.Util.SysTools ( figureLlvmVersion )
