...
module GHC.CmmToAsm.X86.Instr (Instr(..), Operand(..), PrefetchVariant(..), JumpDest,
...
import GHC.Cmm.Syntax.DebugBlock(UnwindTable)
...
fits poorly with the existing CmmToAsm infrastructure, which assumes
flat integer and FP register sets.  Prior to this commit, CmmToAsm
