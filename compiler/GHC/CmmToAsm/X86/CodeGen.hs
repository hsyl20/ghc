...
import GHC.Util.CodeGen.Primitive
import GHC.Cmm.Syntax.DebugBlock ( DebugBlock(..), UnwindPoint(..), UnwindTable
...
import GHC.CoreTypes.SrcLoc      ( srcSpanFile, srcSpanStartLine, srcSpanStartCol )

-- The rest:
import GHC.CoreTypes.ForeignCall      ( CCallConv(..) )
import GHC.Data.OrdList
import GHC.Util.Outputable
import GHC.Data.FastString
import GHC.Config.Flags
import GHC.Util
import GHC.Data.UniqueSupply       ( getUniqueM )
...
-- GHC.Cmm.Syntax.DebugBlock for details.
  ...
  = do
        ...
        return $ if is32bit || os == OSDarwin
                 then e_code `appOL` t_code `appOL` toOL [
                      ...
                      -- GHC.CmmToAsm.X86.Ppr/pprDataItem once binutils
                      -- 2.17 is standard.
