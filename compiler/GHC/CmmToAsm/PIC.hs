{-
  ...
  + GHC.CmmToAsm
    - The cmmToCmm pass in GHC.CmmToAsm calls cmmMakeDynamicReference
      for all labels.
...
import GHC.CoreTypes.CLabel ( CLabel, ForeignLabelSource(..), pprCLabel,
                           mkDynamicLinkerLabel, DynamicLinkerLabelInfo(..),
                           dynamicLinkerLabelInfo, mkPicBaseLabel,
                           labelDynamic, externallyVisibleCLabel )

import GHC.CoreTypes.CLabel ( mkForeignLabel )
