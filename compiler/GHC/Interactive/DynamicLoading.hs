...
import GHC.CoreTypes.OccName          ( OccName, mkVarOcc )
import GHC.Haskell.Rename.ImportExport ( gresFromAvails )
...
import GHC.CoreTypes.Type             ( Type, eqType, mkTyConTy, pprTyThingCategory )
import GHC.CoreTypes.TyCon  ( TyCon )
import GHC.CoreTypes.Name             ( Name, nameModule_maybe )
import GHC.CoreTypes.Id               ( idType )
import GHC.CoreTypes.Module           ( Module, ModuleName )
...
import GHC.CoreTypes.Module ( ModuleName, moduleNameString )
import GHC.Util.Panic
