...
\section[GHC.Types.TypeAndCoercion]{Type and Coercion - friends' interface}
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  GHC.Builtin.Primitive
    .Types           imports GHC.Types.TypeAndCoercion ( including mkTyConTy )
  GHC.Types
...
module GHC.Types.TypeAndCoercion (
...
import {-# SOURCE #-} GHC.Types.Coercion
import {-# SOURCE #-} GHC.Types.ConLike ( ConLike(..), conLikeName )
...
-- others
import GHC.Types.BasicTypes ( LeftOrRight(..), TyPrec(..), maybeParen, pickLR )
...
For unboxed equalities:
  ...
  - Wrap the CoercionHole in a Wanted constraint; see
    GHC.Haskell.TypeCheck.Types.TcEvDest
...
-- Note [Deterministic FV] in GHC.Types.Var.Free.
...
-- See Note [FV naming conventions] in GHC.Types.Var.Free.
--
-- Eta-expanded because that makes it run faster (apparently)
-- See Note [FV eta expansion] in GHC.Types.Var.Free for explanation.
...
See Note [Precedence in types] in GHC.Types.BasicTypes.
-}
...
-- GHC.Types.Type, but how should they be named?
