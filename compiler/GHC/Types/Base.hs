...
\section[GHC.Types.Base]{Types for the per-module compiler}
-}
...
import GHC.Types.Instance       ( InstEnv, ClsInst, identicalClsInstHead )
import GHC.Types.FamilyInstance
import GHC.Core.Syntax          ( CoreProgram, RuleBase, CoreRule, CoreVect )
...
import GHC.Types.Annotation      ( Annotation, AnnEnv, mkAnnEnv, plusAnnEnv )
...
import GHC.Driver.CmdLineParser
import GHC.Config.Flags hiding   (WarnReason)
import GHC.Driver.Phases         ( Phase, HscSource(..), isHsBootOrSig
                                 , hscSourceString )
...
data HscEnv
  = HscEnv {
        ...
        hsc_type_env_var :: Maybe (Module, IORef TypeEnv)
                ...
                -- the 'IfGblEnv'. See 'GHC.Haskell.TypeCheck.Types.tcg_type_env_var' for
                -- 'GHC.Haskell.TypeCheck.Types.TcGblEnv'.  See also Note [hsc_type_env_var hack]
...
data ModGuts
  = ModGuts {
        ...
        mg_trust_pkg    :: Bool                 -- ^ Do we need to trust our
                                                ...
                                                -- See Note [GHC.Haskell.Rename.ImportExport . Trust Own Package]
    }
...
Where do interactively-bound Ids come from?
  ...
  - Ids bound by the debugger etc have Names constructed by
    GHC.Interface.Environment.newInteractiveBinder; at the call sites it is
...
data Dependencies
  = Deps { dep_mods   :: [(ModuleName, IsBootInterface)]
         ...
         , dep_pkgs   :: [(InstalledUnitId, Bool)]
                        ...
                        -- (Safe Haskell). See Note [GHC.Haskell.Rename.ImportExport . Tracking Trust Transitively]
  ...
  deriving( Eq )
        ...
        -- See 'GHC.Haskell.TypeCheck.Types.ImportAvails' for details on dependencies.
...
data ExternalPackageState
  = EPS {
        eps_is_boot :: !(ModuleNameEnv (ModuleName, IsBootInterface)),
                ...
                -- direct from 'GHC.Haskell.TypeCheck.Types.imp_dep_mods'
...
dsGetCompleteMatches in GHC.Compiler.HaskellToCore.Splice accomplishes this lookup.

Also see Note [Typechecking Complete Matches] in
GHC.Haskell.TypeCheck.Binding for a more detailed explanation for how GHC
