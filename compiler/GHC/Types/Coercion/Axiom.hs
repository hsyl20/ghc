...
module GHC.Types.Coercion.Axiom (
...
import {-# SOURCE #-} GHC.Types.TypeAndCoercion ( Type, pprType )
...
can unify. See also [Apartness] in GHC.Types.FamilyInstance
...
-- See Note [Compatibility checking] in GHC.Types.FamilyInstance
...
~~~~~~~~~~~~~~~~~~~~~~
See also Note [Implicit TyThings] in GHC.Types.Base
...
-- See Note [Roles] in GHC.Types.Coercion
...
-- mkRoleAnnotDecl in GHC.Haskell.Parser.Syntax
