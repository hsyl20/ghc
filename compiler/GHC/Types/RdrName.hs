...
--
-- * 'Name.OccName': see "OccName#name_types"
--
...
-- see Note [Demotion] in GHC.Types.OccName
...
-- Reason: see Note [Splicing Exact names] in GHC.Haskell.Rename.Environment
...
--              Haskell quotation; see this note in
...
--   see GHC.Haskell.Rename.ImportExport.exports_from_avail
...
* The GHCi REPL
  ...
  - Ids bought into scope on the command line (eg let x = True) have
    ...
    See Note [Interactively-bound Ids in GHCi] in GHC.Types.Base
...
* Nested Template Haskell declaration brackets
  See Note [Top-level Names in Template Haskell decl quotes] in GHC.Haskell.Rename.ImportExport
