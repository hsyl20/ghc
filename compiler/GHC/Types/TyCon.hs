...
import {-# SOURCE #-} GHC.Types.DataCon
...
import GHC.Utils
import GHC.Types.Unique( tyConRepNameUnique, dataConRepNameUnique )
...
* The axiom ax_ti may be eta-reduced; see
  Note [Eta reduction for data family axioms] in GHC.Types.FamilyInstance

* Data family instances may have a different arity than the data family.
  See Note [Arity of data families] in GHC.Types.FamilyInstance
...
GHC.Haskell.TypeCheck.TypeDeclaration), as do vanilla synonym tycons.
...
- See Note [TyVarBndrs, TyVarBinders, TyConBinders, and visibility] in
  GHC.Types.TypeAndCoercion for what the visibility flag means.
...
data AlgTyConFlav
  ...
  -- See Note [ATyCon for classes] in GHC.Types.TypeAndCoercion
  | ClassTyCon
...
2.  When checking a type/class declaration (in module
    GHC.Haskell.TypeCheck.TypeAndClassDeclaration), we come upon knowledge
    ...
    GHC.Haskell.TypeCheck.TypeAndClassDeclaration, until the real full
    ...
    GHC.Haskell.TypeCheck.UserType.splitTelescopeTvs!) Instead of trying,
    ...
    in GHC.Haskell.TypeCheck.UserType.
...
-- See Note [Grand plan for Typeable] in GHC.Haskell.Derive.Typeable
...
Roughly in order of "includes more information":
 ...
 - A Width (GHC.Cmm.Syntax.Type) is simply a binary value with the specified
...
-- 'GHC.Types.TypeAndCoercion.funTyCon' if you want this functionality
...
-- in GHC.Haskell.TypeCheck.TypeAndClassDeclaration.
mkTcTyCon :: Name
          -> [TyConBinder]
...
-- See Note [Enumeration types] in GHC.Types.TyCon
