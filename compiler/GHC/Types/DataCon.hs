 ...
 * Each argument flag is Inferred or Specified.
   ...
   Note [No Required TyBinder in terms] in GHC.Types.TypeAndCoercion.)
...
data HsSrcBang =
  HsSrcBang SourceText -- Note [Pragma source text] in GHC.Types.BasicTypes
            SrcUnpackedness
            SrcStrictness
  deriving Data.Data
...
-- are a little dodgy.
  ...
  where
    ...
    rep_ty = mkForAllTys univ_tvs $ mkForAllTys ex_tvs $
      ...
      -- See Note [Promoted data constructors] in GHC.Types.TyCon
