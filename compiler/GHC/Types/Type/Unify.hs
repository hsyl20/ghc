...
import GHC.Types.Type            hiding ( getTvSubstEnv )
import GHC.Types.Coercion        hiding ( getCvSubstEnv )
import GHC.Types.TyCon
import GHC.Types.TypeAndCoercion hiding ( getTvSubstEnv, getCvSubstEnv )
import GHC.Utils
...
GHC.Haskell.TypeCheck.Constraint.Canonicalise), the pure unifier It does
/not/ work up to ~.
...
algorithm in FamInstEnv (See Note [Flattening] in GHC.Types.FamilyInstance),
