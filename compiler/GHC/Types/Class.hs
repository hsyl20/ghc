...
import {-# SOURCE #-} GHC.Types.TypeAndCoercion ( Type, PredType, pprType )
...
import GHC.Data.BoolFormula (BooleanFormula, mkTrue)
...
(in GHC.Haskell.TypeCheck.TypeAndClassDeclaration) when checking a class's
roles.
