...
module GHC.Types.FamilyInstance (
...
data FamInst  -- See Note [FamInsts and CoAxioms]
  = FamInst { fi_axiom  :: CoAxiom Unbranched -- The new coercion axiom
            ...
            , fi_fam   :: Name          -- Family name
                ...
                -- See Note [Rough-match field] in GHC.Types.Instance
            ...
            , fi_cvs :: [CoVar]      -- Template covars for full match
                 ...
                 -- See Note [Template tyvars are fresh] in 
                 -- GHC.Types.Instance
...
See also Note [Newtype eta] in GHC.Types.TyCon.
...
parameter. The axiom is loaded lazily, via a forkM, in GHC.Interface.TypeCheck. Sometime
...
-- the compatibilities
-- See Note [Storing compatibility] in GHC.Types.Coercion.Axiom
...
mkNewTypeCoAxiom name tycon tvs roles rhs_ty
  = CoAxiom { co_ax_unique   = nameUnique name
            , co_ax_name     = name
            , co_ax_implicit = True  -- See Note [Implicit axioms] in
                                     -- GHC.Types.TyCon
...
apartnessCheck :: [Type]     -- ^ /flattened/ target arguments. Make sure
                             ...
                             -- "flat" than is used in GHC.Haskell.TypeCheck.Flatten.)
