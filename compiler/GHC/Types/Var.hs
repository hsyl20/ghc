...
-- contain type variables, which have a 'GHC.Types.TypeAndCoercion.Kind' rather
-- than a 'GHC.Types.TypeAndCoercion.Type' and only contain some extra details
-- during typechecking.
--
...
import {-# SOURCE #-} GHC.Types.TypeAndCoercion( Type, Kind, pprKind )
import {-# SOURCE #-} GHC.Haskell.TypeCheck.Type( TcTyVarDetails, 
                                                      pprTcTyVarDetails,
                                                      vanillaSkolemTv )
import {-# SOURCE #-} GHC.Types.Id.Info ( IdDetails, IdInfo, coVarDetails,
...
-- home in GHC.Types.TypeAndCoercion, because it's used in
-- GHC.Types.DataCon .hs-boot file
...
mkTcTyVar name kind details
  = -- NB: 'kind' may be a coercion kind;
    -- cf, 'GHC.Haskell.TypeCheck.MutableType.newMetaCoVar'
...
-- See Note [TcTyVars in the typechecker] in GHC.Haskell.TypeCheck.Type
