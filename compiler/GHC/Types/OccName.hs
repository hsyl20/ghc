...
-- see also: Note [Data Constructor Naming] in GHC.Types.DataCon
--
-- $real_vs_source_data_constructors
...
-- See Note [Demotion] in GHC.Haskell.Rename.Environment
...
-- TyConRepName stuff; see Note [Grand plan for Typeable] in GHC.Haskell.Derive.Typeable
...
(See GHC.Haskell.TypeCheck.ClassDeclaration.tcMethodBind)
