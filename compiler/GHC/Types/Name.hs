...
import {-# SOURCE #-} GHC.Types.TypeAndCoercion( TyThing )
...
-- See Note [The interactive package] in GHC.Types.Base
...
-- (see Note [The Name Cache] in GHC.Interface.Environment), so don't just
...
-- 'GHC.Interface.Syntax.putIfaceTopBndr' and
-- 'GHC.Interface.Syntax.getIfaceTopBndr' for serializing binding 'Name's.
...
-- See Note [Printing original names] in GHC.Types.Base
...
This pprPrefixName stuff is really only used when printing GHC.Haskell,
...
type being pretty printed; eg the pretty-printing code in GHC.Types.TypeAndCoercion.
