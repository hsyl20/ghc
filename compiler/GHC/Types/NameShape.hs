...
-- The 'NameShape' type is defined in GHC.Haskell.TypeCheck.Types, because
-- GHC.Haskell.TypeCheck.Types needs to refer to NameShape, and having
-- GHC.Haskell.TypeCheck.Types import NameShape (even by SOURCE) would
