...
import GHC.Types.OccName ( OccName )
...
-- See also Note [coreView vs tcView] in GHC.Types.Type.
{-# INLINE tcView #-}
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
As noted in Note [Forall coercions] in GHC.Types.TypeAndCoercion, a ForAllCo is
...
Notably this plays a role in tcTySigs in GHC.Haskell.TypeCheck.Binding
...
-- See also Note [Non-trivial definitional equality] in GHC.Types.TypeAndCoercion.
...
nonDetCmpTypeX :: RnEnv2 -> Type -> Type -> Ordering  -- Main workhorse
    -- See Note [Non-trivial definitional equality] in GHC.Types.TypeAndCoercion
