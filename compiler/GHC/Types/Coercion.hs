...
%*                                                                      *
     ...
     -- See [Coercion axioms applied to coercions] in GHC.Types.TypeAndCoercion
...
-- Outputable instances are in GHC.Types.TypeAndCoercion, to avoid orphans
...
-- of Coercion and the Note [Refl invariant] in GHC.Types.TypeAndCoercion.
...
{- Note [mkCoVarCo]
~~~~~~~~~~~~~~~~~~~
In the past, mkCoVarCo optimised (c :: t~t) to (Refl t).  That is valid
(although see Note [Unbound RULE binders] in GHC.Core.Rules), but
it's a relatively expensive test and perhaps better done in optCoercion.  Not a
big deal either way.
-}
...
-- See Note [Newtype coercions] in GHC.Types.TyCon
...
data LiftingContext = LC TCvSubst LiftCoEnv
  ...
  -- See Note [Optimising InstCo] in GHC.Types.Coercion.Optimise
