...
-- instance. See Note [Safe Haskell isSafeOverlap] (in GHC.Types.Instance)
...
-- See Note [Rules for instance lookup] in GHC.Types.Instance
data OverlapMode
...
data TyPrec   -- See Note [Precedence in types] in GHC.Types.TypeAndCoercion
  = TopPrec         -- No parens
...
See Note [Rules and inlining/other rules] in GHC.Compiler.HaskellToCore.
