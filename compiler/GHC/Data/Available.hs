...
plusAvail a1 a2
  ...
  = pprPanic "GHC.IR.Haskell.Renamer.Environment.plusAvail names differ" (hsep [ppr a1,ppr a2])
...
plusAvail a1 a2 = pprPanic "GHC.IR.Haskell.Renamer.Environment.plusAvail" (hsep [ppr a1,ppr a2])
