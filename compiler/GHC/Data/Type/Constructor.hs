 ...
 * [Type inference for type families with injectivity] in GHC.IR.Haskell.TypeSystem.Constraint.Interact
...
-- See also Note [Decomposing equality] in GHC.IR.Haskell.TypeSystem.Constraint.Canonicaliser
