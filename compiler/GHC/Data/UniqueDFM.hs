...
See Note [Unique Determinism] in GHC.CoreTypes.Unique for explanation why @Unique@
...
import GHC.Data.UniqueFM (UniqFM, listToUFM_Directly, nonDetUFMToList
                         , ufmToIntMap)
...
-- See Note [Unique Determinism] in GHC.CoreTypes.Unique.
--
--
