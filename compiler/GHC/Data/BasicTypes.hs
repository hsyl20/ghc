...
--  fib 100     has arity 0
--  \x -> fib x has arity 1
-- See also Note [Definition of arity] in GHC.IR.Core.Arity
type Arity = Int
...
If you want to know where InlinePragmas take effect: Look in GHC.Compilers.SyntaxToCore.Binding.makeCorePair
