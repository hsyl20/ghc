...
data IdDetails
  ...
  | RecSelId
    ...
    }                           -- See Note [Naughty record selectors] in GHC.IR.Haskell.TypeSystem.TypeAndClassDeclaration
...
In GHC.IR.Interface.Tidy, when the LocalId becomes a GlobalId, its RULES are stripped off
