...
import qualified GHC.Util.SysTools
...
endMkDependHS dflags
  ...
  when (isJust makefile_hdl)
       (GHC.Util.SysTools.copy dflags ("Backing up " ++ makefile)
          makefile (makefile++".bak"))

        -- Copy the new makefile in place
  GHC.Util.SysTools.copy dflags "Installing new makefile" tmp_file makefile
