...
import GHC.CoreTypes.Type              ( Type, Kind )
import GHC.Core.Lint                   ( lintInteractiveExpr )
import GHC.CoreTypes.Var.Environment   ( emptyTidyEnv )
import GHC.Util.Panic
import GHC.CoreTypes.ConLike
import Control.Concurrent

import GHC.CoreTypes.Available ( Avails )
...
import qualified GHC.StgToCmm as StgToCmm
import GHC.Stg.Syntax
import GHC.CoreTypes.CostCentre
import GHC.CoreTypes.CostCentre.Init
...
import GHC.Cmm.InfoTableBuilder
...
import GHC.Util.Platform              ( platformOS, osSubsectionsViaSymbols )

import GHC.Util.Outputable
import GHC.CoreTypes.Name.Environment
import GHC.Haskell.Stats   ( ppSourceStats )
...
-- GHC.Haskell.Rename.ImportExport.rnImportDecl for where package trust
-- dependencies for a module are collected and unioned.  Specifically see the
-- Note [GHC.Haskell.Rename.ImportExport . Tracking Trust Transitively] and
-- the Note [GHC.Haskell.Rename.ImportExport . Trust Own Package].
 ...
 runInteractiveHsc hsc_env0 $ do
    ...
    let tcs = filterOut isImplicitTyCon (mg_tcs simpl_mg)
        ...
        ext_ids = [ id | id <- bindersOfBinds core_binds
            ...
            -- (as decided by GHC.Interface.Tidy), since those
