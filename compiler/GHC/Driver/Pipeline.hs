...
import GHC.Types.Base hiding ( Hsc )
...
import GHC.Types.BasicTypes           ( SuccessFlag(..) )
  ...
  let mySettings = settings dflags
      ...
      ld_r args cc = SysTools.runLink dflags ([
                       ...
                       SysTools.Option "-Wl,-r"
                        ...
                        -- See Note [No PIE while linking] in GHC.Utils.SysTools
...
Introduction
  ...
  `GHC.Compiler.HaskellToCore.Coverage.isGoodTickSrcSpan`, we compare the
  filename that a `SrcSpan` refers to with the name of the file we are currently
  compiling.  For some reason I don't yet understand, they can sometimes
  legitimally be different, and then hpc ignores that SrcSpan.
