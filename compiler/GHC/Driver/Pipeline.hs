...
import GHC.CoreTypes.BasicTypes        ( SuccessFlag(..) )
  ...
  let mySettings = settings dflags
      ...
      ld_r args cc = SysTools.runLink dflags ([
                       ...
                       SysTools.Option "-Wl,-r"
                        ...
                        -- See Note [No PIE while linking] in GHC.Util.SysTools
...
Introduction
  ...
  `GHC.HaskellToCore.Coverage.isGoodTickSrcSpan`, we compare the
