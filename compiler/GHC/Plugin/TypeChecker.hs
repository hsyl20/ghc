...
import qualified GHC.Haskell.TypeCheck.Constraint.Solve  as TcS
...
import GHC.Haskell.TypeCheck  ( TcGblEnv, TcLclEnv, Ct, CtLoc, TcPluginM
                                   , unsafeTcPluginTcM, getEvBindsTcPluginM
                                   , liftIO, traceTc )
import GHC.Haskell.TypeCheck.MutableType ( TcTyVar, TcType )
import GHC.Haskell.TypeCheck.Environment ( TcTyThing )
import GHC.Haskell.TypeCheck.Evidence    ( TcCoercion, CoercionHole
                                              , EvTerm, EvBind
                                              , mkGivenEvBind )
import GHC.Haskell.TypeCheck.Types       ( CtEvidence(..) )
...
findImportedModule mod_name mb_pkg = do
    hsc_env <- getTopEnv
    tcPluginIO $ GHC.Driver.Finder.findImportedModule hsc_env mod_name mb_pkg
