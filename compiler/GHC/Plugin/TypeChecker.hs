...
import qualified GHC.IR.Haskell.TypeChecker.Constraint.Solver  as TcS
...
import qualified GHC.IR.Haskell.TypeChecker.FamilyInstance     as TcM
import qualified GHC.IR.Interface.Environment as IfaceEnv
import qualified GHC.Utils.Finder

import GHC.Entity.FamilyInstance   ( FamInstEnv )
import GHC.IR.Haskell.TypeChecker  ( TcGblEnv, TcLclEnv, Ct, CtLoc, TcPluginM
                                   , unsafeTcPluginTcM, getEvBindsTcPluginM
                                   , liftIO, traceTc )
import GHC.IR.Haskell.TypeChecker.MutableType ( TcTyVar, TcType )
import GHC.IR.Haskell.TypeChecker.Environment ( TcTyThing )
import GHC.IR.Haskell.TypeChecker.Evidence    ( TcCoercion, CoercionHole
                                              , EvTerm, EvBind
                                              , mkGivenEvBind )
import GHC.IR.Haskell.TypeChecker.Types       ( CtEvidence(..) )
