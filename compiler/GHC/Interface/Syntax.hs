...
import GHC.Core.Printer    ()            -- Printing DFunArgs
import GHC.Types.Demand
import GHC.Types.Class
import GHC.Types.FieldLabel
import GHC.Types.Name.Set
import GHC.Types.Coercion.Axiom ( BranchIndex )
import GHC.Types.Name
import GHC.Types.CostCentre
import GHC.Types.Literal
import GHC.Types.ForeignCall
import GHC.Types.Annotation( AnnPayload, AnnTarget )
...
import GHC.Types.Var             ( TyVarBndr(..) )
import GHC.Types.TyCon ( Role (..), Injectivity(..) )
import GHC.Utils                  ( filterOut, filterByList )
import GHC.Types.DataCon (SrcStrictness(..), SrcUnpackedness(..))
...
type IfaceTopBndr = Name
  -- It's convenient to have an Name in the GHC.Interface.Syntax, although in
...
data IfaceAxBranch = IfaceAxBranch { ifaxbTyVars   :: [IfaceTvBndr]
                                   ...
                                   , ifaxbIncomps  :: [BranchIndex] }
                                     -- See Note [Storing compatibility] in
                                     -- GHC.Types.Coercion.Axiom
...
data IfaceConDecl
  = IfCon {
        ...
        ifConStricts :: [IfaceBang],
          ...
          -- See Note [Bangs on imported data constructors] in
          -- GHC.Types.Id.Make
...
data IfaceClsInst
  = IfaceClsInst { ifInstCls  :: IfExtName,          -- See comments with
                   ...
                   ifInstOrph :: IsOrphan }          -- See Note [Orphans] in
                                                     -- GHC.Types.Instance
...
-- See Note [Implicit TyThings] in GHC.Types.Base

-- N.B. the set of names returned here *must* match the set of
-- TyThings returned by GHC.Types.Base.implicitTyThings, in the sense that
-- TyThing.getOccName should define a bijection between the two lists.
-- This invariant is used in GHC.Interface.Load.loadDecl (see note [Tricky
-- iface loop])
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
In GHC.Interface.Syntax an IfaceCase does not record the types of the
...
GHC.Interface.Load.loadDecl calculates the list of (Name, TyThing) bindings
