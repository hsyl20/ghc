...
-- See Note [Implicit TyThings] in GHC.CoreTypes.Base

-- N.B. the set of names returned here *must* match the set of
-- TyThings returned by GHC.CoreTypes.Base.implicitTyThings, in the sense that
...
(see GHC.Util.PrettyPrint.TyThing), the TyThing may come from some other module
...
--     See Note [Pretty-printing TyThings] in GHC.Util.PrettyPrint.TyThing
