...
import GHC.Types.FamilyInstance   ( FamInstEnvs, mkNewTypeCoAxiom )
...
See Note [TyVarBinders in DataCons] in GHC.Types.DataCon.
...
in GHC.Types.TypeAndCoercion), so we change it to Specified when making MkT's
TyBinders
...
-- Called in GHC.Interface.BuildTypeAndClass to allocate the implicit binders
-- of type/class decls
-- For source type/class decls, this is the first occurrence
-- For iface ones, the GHC.Interface.Load has already allocated a suitable
-- name in the cache
