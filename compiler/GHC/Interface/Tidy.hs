...
GHC.Core.Inliner.mkImplicitUnfolding uses simpleOptExpr to do a
...
GHC.Core.Monad.  But that gave rise to real difficulty,
...
Oh: two other reasons for injecting them late:
  ...
  - If implicit Ids are already in the bindings when we start
    GHC.Interface.Tidy, we'd have to be careful not to treat
...
See Note [Data constructor workers] in GHC.Core.Prepare.
-}
...
GHC.Interface.Tidy.  But CorePrep does some transformations
