...
import GHC.Types.TyCon hiding ( pprPromotionQuote )
...
-- and Note [The oneShot function] in GHC.Types.Id.Make
data IfaceOneShot    
  = IfaceNoOneShot
  | IfaceOneShot
...
GHC.Types.TypeAndCoercion we only keep the hole's Unique, since that is all we
need to print.
-}
...
-- See equivalent function in GHC.Types.TypeAndCoercion
