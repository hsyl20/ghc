...
module GHC.Compiler.CmmToAsm.Register.Allocator.Linear.FreeRegs (
    FR(..),
    maxSpillSlots
)
...
import qualified GHC.Compiler.CmmToAsm.PPC.Instr as PPC.Instr
import qualified GHC.Compiler.CmmToAsm.SPARC.Instr as SPARC.Instr
