...
@GHC.Compilers.HaskellToCore.Monad@: monadery used in desugaring
-}

{-# LANGUAGE FlexibleInstances, FlexibleContexts #-}
{-# OPTIONS_GHC -fno-warn-orphans #-}  -- instance MonadThings is necessarily an orphan

module GHC.Compilers.HaskellToCore.Monad (
...
mkDsEnvs dflags mod rdr_env type_env fam_inst_env msg_var pmvar
  ...
  = let if_genv = IfGblEnv { if_doc       = text "mkDsEnvs",
        ...
        gbl_env = DsGblEnv { ds_mod     = mod
                           ...
                           , ds_parr_bi = panic "GHC.Compilers.HaskellToCore.Monad: uninitialised ds_parr_bi"
...
of cases; see calls to GHC.Compilers.HaskellToCore.Monad.dsNoLevPoly and friends.
...
but we can't, because of the fixM in GHC.Compilers.HaskellToCore.Arrow. It's all OK, though:
...
-- of the fixM used in GHC.Compilers.HaskellToCore.Arrow. See Note [Levity polymorphism checking]
...
--
-- c.f. GHC.IR.Haskell.TypeSystem.askNoErrs
...
dsLoadModule doc mod
  = do { env    <- getGblEnv
       ...
       ; case iface of
           Failed err      -> pprPanic "GHC.Compilers.HaskellToCore.Monad.dsLoadModule: failed to load" (err $$ doc)
