...
module GHC.IR.Stg.Transformer.CostCentreCollecter ( stgMassageForProfiling ) where

#include "HsVersions.h"

import GHC.IR.Stg.Syntax

import GHC.Entity.CostCentre       -- lots of things
...
stgMassageForProfiling dflags mod_name _us stg_binds
  ...
  where
    ...
    do_expr other = pprPanic "GHC.IR.Stg.Transformer.CostCentreCollecter.do_expr" (ppr other)
