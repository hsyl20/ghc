...
module GHC.IR.Stg.Utils ( fixStgRegisters ) where
...
baseRegOffset _      BaseReg             = panic "GHC.IR.Stg.Utils.baseRegOffset:BaseReg"
baseRegOffset _      PicBaseReg          = panic "GHC.IR.Stg.Utils.baseRegOffset:PicBaseReg"
baseRegOffset _      MachSp              = panic "GHC.IR.Stg.Utils.baseRegOffset:MachSp"
baseRegOffset _      UnwindReturnReg     = panic "GHC.IR.Stg.Utils.baseRegOffset:UnwindReturnReg"
