...
module GHC.IR.Stg.Analyser.Lint ( lintStgTopBindings ) where

import GHC.IR.Stg.Syntax

import GHC.Data.Bag              ( Bag, emptyBag, isEmptyBag, snocBag, bagToList )
import GHC.Entity.Id               ( Id, idType, isLocalId )
import GHC.Entity.Var.Set
import GHC.Entity.DataConstructor
import GHC.IR.Core.Syntax          ( AltCon(..) )
import GHC.Builtin.Primitive.Operations           ( primOpType )
import GHC.Entity.Literal          ( literalType )
import GHC.Data.Maybe
import GHC.Entity.Name             ( getSrcLoc )
