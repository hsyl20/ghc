...
module GHC.IR.Haskell.TypeChecker.Matches
   ( tcMatchesFun, tcGRHS, tcGRHSsPat, tcMatchesCase, tcMatchLambda
...
tcMatchLambda :: SDoc -- see Note [Herald for matchExpectedFunTys]
                      -- in GHC.IR.Haskell.TypeChecker.Unify
              -> TcMatchCtxt HsExpr
              -> MatchGroup GhcRn (LHsExpr GhcRn)
