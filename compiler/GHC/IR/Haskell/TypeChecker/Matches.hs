...
GHC.IR.Haskell.TypeChecker.Matches: Typecheck some @Matches@
-}
...
module GHC.IR.Haskell.TypeChecker.Matches ( tcMatchesFun, tcGRHS, tcGRHSsPat, tcMatchesCase, tcMatchLambda,
                   TcMatchCtxt(..), TcStmtChecker, TcExprStmtChecker, TcCmdStmtChecker,
                   tcStmts, tcStmtsAndThen, tcDoStmts, tcBody,
                   tcDoStmt, tcGuardStmt
       ) where

import {-# SOURCE #-}   GHC.IR.Haskell.TypeChecker.Expression( tcSyntaxOp, tcInferSigmaNC, tcInferSigma
...
See Note [sig_tau may be polymorphic] in GHC.IR.Haskell.TypeChecker.Pattern.
-}
...
tcMatchLambda :: SDoc -- see Note [Herald for matchExpectedFunTys] in GHC.IR.Haskell.TypeChecker.Unify
              -> TcMatchCtxt HsExpr
              -> MatchGroup GhcRn (LHsExpr GhcRn)
