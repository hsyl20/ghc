...
\section[GHC.IR.Haskell.TypeChecker.Foreign]{Typechecking \tr{foreign} declarations}
...
module GHC.IR.Haskell.TypeChecker.Foreign
        ( tcForeignImports
        , tcForeignExports
  ...
  where
    ...
    go_tc_app rec_nts tc tys
        ...
        , Just rec_nts' <- checkRecTc rec_nts tc
                   -- See Note [Expanding newtypes] in
...
for the newtype constructors they see. Then GHC.IR.Haskell.TypeChecker.Module can add them
       ...
       ; let
           ...
           -- structure of the foreign type.
             ...
             id                = mkLocalId nm sig_ty
                 ...
                 -- (so GHC.IR.Haskell.TypeChecker.Syntax.zonkForeignExports ignores it).
