...
for the newtype constructors they see. Then GHC.IR.Haskell.TypeChecker.Module
can add them to the module's usages.
       ...
       ; let
           ...
           -- structure of the foreign type.
             ...
             id                = mkLocalId nm sig_ty
                 ...
                 -- (so GHC.IR.Haskell.TypeChecker.Syntax.zonkForeignExports
                 -- ignores it).
