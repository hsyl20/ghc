...
--
-- The Id is never a DataCon. (Why does that matter? see GHC.IR.Haskell.TypeChecker.Expression.tcId)
tcLookupId name = do
    thing <- tcLookup name
    case thing of
...
to the environment. Then GHC.IR.Haskell.TypeChecker.UserType.tcTyVar will find A in the kind
