...
Various types used during typechecking, please see GHC.IR.Haskell.TypeChecker as
well for operations on these types. You probably want to import it, instead of
this module.
...
data IfLclEnv
  = IfLclEnv {
        ...
        -- See Note [Resolving never-exported Names]
...
--        See lookupIfaceTop in GHC.IR.Interface.Environment, mkIface and
--        addFingerprints in GHC.IR.Interface.Utils, and tcLookupGlobal in
--        GHC.IR.Haskell.TypeChecker.Environment
--
...
--        Similarly, in GHC.IR.Haskell.Renamer.ImportExport we check for
--        self-imports using identity modules, to allow signatures to import
--        their implementor.
--
...
type ThBindEnv = NameEnv (TopLevelFlag, ThLevel)
   ...
   -- bound at top level!  See Note [Template Haskell levels] in
   -- GHC.IR.Haskell.TypeChecker.Splice
...
-- See Note [Template Haskell state diagram] in
-- GHC.IR.Haskell.TypeChecker.Splice
data ThStage    
...
-- See 'GHC.IR.Haskell.TypeChecker.Environment' for how to retrieve a 'TyThing'
-- given a 'Name'.
data TcTyThing
...
data PromotionErr
  ...
  | FamDataConPE     -- Data constructor for a data family
                     -- See Note [AFamDataCon: not promoting data family
                     -- constructors] in GHC.IR.Haskell.TypeChecker.Module
  | PatSynPE         -- Pattern synonyms
                     -- See Note [Don't promote pattern synonyms] in
                     -- GHC.IR.Haskell.TypeChecker.Environment

  | RecDataConPE     -- Data constructor in a recursive loop
                     -- See Note [ARecDataCon: recusion and promoting data
                     -- constructors] in
                     -- GHC.IR.Haskell.TypeChecker.TypeAndClassDeclaration
...
--
-- a) for static forms in
--    GHC.IR.Haskell.TypeChecker.Expression.checkClosedInStaticForm and
...
data ImportAvails
   = ImportAvails {
        imp_mods :: ImportedMods,
          ...
          --
          -- See the documentation on ImportedModsVal in GHC.Entity.Types for
        ...
        imp_trust_pkgs :: Set InstalledUnitId,
          ...
          -- See Note [Tracking Trust Transitively] in
          -- GHC.IR.Haskell.Renamer.ImportExport. 

        imp_trust_own_pkg :: Bool,
          -- ^ Do we require that our own package is trusted?
          -- This is to handle efficiently the case where a Safe module imports
          -- a Trustworthy module that resides in the same package as it.
          -- See Note [Trust Own Package] in
          -- GHC.IR.Haskell.Renamer.ImportExport. 
...
data WhereFrom
  ...
  | ImportByPlugin                      -- Importing a plugin;
                                        -- See Note [Care with plugin imports]
                                        -- in GHC.IR.Interface.Loader
...
-- GHC.IR.Haskell.TypeChecker.Constraint.Simplifier uses them, and
-- GHC.IR.Haskell.TypeChecker.Constraint.Simplifier is fairly low down in the
-- module hierarchy
...
data TcIdSigInfo   -- See Note [Complete and partial type signatures]
  ...
  | PartialSig     -- A partial type signature (i.e. includes one or more
      ...
      { psig_name  :: Name               -- Name of the function; used when
                                         -- report wildcards
...
data TcIdSigInst
  = TISI { sig_inst_sig :: TcIdSigInfo
         ...
         , sig_inst_skols :: [(Name, TcTyVar)]
               ...
               -- See Note [Binding scoped type variables] in
               -- GHC.IR.Haskell.TypeChecker.Signature
...
data TcPatSynInfo
  = TPSI {
        ...
        patsig_implicit_bndrs :: [TyVarBinder], -- Implicitly-bound kind vars (Inferred) and
          ...
          -- See Note [The pattern-synonym signature splitting rule] in
          -- GHC.IR.Haskell.TypeChecker.PatternSynonym
...
-- We enforce the structure of Xi types when we flatten
-- (GHC.IR.Haskell.TypeChecker.Constraint.Canonicaliser)
...
data Ct
  ...
  = CDictCan {  -- e.g.  Num xi
      ...
      cc_pend_sc :: Bool -- See Note [The superclass story] in 
                         -- GHC.IR.Haskell.TypeChecker.Constraint.Canonicaliser
  ...
  | CTyEqCan {  -- tv ~ rhs
       -- Invariants:
       --   * See Note [Applying the inert substitution] in
       --     GHC.IR.Haskell.TypeChecker.Flatten
...
See Note [The superclass story] in
GHC.IR.Haskell.TypeChecker.Constraint.Canonicaliser.
-}
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
First read Note [The superclass story] in
GHC.IR.Haskell.TypeChecker.Constraint.Canonicaliser.
...
data ImplicStatus
  = IC_Solved     -- All wanteds in the tree are solved, all the way down
       ...
       , ics_dead :: [EvVar] }  -- Subset of ic_given that are not needed
         -- See Note [Tracking redundant constraints] in
         -- GHC.IR.Haskell.TypeChecker.Constraint.Simplifier
...
Instead, ic_skols is used only when considering floating a constraint outside
the implication in
GHC.IR.Haskell.TypeChecker.Constraint.Simplifier.floatEqualities or
...
See Note [The improvement story and derived shadows] in
...
improvement works; see Note [The improvement story] in
GHC.IR.Haskell.TypeChecker.Constraint.Interact.
...
sense of Definition [Can-rewrite relation] in
GHC.IR.Haskell.TypeChecker.Constraint.Solver.
...
* Then when tidying in GHC.IR.Haskell.TypeChecker.MutableType.tidySkolemInfo, we
  first tidy a' to whatever it tidies to, say a''; and then we walk over the
  type replacing the binder a by the tidied version a'', to give
