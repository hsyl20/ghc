...
GHC.IR.Haskell.TypeChecker.Splice: Template Haskell splices
-}
...
"GHC.IR.Haskell.Renamer.Splice"). Thus after executing the splice, we move the finalizers to the
...
like that.  Here's how it's processed:
  ...
  * The TcM monad is an instance of Quasi (see GHC.IR.Haskell.TypeChecker.Splice), and it implements
...
-- This is a specialised version of GHC.IR.Haskell.TypeChecker.Environment.tcLookup; specialised mainly in that
       ...
       ; main_con <-
           if | not (null fields) && not isGadtDataCon ->
              ...
              | not (null fields) -> do
                ...
                -- See Note [Infix GADT constructors] in GHC.IR.Haskell.TypeChecker.TypeAndClassDeclaration.
