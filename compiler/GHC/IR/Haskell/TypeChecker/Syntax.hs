...
module GHC.IR.Haskell.TypeChecker.Syntax (
...
import GHC.Entity.TypeConstructor   ( isUnboxedTupleTyCon )
...
************************************************************************
*                                                                      *
\subsection[BackSubst-GHC.IR.Haskell.Syntax.Binding]{Running a substitution over @GHC.IR.Haskell.Syntax.Binding@}
*                                                                      *
************************************************************************
...
-- Confused by zonking? See Note [What is zonking?] in GHC.IR.Haskell.TypeChecker.MutableType.
...
is justified by the use of newUnique in GHC.IR.Haskell.TypeChecker.MutableType.instSkolTyCoVarX.)
...
zonkVect _ (HsVectTypeIn _ _ _ _) = panic "GHC.IR.Haskell.TypeChecker.Syntax.zonkVect: HsVectTypeIn"
zonkVect _env (HsVectClassOut c)
  = return $ HsVectClassOut c
zonkVect _ (HsVectClassIn _ _) = panic "GHC.IR.Haskell.TypeChecker.Syntax.zonkVect: HsVectClassIn"
zonkVect _env (HsVectInstOut i)
  = return $ HsVectInstOut i
zonkVect _ (HsVectInstIn _) = panic "GHC.IR.Haskell.TypeChecker.Syntax.zonkVect: HsVectInstIn"
