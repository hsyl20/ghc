...
GHC.IR.Haskell.TypeChecker.FunctionalDependency - functional dependencies
...
module GHC.IR.Haskell.TypeChecker.FunctionalDependency (
...
import GHC.IR.Haskell.TypeChecker.Type( transSuperClasses )
import GHC.Entity.Coercion.Axiom( TypeEqn )
import GHC.Utils.Unify
import GHC.IR.Haskell.TypeChecker.FamilyInstance( injTyVarsOfTypes )
...
Remember from Note [The equality types story] in GHC.Builtin.Primitive.Types, that
