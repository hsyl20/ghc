...
GHC.IR.Haskell.TypeChecker.TypeAndClassDeclaration: Typecheck type and class
declarations
-}
...
-- See Note [TyClGroups and dependency analysis] in GHC.IR.Haskell.Syntax.Declaration
...
Then:
  ...
  * During GHC.IR.Haskell.TypeChecker.UserType.kcTyVar we look in the *local* env, to get the
    known kind for T.

  * But in GHC.IR.Haskell.TypeChecker.UserType.ds_type (and ds_var_app in particular) we look in
  ...
  = -- Closed type families are a little tricky, because they contain the definition
    ...
    do { traceTc "Closed type family:" (ppr tc_name)
       ...
       ; branches <- mapM (tcTyFamInstEqn fam_tc_shape Nothing) eqns
         ...
         -- for this afterwards, in GHC.IR.Haskell.TypeChecker.Validity.checkValidCoAxiom
         -- Example: tc265
  ...
  = do { -- Kind-check and quantify
         ...
         do { (insting_subst, _leftover_binders, args, leftovers, n)
            ...
            ; case leftovers of
                ...
                _       -> return ()
              -- don't worry about leftover_binders; GHC.IR.Haskell.TypeChecker.Validity catches them
...
2. Internally, GHC uses TypeApplications to instantiate the default method in
   an instance. See Note [Default methods in instances] in GHC.IR.Haskell.TypeChecker.Instance.
    ...
    check_dc_roles datacon
      = do { traceTc "check_dc_roles" (ppr datacon <+> ppr (tyConRoles tc))
           ; mapM_ (check_ty_roles role_env Representational) $
                    ...
                    -- See Note [Role-checking data constructor arguments] in GHC.IR.Haskell.TypeChecker.TypeDeclaration
      where
