...
module GHC.IR.Haskell.TypeChecker.Module (
...
import {-# SOURCE #-} GHC.IR.Haskell.TypeChecker.Splice ( finishTH )
...
import GHC.IR.Haskell.TypeChecker.Matches
import GHC.IR.Haskell.TypeChecker.Instantiation( deeplyInstantiate )
import GHC.IR.Haskell.TypeChecker.Unify( checkConstraints )
...
import GHC.Entity.Id.Make
import GHC.IR.Interface.Transformer.Tidier    ( globaliseAndTidyId )
...
import GHC.IR.Haskell.TypeChecker.Export
...
import GHC.Entity.Coercion( pprCoAxiom )
import GHC.IR.Core.Analyser.FreeVars( orphNamesOfFamInst )
import GHC.IR.Haskell.TypeChecker.FamilyInstance
import GHC.Entity.ClassInstance
import GHC.Entity.FamilyInstance
import GHC.IR.Haskell.TypeChecker.Annotation
import GHC.IR.Haskell.TypeChecker.Binding
import GHC.IR.Haskell.Parser.HeaderInfo       ( mkPrelImports )
import GHC.IR.Haskell.TypeChecker.Default
import GHC.IR.Haskell.TypeChecker.Environment
import GHC.IR.Haskell.TypeChecker.Rule
import GHC.IR.Haskell.TypeChecker.Foreign
import GHC.IR.Haskell.TypeChecker.Instance
...
import GHC.IR.Haskell.TypeChecker.TypeAndClassDeclaration
import GHC.IR.Haskell.Deriver.Typeable ( mkTypeableBinds )
import GHC.IR.Haskell.TypeChecker.ModuleSignature
import GHC.IR.Interface.Loader
import GHC.IR.Haskell.Renamer.ImportExport
import GHC.IR.Haskell.Renamer.Environment
import GHC.IR.Haskell.Renamer
import GHC.Utils.Error
import GHC.Entity.Id as Id
...
import GHC.Utils
import GHC.Data.Bag
import GHC.IR.Haskell.TypeChecker.Instantiation (tcGetInsts)
...
tcRnModuleTcRnM hsc_env hsc_src
 ...
 = setSrcSpan loc $
   do { let { explicit_mod_hdr = isJust maybe_mod } ;
        ...
        -- interface files, via GHC.IR.Haskell.TypeChecker.Environment.setGlobalTypeEnv
...
tcRnHsBootDecls hsc_src decls
   = do { (first_group, group_tail) <- findSplice decls
        ...
        -- See Note [Extra dependencies from .hs-boot files] in GHC.IR.Haskell.Renamer
...
checkHiBootIface'
  ...
  = do  { traceTc "checkHiBootIface" $ vcat
        ...
        ; unless (null boot_fam_insts) $
            panic ("GHC.IR.Haskell.TypeChecker.Module.checkHiBootIface: Cannot handle family " ++
...
tcRnStmt hsc_env rdr_stmt
  = runTcInteractive hsc_env $ do {
    ...
    global_ids <- mapM (externaliseAndTidyId this_mod) zonked_ids ;
        -- Note [Interactively-bound Ids in GHCi] in GHC.Entity.Types
...
-- in GHCi] in GHC.Entity.Types for more details. We do this lifting by trying
...
tcGhciStmts stmts
 = do { ioTyCon <- tcLookupTyCon ioTyConName ;
        ...
        traceTc "GHC.IR.Haskell.TypeChecker.Module.tcGhciStmts: tc stmts" empty ;
        ...
        traceTc "GHC.IR.Haskell.TypeChecker.Module.tcGhciStmts: simplify ctxt" empty ;
        const_binds <- checkNoErrs (simplifyInteractive lie) ;
                -- checkNoErrs ensures that the plan fails if context redn fails

        traceTc "GHC.IR.Haskell.TypeChecker.Module.tcGhciStmts: done" empty ;
...
tcRnExpr hsc_env mode rdr_expr
  = runTcInteractive hsc_env $
    ...
    -- same as of a bound expression (GHC.IR.Haskell.TypeChecker.Binding.mkInferredPolyId). See Trac
