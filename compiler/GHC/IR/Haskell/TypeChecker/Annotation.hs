...
\section[GHC.IR.Haskell.TypeChecker.Annotation]{Typechecking annotations}
-}

{-# LANGUAGE CPP #-}
{-# LANGUAGE FlexibleContexts #-}

module GHC.IR.Haskell.TypeChecker.Annotation ( tcAnnotations, annCtxt ) where

import {-# SOURCE #-} GHC.IR.Haskell.TypeChecker.Splice ( runAnnotation )
