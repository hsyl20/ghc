...
data HsWrapper
  ...
  | WpFun HsWrapper HsWrapper TcType SDoc
       ...
       -- the desugarer. See Note [Levity polymorphism checking] in
...
and the constraint
    [G] g1 :: a~Bool
See Trac [7238] and Note [Bind new Givens immediately] in
...
3. We default any insoluble CallStacks to the empty CallStack. Suppose
   ...
   (see GHC.IR.Haskell.TypeChecker.Constraint.Simplifier.simpl_top and
   GHC.IR.Haskell.TypeChecker.Constraint.Simplifier.defaultCallStacks)
