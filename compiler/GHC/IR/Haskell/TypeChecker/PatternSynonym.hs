...
\section[GHC.IR.Haskell.TypeChecker.PatternSynonym]{Typechecking pattern synonym declarations}
-}
...
import GHC.Entity.Var.Environment( emptyTidyEnv, mkInScopeSet )
import GHC.Entity.Id
import GHC.Entity.Id.Info( RecSelParent(..), setLevityInfoWithType )
  ...
  = addPatSynCtxt lname $
    do { let decl_arity = length arg_names
       ...
       ; (tclvl, wanted, (lpat', (ex_tvs', prov_dicts, args'))) <-
           ...
           do { let in_scope    = mkInScopeSet (mkVarSet univ_tvs)
              ...
              ; let prov_theta' = substTheta subst prov_theta
                  ...
                  -- substitution.
                  -- See also Note [The substitution invariant] in GHC.Entity.TypeAndCoercion.
       ...
       ; let skol_info = SigSkol (PatSynCtxt name) pat_ty []
                         ...
                         -- See GHC.IR.Haskell.TypeChecker.Types Note [Skolem info for pattern synonyms]
...
Any change to this ordering should make sure to change
GHC.Compiler.HaskellToCore.Expression if you want to avoid difficult to decipher
core lint errors!
 -}
