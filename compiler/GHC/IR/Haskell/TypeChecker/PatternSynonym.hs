...
module GHC.IR.Haskell.TypeChecker.PatternSynonym
...
import GHC.Entity.Id.Info                ( RecSelParent(..)
  ...
  = addPatSynCtxt lname $
    do { let decl_arity = length arg_names
       ...
       ; (tclvl, wanted, (lpat', (ex_tvs', prov_dicts, args'))) <-
           ...
           do { let in_scope    = mkInScopeSet (mkVarSet univ_tvs)
              ...
              ; let prov_theta' = substTheta subst prov_theta
                  ...
                  -- substitution.
                  -- See also Note [The substitution invariant] in
       ...
       ; let skol_info = SigSkol (PatSynCtxt name) pat_ty []
                         ...
                         -- See GHC.IR.Haskell.TypeChecker.Types
