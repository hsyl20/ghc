...
module GHC.IR.Haskell.TypeChecker.Instantiation (
       deeplySkolemise,
...
import {-# SOURCE #-}   GHC.IR.Haskell.TypeChecker.Expression( tcPolyExpr, tcSyntaxOp )
import {-# SOURCE #-}   GHC.IR.Haskell.TypeChecker.Unify( unifyType, unifyKind, noThing )

import GHC.Entity.BasicTypes ( IntegralLit(..), SourceText(..) )
...
import GHC.Entity.Id.Make   ( mkDictFunId )
import GHC.Entity.Id
import GHC.Entity.Name
import GHC.Entity.Var       ( EvVar, mkTyVar, tyVarName, TyVarBndr(..) )
...
-- newOverloadedLit in GHC.IR.Haskell.TypeChecker.Unify
...
newClsInst overlap_mode dfun_name tvs theta clas tys
  = do { (subst, tvs') <- freshenTyVarBndrs tvs
       ...
       ; let tys' = substTys subst tys
             ...
             --     an InstInfo, and in
             --     GHC.IR.Haskell.TypeChecker.Environment.pprInstInfoDetails
             --     it's helpful to use the same names
