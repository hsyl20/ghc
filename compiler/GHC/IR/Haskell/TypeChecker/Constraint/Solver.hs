...
module GHC.IR.Haskell.TypeChecker.Constraint.Solver (
    ...
    pprEq                                    -- Smaller utils, re-exported from TcM
                                             ...
                                             -- instance matcher in GHC.IR.Haskell.TypeChecker.Constraint.Simplifier. I am wondering
...
Conditions (K1-K3) are established by GHC.IR.Haskell.TypeChecker.Constraint.Solver.kickOutRewritable
...
rewrite Wanteds] in GHC.IR.Haskell.TypeChecker.Types), we may miss some opportunities for
