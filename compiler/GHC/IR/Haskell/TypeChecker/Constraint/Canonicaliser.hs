...
import GHC.Entity.TypeAndCoercion   -- cleverly decomposes types, good for completeness checking
...
3. If we have any remaining unsolved wanteds
   ...
   proof.  This is done in GHC.IR.Haskell.TypeChecker.Constraint.Simplifier.expandSuperClasses.
...
Furthermore, as explained in Note [NthCo and newtypes] in GHC.Entity.TypeAndCoercion, we can't use
...
constraints: see Note [Instance and Given overlap] in GHC.IR.Haskell.TypeChecker.Constraint.Interact.
...
GHC.IR.Haskell.TypeChecker.Constraint.Simplifier.applyTyVarDefaulting will find a
variable that has in fact been substituted.
...
canEqTyVar ev eq_rel swapped tv1 ps_ty1 (TyVarTy tv2) _
  ...
  = do { traceTcS "canEqTyVar" (ppr tv1 $$ ppr tv2 $$ ppr swapped)
         -- FM_Avoid commented out: see Note [Lazy flattening] in GHC.IR.Haskell.TypeChecker.Flatten
