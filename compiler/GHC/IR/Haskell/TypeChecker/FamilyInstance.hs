...
module GHC.IR.Haskell.TypeChecker.FamilyInstance (
...
import GHC.Entity.ClassInstance( roughMatchTcs )
...
import GHC.Entity.DataConstructor ( dataConName )
...
certain that the modules in our `GHC.Entity.Types.dep_finsts' are consistent.)
