...
* Increase kind polymorphism.  See GHC.IR.Haskell.TypeChecker.TypeAndClassDeclaration
...
rnTyClDecl (DataDecl { tcdLName = tycon, tcdTyVars = tyvars,
  ...
  = do { tycon' <- lookupLocatedTopBndrRn tycon
       ...
       ; ((tyvars', defn', no_kvs), fvs)
          ...
          -- See Note [Complete user-supplied kind signatures] in GHC.IR.Haskell.Syntax.Declaration
