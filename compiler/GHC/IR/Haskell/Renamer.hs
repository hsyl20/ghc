...
\section[GHC.IR.Haskell.Renamer]{Main pass of renamer}
-}
...
import {-# SOURCE #-} GHC.IR.Haskell.Renamer.Splice ( rnSpliceDecl
                                                    , rnTopSpliceDecls )
...
import GHC.IR.Haskell.TypeChecker.Annotation ( annCtxt )
import GHC.IR.Haskell.TypeChecker

import GHC.Entity.ForeignCall ( CCallTarget(..) )
import GHC.Entity.Module
import GHC.Entity.Types  ( Warnings(..), plusWarns )
import GHC.Entity.Class  ( FunDep )
...
import GHC.Data.Bag
import GHC.Entity.BasicTypes ( DerivStrategy, RuleName, pprRuleName )
import GHC.Data.FastString
import GHC.Entity.SrcLoc
import GHC.Config.Flags
import GHC.Utils             ( debugIsOn, lengthExceeds, partitionWith )
import GHC.Entity.Types      ( HscEnv, hsc_dflags )
...
checkCanonicalInstances cls poly_ty mbinds = do
  ...
  where
    ...
    -- stolen from GHC.IR.Haskell.TypeChecker.Instance
...
-- See Note [Associated type instances] in GHC.IR.Haskell.TypeChecker.Instance
...
rnHsVectDecl (HsVectTypeOut _ _ _)
  = panic "GHC.IR.Haskell.Renamer.rnHsVectDecl: Unexpected 'HsVectTypeOut'"
rnHsVectDecl (HsVectClassIn s cls)
  = do { cls' <- lookupLocatedOccRn cls
       ; return (HsVectClassIn s cls', unitFV (unLoc cls'))
       }
rnHsVectDecl (HsVectClassOut _)
  = panic "GHC.IR.Haskell.Renamer.rnHsVectDecl: Unexpected 'HsVectClassOut'"
...
rnHsVectDecl (HsVectInstOut _)
  = panic "GHC.IR.Haskell.Renamer.rnHsVectDecl: Unexpected 'HsVectInstOut'"
...
* Increase kind polymorphism.
  See GHC.IR.Haskell.TypeChecker.TypeAndClassDeclaration
...
constructors] in GHC.IR.Haskell.TypeChecker.Environment
-}
...
rnTyClDecl (ClassDecl { tcdCtxt = context, tcdLName = lcls,
  ...
  = do  { lcls' <- lookupLocatedTopBndrRn lcls
        ...
        -- GHC.IR.Haskell.Renamer.ImportExport.extendGlobalRdrEnvRn
        ...
        ; (mbinds', sigs', meth_fvs)
            <- rnMethodBinds True cls' (hsAllLTyVarNames tyvars') mbinds sigs
                ...
                -- since that is done by
                -- GHC.IR.Haskell.Renamer.ImportExport.extendGlobalRdrEnvRn and
                -- the methods are already in scope
...
add_bind _ (ValBindsOut {})     = panic "GHC.IR.Haskell.Parser.Syntax:add_bind"

add_sig :: LSig a -> HsValBinds a -> HsValBinds a
add_sig s (ValBindsIn bs sigs) = ValBindsIn bs (s:sigs)
add_sig _ (ValBindsOut {})     = panic "GHC.IR.Haskell.Parser.Syntax:add_sig"
