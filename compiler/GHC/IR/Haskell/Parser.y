...
import GHC.Entity.Types         ( IsBootInterface, WarningTxt(..) )
import GHC.Config.Flags
import GHC.Program.BackPack.Syntax
import GHC.Packages.PackageConfig

import GHC.Data.Tree.OrdList
import GHC.Data.Bool.Formula   ( BooleanFormula(..), LBooleanFormula(..)
                               , mkTrue )
...
import GHC.Entity.OccName          ( varName, dataName, tcClsName, tvName
                                   , startsWithUnderscore )
import GHC.Entity.DataConstructor  ( DataCon, dataConName )
import GHC.Entity.SrcLoc
import GHC.Entity.Module
import GHC.Entity.BasicTypes

import GHC.Entity.Type             ( funTyCon )
import GHC.Entity.Kind             ( Kind )
...
import GHC.IR.Haskell.TypeChecker.Evidence  ( emptyTcEvBinds )

import GHC.Entity.ForeignCall
import GHC.Builtin.Primitive.Types          ( eqPrimTyCon )
import GHC.Builtin.Names       ( eqTyCon_RDR )
import GHC.Builtin.Types       ( unitTyCon, unitDataCon, tupleTyCon
                               , tupleDataCon, nilDataCon
                               , unboxedUnitTyCon, unboxedUnitDataCon
                               , listTyCon_RDR, parrTyCon_RDR
                               , consDataCon_RDR )
...
You can learn more about the conflicts by passing 'happy' the -i flag:
    ...
    happy -agc --strict compiler/GHC/IR/Haskell/Parser.y -idetailed-info
...
-- See also Note [Parsing data constructors is hard] in
...
correct places using GHC.IR.Haskell.Parser.Syntax.splitTilde.
...
constr_stuff :: { Located (Located RdrName, HsConDeclDetails GhcPs) }
    -- See Note [Parsing data constructors is hard] in
    -- GHC.IR.Haskell.Parser.Syntax
...
in GHC.IR.Haskell.Syntax.Annotation
