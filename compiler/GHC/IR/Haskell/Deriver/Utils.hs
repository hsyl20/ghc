...
module GHC.IR.Haskell.Deriver.Utils (
...
import GHC.Entity.Types (lookupFixity, mi_fix)
import GHC.IR.Haskell.Syntax
import GHC.IR.Haskell.TypeChecker.Instantiation
import GHC.Entity.ClassInstance
import GHC.IR.Interface.Loader (loadInterfaceForName)
import GHC.Entity.Module (getModule)
import GHC.Entity.Name
import GHC.Utils.Outputable
import GHC.Builtin.Names
import GHC.Entity.SrcLoc
import GHC.IR.Haskell.Deriver.BasicClasses
import GHC.IR.Haskell.Deriver.Functor
import GHC.IR.Haskell.Deriver.Generic
...
-- c.f. GHC.IR.Haskell.Renamer.Environment.lookupFixity, and Trac #9830
  ...
  where
    ...
    check_universal con
      ...
      = IsValid -- See Note [DeriveFoldable with ExistentialQuantification]
                -- in GHC.IR.Haskell.Deriver.Functor
...
-- for functional dependency errors -- that'll happen in GHC.IR.Haskell.TypeChecker.Instance
...
See Note [DeriveFoldable with ExistentialQuantification] in GHC.IR.Haskell.Deriver.Functor.
-}
