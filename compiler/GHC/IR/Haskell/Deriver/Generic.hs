...
(equivalent to the code in GHC.IR.Haskell.Deriver.BasicClasses, for other classes)
-}
...
module GHC.IR.Haskell.Deriver.Generic (canDoGenerics, canDoGenerics1,
                      GenericKind(..),
...
-- called by GHC.IR.Haskell.Deriver.inferConstraints; generates a list of types, each of which
