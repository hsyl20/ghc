...
module GHC.IR.Haskell.Deriver.Constraints (inferConstraints, simplifyInstanceContexts) where
...
Specifically, we use GHC.IR.Haskell.Deriver.BasicClasses.box to box the Int# into an Int
    ...
    gen_soln (DS { ds_loc = loc, ds_tvs = tyvars
      ...
      = setSrcSpan loc  $
        ...
        do { theta <- simplifyDeriv the_pred tyvars deriv_rhs
           ...
           ; traceTc "GHC.IR.Haskell.TypeChecker.Deriving" (ppr deriv_rhs $$ ppr theta)
