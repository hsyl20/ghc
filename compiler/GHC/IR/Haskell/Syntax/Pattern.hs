...
import {-# SOURCE #-} GHC.IR.Haskell.Syntax.Expression (SyntaxExpr, LHsExpr
...
data Pat p
  ...
  | NPlusKPat       (Located (IdP p))       -- n+k pattern
                    ...
                    (SyntaxExpr p)     -- Name of '-' (see GHC.IR.Haskell.Renamer.Environment.lookupSyntaxName)
...
-- unambiguous updates can be represented by 'GHC.Compiler.HaskellToCore.Splices.repUpdFields'.
--
...
--
-- See also Note [Disambiguating record fields] in GHC.IR.Haskell.TypeChecker.Expression.
