...
data HsExpr p
  ...
  | HsPar       (LHsExpr p)    -- ^ Parenthesised expr;
                               -- see Note [Parens in GHC.IR.Haskell]

  | SectionL    (LHsExpr p)    -- operand; see Note [Sections in GHC.IR.Haskell]
                (LHsExpr p)    -- operator
  | SectionR    (LHsExpr p)    -- operator; see Note [Sections in GHC.IR.Haskell]
                (LHsExpr p)    -- operand
...
-- Exported to GHC.IR.Haskell.Syntax.Binding, which can't see the defn of HsMatchContext
