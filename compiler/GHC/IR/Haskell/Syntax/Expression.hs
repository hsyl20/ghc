...
module GHC.IR.Haskell.Syntax.Expression where
...
import GHC.IR.Haskell.Syntax.PlaceHolder ( NameOrRdrName )
...
import GHC.Entity.RdrName  ( GlobalRdrEnv )
...
When it calls GHC.IR.Haskell.Renamer.Environment.unknownNameSuggestions to
...
-- Exported to GHC.IR.Haskell.Syntax.Binding, which can't see the defn of
-- HsMatchContext
...
data StmtLR idL idR body -- body should always be (LHs**** idR)
  ...
  -- GHC.IR.Haskell.Renamer.Expression
  --
  | ApplicativeStmt
             [ ( SyntaxExpr idR
...
-- GHC.IR.Haskell.Renamer.Splice. For how this is used.
--
