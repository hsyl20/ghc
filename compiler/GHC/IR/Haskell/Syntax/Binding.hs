...
data HsBindLR idL idR
  = -- | Function Binding
    ...
    --           'GHC.IR.Haskell.TypeChecker.Binding.tcMonoBinds'.
    --
...
c) Deciding whether the binding can be used in static forms
    (see GHC.IR.Haskell.TypeChecker.Expression.checkClosedInStaticForm for the
    HsStatic case and GHC.IR.Haskell.TypeChecker.Binding.isClosedBndrGroup).
