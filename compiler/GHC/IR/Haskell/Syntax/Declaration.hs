...
-- friends:
import {-# SOURCE #-} GHC.IR.Haskell.Syntax.Expression
...
Plan of attack:
 ...
 - When typechecking the decl, we build the implicit TyCons and Ids.
   ...
   (GHC.IR.Haskell.Renamer.Environment.lookupSysName), to ensure correct module
...
~~~~~~~~~~~~~~~
 ...
 - If there is a default method name at all, it's recorded in
   the ClassOpSig (in GHC.IR.Haskell.Syntax.Binding), in the DefMethInfo field.
   (DefMethInfo is defined in GHC.Entity.Class)
...
GHC.IR.Haskell.TypeChecker.Instance.tcInstDecls1).  So we can't generate the
...
in GHC.IR.Haskell.Renamer for more info.
-}
...
data HsDerivingClause pass
  -- See Note [Deriving strategies] in GHC.IR.Haskell.TypeChecker.Deriving
  = HsDerivingClause
...
lvectDeclName (L _ (HsVectInstIn _))
  = panic "GHC.IR.Haskell.Syntax.Declaration.lvectDeclName: HsVectInstIn"
lvectDeclName (L _ (HsVectInstOut  _))
  = panic "GHC.IR.Haskell.Syntax.Declaration.lvectDeclName: HsVectInstOut"
