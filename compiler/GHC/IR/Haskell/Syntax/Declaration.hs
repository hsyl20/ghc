...
-- friends:
import {-# SOURCE #-} GHC.IR.Haskell.Syntax.Expression ( LHsExpr, HsExpr, HsSplice, pprExpr,
                                pprSpliceDecl )
...
GHC.IR.Haskell.TypeChecker.Instance.tcInstDecls1).  So we can't generate the names for
