...
module GHC.IR.Haskell.Syntax.Literal where

#include "HsVersions.h"

import {-# SOURCE #-} GHC.IR.Haskell.Syntax.Expression ( HsExpr, pprExpr )
import GHC.Entity.BasicTypes ( IntegralLit(..),FractionalLit(..)
...
-- the following
-- Note [Trees that grow] in GHC.IR.Haskell.Syntax.Extension for the Xxxxx
...
data HsLit x
  ...
  | HsInt (XHsInt x)  IntegralLit
      ...
      -- @GHC.IR.Haskell.Deriver.BasicClasses@, and from TRANSLATION
...
-- GHC.Compiler.HaskellToCore.Match.Literal)
