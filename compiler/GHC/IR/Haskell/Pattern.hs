...
data Pat id
  ...
  | NPlusKPat       (Located id)        -- n+k pattern
                    ...
                    (SyntaxExpr id)     -- Name of '-' (see GHC.IR.Haskell.Renamer.Environment.lookupSyntaxName)
...
-- unambiguous updates can be represented by 'GHC.Compilers.HaskellToCore.Splices.repUpdFields'.
--
...
pprPat (ConPatOut { pat_con = con, pat_tvs = tvs, pat_dicts = dicts,
  ...
  = sdocWithDynFlags $ \dflags ->
       -- Tiresome; in GHC.IR.Haskell.TypeSystem.Binding.tcRhs we print out a
