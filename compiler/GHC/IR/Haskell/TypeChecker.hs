...
module GHC.IR.Haskell.TypeChecker(
  -- * Initalisation
...
import GHC.IR.Haskell.TypeChecker.Types -- Re-export all
...
import GHC.Entity.BasicTypes( TopLevelFlag )
...
import {-# SOURCE #-} GHC.IR.Haskell.TypeChecker.Splice (runRemoteModFinalizers)
