...
-- See Note [Warnings in code generated by Alex] in compiler/GHC/IR/Haskell/Lexer.x
...
import GHC.Entity.BasicTypes ( InlineSpec(..), RuleMatchInfo(..),
...
(GHC.IR.Haskell.TypeChecker.TypeAndClassDeclaration) ensure that type families
