...
-- GHC.IR.Haskell.TypeSystem.Constraint.Canonicaliser.canEqTyVarTyVar (nicer_to_update_tv2)
...
@GHC.IR.Haskell.TypeSystem.Constraint.Canonicaliser@ even if they come in as CDictCan. Only canonical constraints that
