...
import GHC.Builtin.Typess( coercibleClass, unitTyCon, unitTyConKey
...
-- decomposing tycon applications] in GHC.IR.Haskell.TypeSystem.Constraint.Canonicaliser for details.
...
-- GHC.IR.Haskell.TypeSystem.Constraint.Canonicaliser for the motivation for this function.
...
************************************************************************
*                                                                      *
\subsection[GHC.Builtin.Typess-ext-type]{External types}
*                                                                      *
************************************************************************
