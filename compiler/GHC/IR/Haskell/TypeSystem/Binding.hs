...
@tcBindsAndThen@ typechecks a @GHC.IR.Haskell.Binding@.  The "and then" part is because
...
tc_group top_lvl sig_fn prag_fn (Recursive, binds) closed thing_inside
  =     -- To maximise polymorphism, we do a new
        ...
        -- See Note [Polymorphic recursion] in GHC.IR.Haskell.Binding.
...
@tcMonoBinds@ deals with a perhaps-recursive group of GHC.IR.Haskell.Binding.
