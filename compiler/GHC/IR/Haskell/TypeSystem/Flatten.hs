...
-- Note [No derived kind equalities] in GHC.IR.Haskell.TypeSystem.Constraint.Canonicaliser
...
where it is *used*, namely in GHC.IR.Haskell.TypeSystem.Constraint.Canonicaliser.canEqTyVar.
...
GHC.IR.Haskell.TypeSystem.Constraint.Canonicaliser.homogeniseRhsKind). Invariant (F2) is needed solely to support
