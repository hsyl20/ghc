...
mkTyVarEqErr dflags ctxt report ct oriented tv1 ty2
  | isUserSkolem ctxt tv1   -- ty2 won't be a meta-tyvar, or else the thing would
                            ...
                            -- see GHC.IR.Haskell.TypeSystem.Constraint.Canonicaliser.canEqTyVarTyVar
  ...
  | OC_Occurs <- occ_check_expand
    ...
    -- See Note [Occurs check error] in GHC.IR.Haskell.TypeSystem.Constraint.Canonicaliser
...
evidence.  We don't re-use the code in GHC.IR.Haskell.TypeSystem.Constraint.Canonicaliser because that's in
