...
import GHC.Utils
import GHC.Entity.BasicTypes ( compareFixity, funTyFixity, negateFixity
...
{-
These type renamers are in a separate module, rather than in (say) GHC.IR.Haskell.Renamer,
...
bindHsQTyVars :: forall a b.
              ...
              -> (LHsQTyVars GhcRn -> NameSet -> RnM (b, FreeVars))
                  ...
                  -- signatures] in GHC.IR.Haskell.Syntax.Declaration
              -> RnM (b, FreeVars)
...
GHC.IR.Haskell.Renamer.ImportExport.getLocalNonValBinders), so we just take the
list as an argument, build a map and look them up.
-}

rnConDeclFields :: HsDocContext -> [FieldLabel] -> [LConDeclField GhcPs]
                -> RnM ([LConDeclField GhcRn], FreeVars)
-- Also called from GHC.IR.Haskell.Renamer
