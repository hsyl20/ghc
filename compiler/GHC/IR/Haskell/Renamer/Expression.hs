...
rnExpr (OpApp e1 op  _ e2)
  = do  { (e1', fv_e1) <- rnLExpr e1
        ...
        -- more, so I've removed the test.  Adding HsPars in GHC.IR.Haskell.Deriver.BasicClasses
...
-- Neither is ArrowExpr, which has its own desugarer in GHC.Compiler.HaskellToCore.Arrow
