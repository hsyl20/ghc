...
import GHC.Entity.BasicTypes       ( TopLevelFlag, isTopLevel, SourceText(..) )
...
--            [| map |]
--
-- This code is similar to checkCrossStageLifting in GHC.IR.Haskell.TypeChecker.Expression, but
...
have no cross-stage lifting (c.f. GHC.IR.Haskell.TypeChecker.Expression.thBrackId).  So, after incrementing
