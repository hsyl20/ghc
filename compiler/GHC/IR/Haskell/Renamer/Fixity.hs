...
-}
module GHC.IR.Haskell.Renamer.Fixity
   ( MiniFixityEnv
   , addLocalFixities
...
import GHC.Entity.BasicTypes ( Fixity(..), FixityDirection(..), minPrecedence
...
* Top-level fixity decls in this module may be for Names that are
  ...
  (See notes with GHC.IR.Haskell.Renamer.ImportExport.getLocalDeclBinders for
  why we have this split.)
