...
-}
module GHC.IR.Haskell.Renamer.Utils.Unbound ( mkUnboundName
                 , mkUnboundNameRdr
                 , isUnboundName
                 , reportUnboundName
...
-- | Called from the typechecker (GHC.IR.Haskell.TypeChecker.Error) when we find an unbound variable
