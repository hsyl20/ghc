...
rnImportDecl this_mod
  ...
  = setSrcSpan loc $ do
    ...
    -- at least not until GHC.IR.Interface.TypeChecker.tcHiBootIface, which is too late to avoid
    -- typechecker crashes.  (Indirect self imports are not caught until
    -- GHC.IR.Interface.TypeChecker, see #10337 tracking how to make this error better.)
    --
