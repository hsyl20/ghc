...
-- | Find the in-scope set: see "GHC.IR.Core.Substitution#in_scope_invariant"
...
-- such that the "GHC.IR.Core.Substitution#in_scope_invariant" is true after extending the substitution like this
...
-- the "GHC.IR.Core.Substitution#in_scope_invariant" is true after extending
...
lookupIdSubst doc (Subst in_scope ids _ _) v
  ...
  | otherwise = WARN( True, text "GHC.IR.Core.Substitution.lookupIdSubst" <+> doc <+> ppr v
                            $$ ppr in_scope)
                Var v
...
-- apply the substitution /once/: see "GHC.IR.Core.Substitution#apply_once"
--
