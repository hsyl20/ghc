...
--       in GHC.IR.Core.Transform.ConstantFolding for rationale.
--
...
GHC.IR.Core.Transform.ConstantFolding for the rationale for this restriction.
...
string bindings; anything else and things break. GHC.IR.Core.Analyse.Lint checks this invariant.
...
data Tickish id =
  ...
  | Breakpoint
    ...
    , breakpointFVs    :: [id]  -- ^ the order of this list is important:
                                ...
                                -- Note [substTickish] in GHC.IR.Core.Substitution.
    }
...
but GHC.IR.Core.FreeVars, Subst, GHC.IR.Core.PrettyPrint, CoreTidy also inspect the representation.
-}
...
-- This type should be treated as abstract everywhere except in "GHC.IR.Core.Transform.Unfolding"
data Unfolding
...
data UnfoldingGuidance
  = UnfWhen {   -- Inline without thinking about the *size* of the uf_tmpl
                ...
                -- See Note [INLINE for small functions] in GHC.IR.Core.Transform.Unfolding
...
See also Note [Inlining an InlineRule] in GHC.IR.Core.Transform.Unfolding.
...
These are defined here to avoid a module loop between GHC.IR.Core.Utils and GHC.IR.Core.FreeVars
