...
module GHC.IR.Core.Transformer.WorkerWrapper.Utils
   ( mkWwBodies
   , mkWWstr
   , mkWorkerArgs
...
import GHC.Entity.Id.Info           ( JoinArity, vanillaIdInfo )
import GHC.Entity.DataConstructor
import GHC.Entity.Demand
import GHC.IR.Core.Syntax.Make      ( mkRuntimeErrorApp, aBSENT_ERROR_ID
...
import GHC.Entity.Var.Environment   ( mkInScopeSet )
import GHC.Entity.Var.Set           ( VarSet )
import GHC.Entity.Type
import GHC.Entity.RepType           ( isVoidTy )
import GHC.Entity.Coercion
import GHC.Entity.FamilyInstance
import GHC.Entity.BasicTypes        ( Boxity(..) )
import GHC.Entity.Literal           ( absentLiteralOf )
...
Note [CPR for thunks] in GHC.IR.Core.Analyser.Demand.
...
rather than being curried. (The real-life example was
GHC.Data.Graph.Operations.addConflicts.)
