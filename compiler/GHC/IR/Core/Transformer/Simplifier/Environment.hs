...
type SimplIdSubst = IdEnv SimplSR -- IdId |--> OutExpr
        -- See Note [Extending the Subst] in
...
-- If you change this function look also at
-- GHC.IR.Core.Transformer.FloatIn.noFloatFromRhs
  ...
  where
    ...
    flag (NonRec bndr rhs)
      ...
      | exprIsLiteralString rhs  = FltLifted
          ...
          -- See Note [Core syntax top-level string literals] in
          -- GHC.IR.Core.Syntax.
