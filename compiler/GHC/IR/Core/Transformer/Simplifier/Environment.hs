...
\section[GHC.IR.Core.Transformer.Simplifier.Monad]{The simplifier Monad}
-}

{-# LANGUAGE CPP #-}

module GHC.IR.Core.Transformer.Simplifier.Environment (
        -- * The simplifier mode
        setMode, getMode, updMode,

        -- * Environments
        GHC.IR.Core.Transformer.Simplifier.Environment.SimplEnv(..),
        StaticEnv, pprSimplEnv,   -- Temp not abstract
        mkSimplEnv, extendIdSubst,
        GHC.IR.Core.Transformer.Simplifier.Environment.extendTvSubst,
        GHC.IR.Core.Transformer.Simplifier.Environment.extendCvSubst,
...
import GHC.Entity.Type hiding              ( substTy, substTyVar, substTyVarBndr )
import qualified GHC.Entity.Coercion as Coercion
import GHC.Entity.Coercion hiding          ( substCo, substCoVar, substCoVarBndr )
import GHC.Entity.BasicTypes
import GHC.Utils.Monad
import GHC.Utils.Outputable
import GHC.Utils
import GHC.Entity.Unique.FiniteMap                   ( pprUniqFM )
...
type SimplIdSubst = IdEnv SimplSR -- IdId |--> OutExpr
        -- See Note [Extending the Subst] in GHC.IR.Core.Transformer.Substitution
...
GHC.IR.Core.Syntax.Make.mkCoreApp transforms
...
-- If you change this function look also at GHC.IR.Core.Transformer.FloatIn.noFloatFromRhs
  ...
  where
    ...
    flag (NonRec bndr rhs)
      ...
      | exprIsLiteralString rhs  = FltLifted
          ...
          -- See Note [GHC.IR.Core.Syntax top-level string ltierals] in GHC.IR.Core.Syntax.
...
--
-- Similar to GHC.IR.Core.Transformer.Substitution.substIdBndr, except that
