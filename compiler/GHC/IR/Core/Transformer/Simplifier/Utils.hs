...
import qualified GHC.IR.Core.Transformer.Substitution as CoreSubst
...
-- See Note [RHS of lets] in GHC.IR.Core.Transformer.Inliner
...
contArgs cont
  ...
  | otherwise = go [] cont
  where
    -- See Note [Lone variables] in GHC.IR.Core.Transformer.Inliner
      ...
      = case splitStrictSig (idStrictness fun) of
          (demands, result_info)
                ...
                ->      -- Enough args, use the strictness given.
                        ...
                        -- GHC.IR.Core.Transformer.Simplifier.Utils.analyseCont)
...
GHC.IR.Core.Transformer.Simplifier.Utils.abstractFloats, but there is quite a
