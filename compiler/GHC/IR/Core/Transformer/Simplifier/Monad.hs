...
module GHC.IR.Core.Transformer.Simplifier.Monad (
        -- The monad
        SimplM,
        initSmpl, traceSmpl,
...
import GHC.Entity.Var             ( Var, isTyVar, mkLocalVar )
import GHC.Entity.Name            ( mkSystemVarName )
import GHC.Entity.Id              ( Id, mkSysLocalOrCoVar )
import GHC.Entity.Id.Info         ( IdDetails(..), vanillaIdInfo, setArityInfo )
import GHC.Entity.Type            ( Type, mkLamTypes )
...
import GHC.Entity.BasicTypes      ( IntWithInf, treatZeroAsInf, mkIntWithInf )
