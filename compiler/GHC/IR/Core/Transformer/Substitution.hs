...
-- | Find the in-scope set: see
-- "GHC.IR.Core.Transformer.Substitution#in_scope_invariant"
...
-- in-scope set is such that the
-- "GHC.IR.Core.Transformer.Substitution#in_scope_invariant" is true after
...
-- You must ensure that the in-scope set is such that the
-- "GHC.IR.Core.Transformer.Substitution#in_scope_invariant" is true after
-- extending the substitution like this.
...
lookupIdSubst doc (Subst in_scope ids _ _) v
  ...
  | otherwise = WARN( True, text "lookupIdSubst" <+> doc <+> ppr v
                            $$ ppr in_scope)
                Var v
...
-- apply the substitution /once/: see
-- "GHC.IR.Core.Transformer.Substitution#apply_once"
--
