...
module GHC.IR.Core.Transformer.Vectoriser ( vectorise )
where

import GHC.IR.Core.Transformer.Vectoriser.Type.Env
...
import GHC.IR.Core.Transformer.Vectoriser.Exp
...
import GHC.IR.Core.Pipeline            ( CoreM, getHscEnv )
