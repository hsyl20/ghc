...
module GHC.IR.Core.Transformer.Vectoriser.Generic.PData
  ( buildPDataTyCon
  , buildPDatasTyCon )
where
...
import GHC.IR.Core.Transformer.Vectoriser.Generic.Description
import GHC.IR.Core.Transformer.Vectoriser.Utils
import GHC.IR.Core.Transformer.Vectoriser.Env( GlobalEnv(global_fam_inst_env) )

import GHC.Entity.BasicTypes ( SourceText(..) )
