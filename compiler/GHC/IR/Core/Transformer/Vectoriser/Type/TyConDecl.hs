...
module GHC.IR.Core.Transformer.Vectoriser.Type.TyConDecl (
  vectTyConDecls
) where
...
import GHC.IR.Interface.BuildTypeAndClass( TcMethInfo, buildClass, buildDataCon, newTyConRepName )
...
import GHC.Entity.BasicTypes( DefMethSpec(..) )
