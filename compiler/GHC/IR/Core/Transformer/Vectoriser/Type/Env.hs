...
module GHC.IR.Core.Transformer.Vectoriser.Type.Env (
  vectTypeEnv,
) where
...
import GHC.IR.Core.Transformer.Vectoriser.Type.TyConDecl
import GHC.IR.Core.Transformer.Vectoriser.Type.Classify
import GHC.IR.Core.Transformer.Vectoriser.Generic.PADict
import GHC.IR.Core.Transformer.Vectoriser.Generic.PAMethods
import GHC.IR.Core.Transformer.Vectoriser.Generic.PData
