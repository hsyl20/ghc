...
import GHC.Entity.TypeConstructor      ( tyConDataCons_maybe, isEnumerationTyCon
                                       , isNewTyCon , unwrapNewTyCon_maybe
                                       , tyConDataCons )
import GHC.Entity.DataConstructor      ( DataCon, dataConTagZ, dataConTyCon
                                       , dataConWorkId )
...
--
-- cf Scrutinee Constant Folding in GHC.IR.Core.Transformer.Simplifier.Utils
--------------------------------------------------------
