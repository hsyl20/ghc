...
import {-# SOURCE #-} GHC.Entity.Id.Make ( mkPrimOpId, magicDictId )

import GHC.IR.Core.Syntax
import GHC.IR.Core.Syntax.Make
import GHC.Entity.Id
import GHC.Entity.Literal
import GHC.IR.Core.Transformer.Simple    ( exprIsLiteral_maybe )
import GHC.Builtin.Primitive.Operations      ( PrimOp(..), tagToEnumKey )
import GHC.Builtin.Types
import GHC.Builtin.Primitive.Types
import GHC.Entity.TypeConstructor       ( tyConDataCons_maybe, isEnumerationTyCon, isNewTyCon
                   , unwrapNewTyCon_maybe, tyConDataCons )
import GHC.Entity.DataConstructor     ( DataCon, dataConTagZ, dataConTyCon, dataConWorkId )
import GHC.IR.Core.Utils   ( cheapEqExpr, exprIsHNF )
import GHC.IR.Core.Transformer.Inliner  ( exprIsConApp_maybe )
import GHC.Entity.Type
import GHC.Entity.OccName     ( occNameFS )
import GHC.Builtin.Names
import GHC.Data.Maybe      ( orElse )
import GHC.Entity.Name        ( Name, nameOccName )
...
import GHC.Utils
import GHC.Entity.Coercion     (mkUnbranchedAxInstCo,mkSymCo,Role(..))
...
This optimises to:
Shift.$wgo = \ (w_sCS :: GHC.Prim.Int#) (w1_sCT :: [GHC.Entity.Types.Bool]) ->
    case w1_sCT of _ {
      [] -> 0##;
      : x_aAW xs_aAX ->
        case x_aAW of _ {
          GHC.Entity.Types.False ->
            case w_sCS of wild2_Xh {
              __DEFAULT -> Shift.$wgo (GHC.Prim.+# wild2_Xh 1) xs_aAX;
              9223372036854775807 -> 0## };
          GHC.Entity.Types.True ->
...
-- See Note [magicDictId magic] in `GHC.Entity.Id.Make`
...
--
-- cf Scrutinee Constant Folding in simplCore/GHC.IR.Core.Transformer.Simplifier.Utils
--------------------------------------------------------
...
NB: in GHC.IR.Core.Transformer.Simplifier.Utils, where we invoke caseRules,
