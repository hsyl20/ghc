...
import GHC.IR.Core.Analyser.FreeVars          ( exprFreeVars, exprsFreeVars, bindFreeVars
...
import GHC.Entity.Name             ( Name, NamedThing(..), nameIsLocalOrFrom )
...
import GHC.Entity.BasicTypes       ( Activation, CompilerPhase, isActive, pprRuleName )
...
* GHC.IR.Interface.Transformer.Tidier strips off all the rules from local Ids and adds them to
...
but that isn't quite right:
     ...
     - The rules in GHC.IR.Core.Transformer.ConstantFolder.builtinRules should be active even
