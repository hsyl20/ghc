...
module GHC.IR.Core.Transformer.Inliner (
        ...
        -- Reexport from GHC.IR.Core.Transformer.Substitution (it only live
        -- there so it can be used by the Very Simple Optimiser)
...
import GHC.Entity.BasicTypes           ( Arity, InlineSpec(..)
                                       , inlinePragmaSpec )
...
and similar friends.
See Note [Bottoming floats] in GHC.IR.Core.Transformer.LevelSetter.
