...
import GHC.Entity.Unique.Supply       ( UniqSupply, mkSplitUniqSupply, splitUniqSupply )
...
getCoreToDo dflags
  ...
  where
    ...
    -- after this before anything else
        ...
        -- has run at all. See Note [Final Demand Analyser run] in GHC.IR.Core.Analyser.Demand
