...
module GHC.IR.Core.Analyse.Occurence (
...
See also Note [Inlining and hs-boot files] in GHC.Interface.CoreToInterface, which deals
...
Annoyingly, we have to approximate GHC.IR.Core.Transform.Simplify.Utils.preInlineUnconditionally.
