...
import GHC.Entity.Var      ( EvVar, setTyVarUnique )

import GHC.IR.Core.Syntax
import GHC.IR.Core.Utils        ( exprType, needsCaseBinding, bindNonRec )
...
import GHC.IR.Haskell.TypeChecker.Type           ( mkSpecSigmaTy )
import GHC.Entity.Type
import GHC.Entity.Coercion         ( isCoVar )
import GHC.Builtin.Primitive.Types
import GHC.Entity.DataConstructor          ( DataCon, dataConWorkId )
import GHC.Entity.Id.Info           ( vanillaIdInfo, setStrictnessInfo,
                          setArityInfo )
...
************************************************************************
*                                                                      *
\subsection{Basic GHC.IR.Core.Syntax construction}
*                                                                      *
************************************************************************
-}
...
-- appropriate (see "GHC.IR.Core.Syntax#let_app_invariant")
mkCoreLet :: CoreBind -> CoreExpr -> CoreExpr
mkCoreLet (NonRec bndr rhs) body        -- See Note [GHC.IR.Core.Syntax let/app invariant]
...
--   See GHC.IR.Core.Syntax Note [GHC.IR.Core.Syntax let/app invariant]
...
their counterparts in GHC.IR.Core.Syntax, but they are here for consistency
-}
...
data FloatBind
  ...
  | FloatCase CoreExpr Id AltCon [Var]
      -- case e of y { C ys -> ... }
      -- See Note [Floating cases] in GHC.IR.Core.Transformer.LevelSetter
