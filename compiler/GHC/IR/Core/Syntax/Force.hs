...
module GHC.IR.Core.Syntax.Force (
...
import GHC.Entity.Demand         ( seqDemand, seqStrictSig )
import GHC.Entity.BasicTypes     ( seqOccInfo )
import GHC.Entity.Var.Set        ( seqDVarSet )
import GHC.Entity.Var            ( varType, tyVarKind )
import GHC.Entity.Type           ( seqType, isTyVar )
import GHC.Entity.Coercion       ( seqCo )
import GHC.Entity.Id             ( Id, idInfo )
