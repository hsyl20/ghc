...
module GHC.IR.Core.Analyser.Stats (
...
import GHC.Entity.Type (Type, typeSize, seqType)
import GHC.Entity.Id (idType, isJoinId)
import GHC.IR.Core.Syntax.Force (megaSeqIdInfo)
