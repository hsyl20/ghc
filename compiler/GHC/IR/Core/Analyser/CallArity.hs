...
module GHC.IR.Core.Analyser.CallArity
...
import GHC.IR.Core.Utils          ( exprIsCheap, exprIsTrivial )
import GHC.Entity.Var.UndirectedGraph
...
the case for Core!
 1. We need to ensure the invariant
    ...
    [exprArity invariant] in GHC.IR.Core.Analyser.Arity).
