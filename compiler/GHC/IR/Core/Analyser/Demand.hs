...
import GHC.IR.Core.Transformer.WorkerWrapper.Utils            ( findTypeShape, deepSplitProductType_maybe )
...
foo's arity will be zero (see Note [exprArity invariant] in GHC.IR.Core.Analyser.Arity),
