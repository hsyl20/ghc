...
************************************************************************
*                                                                      *
\section[GHC.IR.Core.Transform.FloatIn]{Floating Inwards pass}
*                                                                      *
************************************************************************
...
module GHC.IR.Core.Transform.FloatIn ( floatInwards ) where
...
GHC.IR.Core.Transform.LevelSetting.hs module, which tags things with their level numbers.
\item
  ...
  where
    ...
    go (bind_w_fvs@(FB bndrs bind_fvs bind) : binds) drop_boxes@(here_box : fork_boxes)
        ...
        where
          ...
          new_fork_boxes = zipWithEqual "GHC.IR.Core.Transform.FloatIn.sepBinds" insert_maybe
