...
\section[GHC.IR.Core.Transform.WorkerWrapper.Utils]{A library for the ``worker\/wrapper'' back-end to the strictness analyser}
-}

{-# LANGUAGE CPP #-}

module GHC.IR.Core.Transform.WorkerWrapper.Utils
   ( mkWwBodies
   , mkWWstr
   , mkWorkerArgs
...
Note [CPR for thunks] in GHC.IR.Core.Analyse.Demand.
