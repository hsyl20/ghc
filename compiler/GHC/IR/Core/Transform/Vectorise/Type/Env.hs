...
module GHC.IR.Core.Transform.Vectorise.Type.Env (
  vectTypeEnv,
) where
...
import GHC.IR.Core.Transform.Vectorise.Type.TyConDecl
import GHC.IR.Core.Transform.Vectorise.Type.Classify
import GHC.IR.Core.Transform.Vectorise.Generic.PADict
import GHC.IR.Core.Transform.Vectorise.Generic.PAMethods
import GHC.IR.Core.Transform.Vectorise.Generic.PData
