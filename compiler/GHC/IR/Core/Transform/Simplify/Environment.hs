...
\section[GHC.IR.Core.Transform.Simplify.Monad]{The simplifier Monad}
-}

{-# LANGUAGE CPP #-}

module GHC.IR.Core.Transform.Simplify.Environment (
        -- * The simplifier mode
        setMode, getMode, updMode,

        -- * Environments
        GHC.IR.Core.Transform.Simplify.Environment.SimplEnv(..),
        StaticEnv, pprSimplEnv,   -- Temp not abstract
        mkSimplEnv, extendIdSubst,
        GHC.IR.Core.Transform.Simplify.Environment.extendTvSubst,
        GHC.IR.Core.Transform.Simplify.Environment.extendCvSubst,
...
type SimplIdSubst = IdEnv SimplSR -- IdId |--> OutExpr
        -- See Note [Extending the Subst] in GHC.IR.Core.Substitution
...
-- If you change this function look also at GHC.IR.Core.Transform.FloatIn.noFloatFromRhs
...
--
-- Similar to GHC.IR.Core.Substitution.substIdBndr, except that
