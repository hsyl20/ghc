...
module GHC.IR.Core.Transform.Vectorise ( vectorise )
where

import GHC.IR.Core.Transform.Vectorise.Type.Env
...
import GHC.IR.Core.Transform.Vectorise.Exp
...
import GHC.IR.Core.Transform.Unfolding           ( mkInlineUnfoldingWithArity )
