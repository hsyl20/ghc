...
import GHC.IR.Core.Analyser.FreeVars( exprFreeVars )
...
import GHC.Entity.TypeAndCoercion( TyBinder(..) )
...
-- applied to the actual 'GHC.IR.Core.Syntax.Type' expression as it cannot
...
isExprLevPoly = go
  where
   ...
   go (Coercion {})                = False  -- this case can happen in GHC.IR.Core.Transformer.LevelSetter
...
-- Not defined with applyTypeToArg because you can't print from GHC.IR.Core.Syntax.
...
-- also 'GHC.IR.Core.Syntax.Make.mkCoreLet'
bindNonRec bndr rhs body
  | needsCaseBinding (idType bndr) rhs = Case rhs bndr (exprType body) [(DEFAULT, [], body)]
  | otherwise                          = Let (NonRec bndr rhs) body

-- | Tests whether we have to use a @case@ rather than @let@ binding for this expression
-- as per the invariants of 'CoreExpr': see "GHC.IR.Core.Syntax#let_app_invariant"
...
Note [Empty case alternatives] in GHC.IR.Core.Syntax.
...
also GHC.IR.Core.Analyser.Arity.exprBotStrictness_maybe, but that's a bit more
expensive.
-}
...
one nofib benchmark, wheel-sieve1.  The situation looks like this:
   ...
   let noFactor_sZ3 :: GHC.Entity.Types.Int -> GHC.Entity.Types.Bool
       noFactor_sZ3 = case s_adJ of _ { GHC.Entity.Types.I# x_aRs ->
         case GHC.Prim.<=# x_aRs 2 of _ {
           GHC.Entity.Types.False -> notDivBy ps_adM qs_adN;
           GHC.Entity.Types.True -> lvl_r2Eb }}
...
exprOkForSideEffects = expr_ok primOpOkForSideEffects
  ...
  -- There is one call at a non-Id binder type, in GHC.IR.Core.Transformer.LevelSetter
      ...
      \ (ww :: GHC.Prim.Int#) ->
        case ww of ds {
          __DEFAULT -> case (case <# ds 5 of _ {
                          GHC.Entity.Types.False -> lvl1;
                          GHC.Entity.Types.True -> lvl})
                       of _ { __DEFAULT ->
...
-- happen: see "GHC.IR.Core.Syntax#let_app_invariant". This invariant states that arguments of
...
-- See Note [GHC.IR.Core.Syntax top-level string literals]
...
rhsIsStatic :: Platform
            ...
            -> (Integer -> CoreExpr)  -- Desugaring for integer literals (disgusting)
                                      ...
                                      --      in GHC.IR.Interface.Transformer.Tidier
            -> CoreExpr -> Bool
-- It's called (i) in GHC.IR.Interface.Transformer.Tidier.hasCafRefs to decide if the rhs is, or
-- refers to, CAFs; (ii) in CoreToStg to decide whether to put an
-- update flag on it and (iii) in GHC.Compiler.HaskellToCore.Expression to decide how to expand
-- list literals
--
...
--
--
-- This is a bit like GHC.IR.Core.Utils.exprIsHNF, with the following differences:
