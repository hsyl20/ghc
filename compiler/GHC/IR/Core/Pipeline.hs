...
import GHC.IR.Haskell.TypeChecker        ( initTcForLookup )
import GHC.IR.Core.Syntax
import GHC.Entity.Types
import GHC.Entity.Module
import GHC.Config.Flags
import GHC.Entity.BasicTypes       ( CompilerPhase(..) )
...
import GHC.IR.Haskell.TypeChecker.Environment            ( lookupGlobal )
...
import GHC.Entity.Unique.FiniteMap       ( UniqFM, mapUFM, filterUFM )
...
import {-# SOURCE #-} GHC.IR.Haskell.TypeChecker.Splice ( lookupThName_maybe )
...
data SimplifierMode             -- See comments in GHC.IR.Core.Transformer.Simplifier.Monad
  = SimplMode
...
data FloatOutSwitches = FloatOutSwitches {
  ...
  floatOutOverSatApps :: Bool,
                             ...
                             -- in GHC.IR.Core.Transformer.LevelSetter
