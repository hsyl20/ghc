...
why GHC.IR.Core.Transformer.Inliner.mkImplicitUnfolding uses simpleOptExpr to do a bit of
...
beginning of GHC.IR.Core.Transformer.Pipeline.  But that gave rise to real difficulty,
...
Oh: two other reasons for injecting them late:
  ...
  - If implicit Ids are already in the bindings when we start GHC.IR.Interface.Transformer.Tidier,
...
after GHC.IR.Interface.Transformer.Tidier.  But CorePrep does some transformations that affect CAF-hood.
