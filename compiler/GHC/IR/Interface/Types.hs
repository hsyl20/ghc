...
import GHC.Entity.TypeConstructor hiding ( pprPromotionQuote )
...
GHC.Entity.TypeAndCoercion we only keep the hole's Unique, since that is all we
need to print.
-}
...
-- See equivalent function in GHC.Entity.TypeAndCoercion
