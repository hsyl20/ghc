...
type IfExtName = Name   -- An External or WiredIn Name can appear in GHC.IR.Interface.Syntax
...
interface file. To avoid an import loop between IfaceType and GHC.Entity.TypeAndCoercion we only
...
--
-- @
-- ($) :: forall (r :: GHC.Entity.Types.RuntimeRep) a (b :: TYPE r).
--        (a -> b) -> a -> b
-- @
--
-- turns in to,
