...
import GHC.IR.Cmm.Syntax.Expression
...
import qualified GHC.Entity.Unique as U
...
way is done in GHC.IR.Cmm.Transformer.ConstantFolder currently. We should fix
this!
-}
...
instance (Ord r, UserOfRegs r CmmReg) => UserOfRegs r ForeignTarget where
  ...
  -- See Note [Recursive superclasses] in GHC.IR.Haskell.TypeChecker.Instance
