...
module GHC.IR.Cmm.Transformer.LayoutStack (
       cmmLayoutStack, setInfoTableStackMap
  ) where

import GHC.Compiler.StgToCmm.Utils      ( callerSaveVolatileRegs ) -- XXX layering violation
import GHC.Compiler.StgToCmm.ForeignCall    ( saveThreadState, loadThreadState ) -- XXX layering violation
...
import GHC.IR.Cmm.Analyser.Liveness
import GHC.IR.Cmm.Transformer.ProcPoint
import GHC.RTS.Storage
import GHC.IR.Cmm.Transformer.Dataflow
import GHC.Entity.Unique.Supply
import GHC.Compiler.StgToCmm.Utils      ( newTemp )
...
areaToSp dflags _ sp_hwm _ (CmmLit CmmHighStackMark)
  = mkIntExpr dflags sp_hwm
    ...
    -- the sp_hwm.   See Note [Stack usage] in GHC.Compiler.StgToCmm.Heap
