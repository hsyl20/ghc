{-# LANGUAGE GADTs #-}
module GHC.IR.Cmm.Transformer.Switch.Implement
...
-- GHC.IR.Cmm.Transformer.Switch and returned as a SwitchPlan; here is just the
-- implementation in terms of Cmm code. See Note [Cmm Switches, the general
-- plan] in GHC.IR.Cmm.Transformer.Switch.
--
...
-- SwitchTargets, a data type exported abstractly by GHC.IR.Cmm.Transformer.Switch.
--
