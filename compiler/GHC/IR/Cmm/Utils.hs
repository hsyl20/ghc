...
import GHC.Entity.TypeConstructor    ( PrimRep(..), PrimElemRep(..) )
import GHC.Entity.RepType  ( UnaryType, SlotTy (..), typePrimRep1 )
...
-- defined in GHC.IR.Cmm.Syntax.Node. -GBM
