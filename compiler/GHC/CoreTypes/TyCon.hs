...
import GHC.Util
import GHC.CoreTypes.Unique( tyConRepNameUnique, dataConRepNameUnique )
...
~~~~~~~~~~~~~~~~~~~~~~~~~
See also Note [Wrappers for data instance tycons] in GHC.CoreTypes.Id.Make
...
* The axiom ax_ti may be eta-reduced; see
  Note [Eta reduction for data family axioms] in GHC.CoreTypes.FamilyInstance

* Data family instances may have a different arity than the data family.
  See Note [Arity of data families] in GHC.CoreTypes.FamilyInstance
...
- See Note [TyVarBndrs, TyVarBinders, TyConBinders, and visibility] in
  GHC.CoreTypes.Type.Internal for what the visibility flag means.
...
data AlgTyConFlav
  ...
  -- See Note [ATyCon for classes] in GHC.CoreTypes.Type.Internal
  | ClassTyCon
...
-- 'GHC.CoreTypes.Type.Internal.funTyCon' if you want this functionality
...
-- See Note [Enumeration types] in GHC.CoreTypes.TyCon
