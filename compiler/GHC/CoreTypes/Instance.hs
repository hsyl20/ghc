...
mkLocalInstance dfun oflag tvs cls tys
  ...
  where
    ...
    is_local name = nameIsLocalOrFrom this_mod name
        ...
        -- Compute orphanhood.  See Note [Orphans] in GHC.CoreTypes.Instance
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  (see GHC.Interface.Utils.instanceToIfaceInst, which implements this)
...
(See `GHC.CoreTypes.Id.Make.mkDictFunId' for the code in question.  Search for
