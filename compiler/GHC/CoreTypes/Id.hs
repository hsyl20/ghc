...
-- 'GHC.CoreTypes.Type.Internal.Type' and some additional details (a
...
module GHC.CoreTypes.Id (
        ...
        -- ** Modifying an Id
        setIdName, setIdUnique, GHC.CoreTypes.Id.setIdType,
...
import GHC.CoreTypes.Var( Id, CoVar, DictId, JoinId,
            InId,  InVar,
            OutId, OutVar,
            idInfo, idDetails, setIdDetails, globaliseId, varType,
            isId, isLocalId, isGlobalId, isExportedId )
import qualified GHC.CoreTypes.Var as Var
...
That is what is happening in, say tidy_insts in GHC.Interface.Tidy.
...
isJoinId :: Var -> Bool
-- It is convenient in GHC.Core.LevelSet.lvlMFE to apply isJoinId
...
-- See Note [Specialisations and RULES in IdInfo] in GHC.CoreTypes.Id.Info
