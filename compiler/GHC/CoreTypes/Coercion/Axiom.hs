...
module GHC.CoreTypes.Coercion.Axiom (
...
can unify. See also [Apartness] in GHC.CoreTypes.FamilyInstance
...
-- See Note [Compatibility checking] in GHC.CoreTypes.FamilyInstance
...
~~~~~~~~~~~~~~~~~~~~~~
See also Note [Implicit TyThings] in GHC.CoreTypes.Base
...
-- See Note [Roles] in GHC.CoreTypes.Coercion
