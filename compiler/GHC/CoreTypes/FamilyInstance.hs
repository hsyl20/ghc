...
module GHC.CoreTypes.FamilyInstance (
...
data FamInst  -- See Note [FamInsts and CoAxioms]
  = FamInst { fi_axiom  :: CoAxiom Unbranched -- The new coercion axiom
            ...
            , fi_fam   :: Name          -- Family name
                ...
                -- See Note [Rough-match field] in GHC.CoreTypes.Instance
    ...
    pp_head | DataFamilyInst rep_tc <- flavor
            ...
            = getPprStyle $ \ sty ->
              ...
              then vanilla_pp_head   -- With -dppr-debug just show it as-is
                     ...
                     --  only for internal debug printing; GHC.Util.PrettyPrint.TyThing.pprFamInst
...
-- the compatibilities
-- See Note [Storing compatibility] in GHC.CoreTypes.Coercion.Axiom
