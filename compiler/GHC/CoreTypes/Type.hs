...
import GHC.CoreTypes.Unique  ( nonDetCmpUnique )
import GHC.CoreTypes.SrcLoc  ( SrcSpan )
import GHC.CoreTypes.OccName ( OccName )
import GHC.CoreTypes.Name    ( mkInternalName )
...
-- See also Note [coreView vs tcView] in GHC.CoreTypes.Type.
{-# INLINE tcView #-}
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
As noted in Note [Forall coercions] in GHC.CoreTypes.Type.Internal, a ForAllCo is
...
GHC.Core.SimpleOpt.pushCoDataCon).
...
-- (See Note [The polymorphism rule of join points] in GHC.Core.Syntax.)
...
-- See also Note [Non-trivial definitional equality] in GHC.CoreTypes.Type.Internal.
...
nonDetCmpTypeX :: RnEnv2 -> Type -> Type -> Ordering  -- Main workhorse
    -- See Note [Non-trivial definitional equality] in GHC.CoreTypes.Type.Internal
