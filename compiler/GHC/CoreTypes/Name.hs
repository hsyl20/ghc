...
-- See Note [The interactive package] in GHC.CoreTypes.Base
...
-- See Note [Printing original names] in GHC.CoreTypes.Base
...
type being pretty printed; eg the pretty-printing code in GHC.CoreTypes.Type.Internal.
