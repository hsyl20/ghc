...
%*                                                                      *
     ...
     -- See [Coercion axioms applied to coercions] in GHC.CoreTypes.Type.Internal
...
-- of Coercion and the Note [Refl invariant] in GHC.CoreTypes.Type.Internal.
...
-- See Note [Newtype coercions] in GHC.CoreTypes.TyCon
...
data LiftingContext = LC TCvSubst LiftCoEnv
  ...
  -- See Note [Optimising InstCo] in GHC.CoreTypes.Coercion.Optimise
