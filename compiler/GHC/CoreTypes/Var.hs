...
-- contain type variables, which have a 'GHC.CoreTypes.Type.Internal.Kind' rather
-- than a 'GHC.CoreTypes.Type.Internal.Type' and only contain some extra details
-- during typechecking.
--
...
import GHC.CoreTypes.Unique ( Uniquable, Unique, getKey, getUnique
...
-- large number of SOURCE imports of GHC.CoreTypes.Id :-(
-}
...
-- home in GHC.CoreTypes.Type.Internal, because it's used in
-- GHC.CoreTypes.DataCon .hs-boot file
...
-- Ids, because GHC.CoreTypes.Id uses 'mkGlobalId' etc with different types
