...
module GHC.CoreTypes.Available (
    Avails,
    AvailInfo(..),
    avail,
    availsToNameSet,
...
plusAvail a1 a2
  ...
  = pprPanic "GHC.Haskell.Rename.Environment.plusAvail names differ"
             (hsep [ppr a1,ppr a2])
...
plusAvail a1 a2 = pprPanic "GHC.Haskell.Rename.Environment.plusAvail"
                           (hsep [ppr a1,ppr a2])
