...
import GHC.CoreTypes.BasicTypes as Hs
...
cvtLit _ = panic "TemplateToHaskell.cvtLit: Unexpected literal"
        ...
        -- GHC.Haskell.Template, hence panic
...
GHC.Haskell.Template, and GHC.Haskell.TypeCheck.Splice:
   ...
   (b) When converting pattern synonyms from TH.Dec to GHC.Haskell in
       GHC.Haskell.Template, we convert their TH type
