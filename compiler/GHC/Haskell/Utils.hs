...
GHC.Haskell.  All these functions deal with generic GHC.Haskell; functions
...
import GHC.Types.Type   ( filterOutInvisibleTypes )
...
-- See GHC.Haskell.Rename.Environment.lookupSyntaxName
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
These functions should only be used on GHC.Haskell *after* the renamer,
to return a [Name] or [Id].  Before renaming the record punning
and wild-card mechanism makes it hard to know what is bound.
So these functions should not be applied to (GHC.Haskell RdrName)
