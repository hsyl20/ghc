...
desugarer; for example, GHC.HaskellToCore.Utils.mkSelectorBinds uses
...
GHC.HaskellToCore.Arrow and arrowcase1), but SPJ (Jan 2007) says it's
...
So in mkSelectorBinds in GHC.HaskellToCore.Utils, we want just m,n as
the variables bound.
-}
