...
module GHC.Haskell.Syntax.Binding where

import {-# SOURCE #-} GHC.Haskell.Syntax.Expression ( pprExpr, LHsExpr,
                               MatchGroup, pprFunBind,
                               GRHSs, pprPatBind )
import {-# SOURCE #-} GHC.Haskell.Syntax.Pattern  ( LPat )
...
import GHC.Data.BoolFormula (LBooleanFormula)
...
data HsBindLR idL idR
  = -- | Function-like Binding
    ...
    --           'GHC.Haskell.TypeCheck.Binding.tcMonoBinds'.
    --
    ...
    FunBind {
        ...
        fun_id :: Located (IdP idL), -- Note [fun_id in Match] in
  ...
  | AbsBinds {                      -- Binds abstraction; TRANSLATION
       ...
       -- to have the right type
        ...
        -- | Evidence bindings
        -- Why a list? See GHC.Haskell.TypeCheck.Instance
...
variables.  The action happens in GHC.Haskell.TypeCheck.Binding.mkExport.
...
a) Dependency analysis prior to type checking
    (see GHC.Haskell.TypeCheck.Binding.tc_group)

b) Deciding whether we can do generalisation of the binding
    (see GHC.Haskell.TypeCheck.Binding.decideGeneralisationPlan)

c) Deciding whether the binding can be used in static forms
    (see GHC.Haskell.TypeCheck.Expression.checkClosedInStaticForm for the
    HsStatic case and GHC.Haskell.TypeCheck.Binding.isClosedBndrGroup).
...
plusHsValBinds _ _
  = panic "GHC.Haskell.Syntax.Binding.plusHsValBinds"
...
data Sig pass
  =   -- | An ordinary type signature
      ...
      -- For details on above see note [Api annotations] in GHC.Haskell.Syntax.Annotation
    TypeSig
  ...
  | SCCFunSig  SourceText      -- Note [Pragma source text]
                               -- in GHC.Types.BasicTypes
