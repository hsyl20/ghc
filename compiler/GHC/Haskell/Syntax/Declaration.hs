...
~~~~~~~~~~~~~~~
 ...
 - If there is a default method name at all, it's recorded in
   the ClassOpSig (in GHC.Haskell.Syntax.Bind), in the DefMethInfo field.
   (DefMethInfo is defined in GHC.CoreTypes.Class)
...
type LRuleDecls pass = Located (RuleDecls pass)
  ...
  -- Note [Pragma source text] in GHC.CoreTypes.BasicTypes
-- | Rule Declarations
...
data VectDecl pass
  = HsVect
      SourceText   -- Note [Pragma source text] in GHC.CoreTypes.BasicTypes
      (Located (IdP pass))
      (LHsExpr pass)
        -- ^ - 'ApiAnnotation.AnnKeywordId' : 'ApiAnnotation.AnnOpen',
