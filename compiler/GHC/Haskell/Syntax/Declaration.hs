...
module GHC.Haskell.Syntax.Declaration (
...
import {-# SOURCE #-} GHC.Haskell.Syntax.Expression
                        ...
                        -- Because Expression imports Declaration via HsBracket
...
Plan of attack:
 ...
 - When typechecking the decl, we build the implicit TyCons and Ids.
   ...
   (GHC.Haskell.Rename.Environment.lookupSysName), to ensure correct module
   and provenance is set
...
~~~~~~~~~~~~~~~
 ...
 - If there is a default method name at all, it's recorded in
   the ClassOpSig (in GHC.Haskell.Syntax.Binding), in the DefMethInfo field.
   (DefMethInfo is defined in GHC.Types.Class)
...
In *source-code* class declarations:
 ...
 - When parsing, every ClassOpSig gets a DefMeth with a suitable RdrName
   This is done by GHC.Haskell.Parser.Syntax.mkClassOpSigDM
...
GHC.Haskell.TypeCheck.Instance.tcInstDecls1).  So we can't generate the
names for dictionary functions in advance (we don't know how many we need).
...
in GHC.Haskell.Rename for more info.
-}
...
Note [Type family instance declarations in GHC.Haskell]
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
type TyFamDefltEqn pass = FamEqn pass (LHsQTyVars pass) (LHsType pass)
  -- See Note [Type family instance declarations in GHC.Haskell.Syntax]
...
type LRuleDecls pass = Located (RuleDecls pass)
  ...
  -- Note [Pragma source text] in GHC.Types.BasicTypes
-- | Rule Declarations
...
data VectDecl pass
  = HsVect
      SourceText   -- Note [Pragma source text] in GHC.Types.BasicTypes
      (Located (IdP pass))
      (LHsExpr pass)
        -- ^ - 'ApiAnnotation.AnnKeywordId' : 'ApiAnnotation.AnnOpen',
...
lvectDeclName (L _ (HsVectInstIn _))
  = panic "GHC.Haskell.Syntax.Declaration.lvectDeclName: HsVectInstIn"
lvectDeclName (L _ (HsVectInstOut  _))
  = panic "GHC.Haskell.Syntax.Declaration.lvectDeclName: HsVectInstOut"
