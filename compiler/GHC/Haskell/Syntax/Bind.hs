...
data HsBindLR idL idR
  = -- | Function-like Binding
    ...
    --           'GHC.Haskell.TypeCheck.Bind.tcMonoBinds'.
    --
...
variables.  The action happens in GHC.Haskell.TypeCheck.Bind.mkExport.
...
a) Dependency analysis prior to type checking
    (see GHC.Haskell.TypeCheck.Bind.tc_group)

b) Deciding whether we can do generalisation of the binding
    (see GHC.Haskell.TypeCheck.Bind.decideGeneralisationPlan)
...
c) Deciding whether the binding can be used in static forms
    ...
    HsStatic case and GHC.Haskell.TypeCheck.Bind.isClosedBndrGroup).
...
plusHsValBinds _ _
  = panic "GHC.Haskell.Syntax.Bind.plusHsValBinds"
