...
import GHC.Util.Outputable            ( SDoc, Outputable )
import {-# SOURCE #-} GHC.Haskell.Syntax.Pattern  ( LPat )
import GHC.CoreTypes.BasicTypes           ( SpliceExplicitFlag(..))
import GHC.Haskell.Syntax.Extension ( OutputableBndrId, DataId, SourceTextX )
