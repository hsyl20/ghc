...
module GHC.Haskell.Syntax.Literal where

#include "HsVersions.h"

import {-# SOURCE #-} GHC.Haskell.Syntax.Expression ( HsExpr, pprExpr )
import GHC.Types.BasicTypes ( IntegralLit(..),FractionalLit(..)
...
-- the following
-- Note [Trees that grow] in GHC.Haskell.Syntax.Extension for the Xxxxx
...
data HsLit x
  ...
  | HsInt (XHsInt x)  IntegralLit
      ...
      -- @GHC.Haskell.Derive.BasicClasses@, and from TRANSLATION
