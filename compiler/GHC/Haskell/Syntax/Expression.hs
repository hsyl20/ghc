...
import GHC.CoreTypes.RdrName  ( GlobalRdrEnv )
...
data HsExpr p
  ...
  | HsTickPragma                      -- A pragma introduced tick
     ...
     ((SourceText,SourceText),(SourceText,SourceText))
        ...
        -- See Note [Pragma source text] in GHC.CoreTypes.BasicTypes
     (LHsExpr p)
...
-- Exported to GHC.Haskell.Syntax.Bind, which can't see the defn of
-- HsMatchContext
