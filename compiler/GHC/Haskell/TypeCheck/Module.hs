...
module GHC.Haskell.TypeCheck.Module (
...
import GHC.Haskell.TypeCheck.Instantiation( deeplyInstantiate )
...
import GHC.Haskell.TypeCheck.Export
...
import GHC.Types.Coercion              ( pprCoAxiom )
...
import GHC.Haskell.TypeCheck.Annotation
import GHC.Haskell.TypeCheck.Binding
import GHC.Haskell.Parser.HeaderInfo   ( mkPrelImports )
import GHC.Haskell.TypeCheck.Default
import GHC.Haskell.TypeCheck.Environment
import GHC.Haskell.TypeCheck.Rule
import GHC.Haskell.TypeCheck.Foreign
import GHC.Haskell.TypeCheck.Instance
...
import GHC.Haskell.TypeCheck.TypeAndClassDeclaration
import GHC.Haskell.Derive.Typeable    ( mkTypeableBinds )
...
import GHC.Utils
import GHC.Data.Bag
import GHC.Haskell.TypeCheck.Instantiation (tcGetInsts)
...
tcRnModuleTcRnM hsc_env hsc_src
 ...
 = setSrcSpan loc $
   do { let { explicit_mod_hdr = isJust maybe_mod } ;
        ...
        -- interface files, via
        -- GHC.Haskell.TypeCheck.Environment.setGlobalTypeEnv
...
tcRnStmt hsc_env rdr_stmt
  = runTcInteractive hsc_env $ do {
    ...
    global_ids <- mapM (externaliseAndTidyId this_mod) zonked_ids ;
        -- Note [Interactively-bound Ids in GHCi] in GHC.Types.Base
...
-- in GHCi] in GHC.Types.Base for more details. We do this lifting by trying
...
tcRnExpr hsc_env mode rdr_expr
  = runTcInteractive hsc_env $
    ...
    -- (GHC.Haskell.TypeCheck.Binding.mkInferredPolyId). See Trac #10321
...
tcDump env
 = do { dflags <- getDynFlags ;
        ...
        -- Dump bindings as an Haskell AST if -ddump-tc-ast
