...
module GHC.Haskell.TypeCheck.FunctionalDependency (
...
import GHC.Haskell.TypeCheck.Util.CoreType         ( transSuperClasses )
import GHC.CoreTypes.Coercion.Axiom                ( TypeEqn )
import GHC.CoreTypes.Type.Unify
import GHC.Haskell.TypeCheck.FamilyInstance( injTyVarsOfTypes )
import GHC.CoreTypes.Instance
import GHC.CoreTypes.Var.Set
import GHC.CoreTypes.Var.Environment
import GHC.Util.Outputable
import GHC.Util.Error                          ( Validity(..), allValid )
