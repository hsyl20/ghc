...
module GHC.Haskell.TypeCheck.Foreign
        ( tcForeignImports
        , tcForeignExports
...
for the newtype constructors they see. Then GHC.Haskell.TypeCheck.Module
       ...
       ; let
           ...
           -- structure of the foreign type.
             ...
             id                = mkLocalId nm sig_ty
                 ...
                 -- (so GHC.Haskell.TypeCheck.Syntax.zonkForeignExports
                 -- ignores it).
