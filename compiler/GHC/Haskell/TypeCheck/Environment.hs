...
import GHC.CoreTypes.DataCon ( DataCon )
import GHC.CoreTypes.PatternSynonym  ( PatSyn )
...
-- See Note [Bindings with closed types] in GHC.Haskell.TypeCheck.Util
...
to the environment. Then GHC.Haskell.TypeCheck.Type.tcTyVar will find A
...
-- See Note [Placeholder PatSyn kinds] in GHC.Haskell.TypeCheck.Bind
