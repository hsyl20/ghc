...
module GHC.Haskell.TypeCheck.Environment(
...
import GHC.Types.DataCon ( DataCon )
import GHC.Types.PatternSynonym  ( PatSyn )
...
-- GHC.Haskell.TypeCheck.Expression.tcId)
tcLookupId name = do
    thing <- tcLookup name
    case thing of
...
-- See Note [Bindings with closed types] in GHC.Haskell.TypeCheck.Types
...
to the environment. Then GHC.Haskell.TypeCheck.UserType.tcTyVar will find A
...
-- See Note [Placeholder PatSyn kinds] in GHC.Haskell.TypeCheck.Binding
