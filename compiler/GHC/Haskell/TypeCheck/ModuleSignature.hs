...
module GHC.Haskell.TypeCheck.ModuleSignature (
    findExtraSigImports',
    findExtraSigImports,
...
import GHC.Types.BasicTypes (defaultFixity)
import GHC.Packages
...
import GHC.Types.NameShape
import GHC.Haskell.TypeCheck.Error
import GHC.Haskell.TypeCheck.Unify
import GHC.Interface.Rename
import GHC.Utils

import Control.Monad
import Data.List (find, foldl')

import {-# SOURCE #-} GHC.Haskell.TypeCheck.Module
...
-- for "GHC.Driver.Make" and "GHC.Haskell.TypeCheck.Module".
...
mergeSignatures
  ...
  orig_tcg_env lcl_iface0 = setSrcSpan loc $ do
    ...
    -- the types match.
    --
    -- See also Note [rnIfaceNeverExported] in GHC.Interface.Rename
