...
module GHC.Haskell.TypeCheck.Constraint.Canonicalise(
     canonicalize,
     unifyDerived,
...
import GHC.Types.TypeAndCoercion   -- cleverly decomposes types,
                                   -- good for completeness checking
import GHC.Types.Coercion
import GHC.Types.FamilyInstance                 ( FamInstEnvs )
import GHC.Haskell.TypeCheck.FamilyInstance   (tcTopNormaliseNewTypeTF_maybe)
import GHC.Types.Var
import GHC.Types.Var.Environment                ( mkInScopeSet )
import GHC.Types.Var.Set                        ( extendVarSetList )
...
(see type Ct in GHC.Haskell.TypeCheck.Types).
...
1. Eagerly generate superclasses for given (but not wanted)
   ...
   Note [Expanding superclasses] in GHC.Haskell.TypeCheck.Type.
...
3. If we have any remaining unsolved wanteds
   (see Note [When superclasses help] in GHC.Haskell.TypeCheck.Types)
   ...
   GHC.Haskell.TypeCheck.Constraint.Simplify.expandSuperClasses.

4. Go round to (2) again.  This loop (2,3,4) is implemented
   in GHC.Haskell.TypeCheck.Constraint.Simplify.simpl_loop.
...
Note [Instance and Given overlap] in GHC.Haskell.TypeCheck.Constraint.Interact.
...
-- The loop-breaking here follows Note [Expanding superclasses] in
...
GHC.Types.TypeAndCoercion, we can't use NthCo on representational coercions
...
See Note [Rewrite insolubles] in GHC.Haskell.TypeCheck.Constraint.Solve.
And if we don't do this there is a bad danger that
GHC.Haskell.TypeCheck.Constraint.Simplify.applyTyVarDefaulting will find
