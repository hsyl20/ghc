...
module GHC.Haskell.TypeCheck.Constraint.Interact (
     solveSimpleGivens,   -- Solves [Ct]
     solveSimpleWanteds,  -- Solves Cts

     -- for use in GHC.Haskell.TypeCheck.Constraint.Simplify
     solveCallStack,      
  ) where

#include "HsVersions.h"

import GHC.Types.BasicTypes ( SwapFlag(..), isSwapped
                             , infinity, IntWithInf, intGtLimit )
import GHC.Haskell.Syntax.Type   ( HsIPName(..) )
import GHC.Haskell.TypeCheck.Constraint.Canonicalise as Canonicaliser
import GHC.Haskell.TypeCheck.Flatten
import GHC.Haskell.TypeCheck.Unify( canSolveByUnification )
import GHC.Types.Var.Set
import GHC.Types.Type as Type
import GHC.Types.Kind              ( isConstraintKind )
import GHC.Types.Instance     ( DFunInstType, lookupInstEnv
                                    , instanceDFunId )
import GHC.Types.Coercion.Axiom    ( sfInteractTop, sfInteractInert )

import GHC.Haskell.TypeCheck.MutableType (newMetaTyVars)

import GHC.Types.Var
import GHC.Haskell.TypeCheck.Type
import GHC.Types.Name
import GHC.Types.RdrName ( lookupGRE_FieldLabel )
...
import GHC.Types.Id      ( idType, isNaughtyRecordSelector )
import GHC.Types.Coercion.Axiom ( TypeEqn, CoAxiom(..), CoAxBranch(..), fromBranches )
import GHC.Types.Class
import GHC.Types.TyCon
import GHC.Types.DataCon( dataConWrapId )
import GHC.Types.FieldLabel
import GHC.Haskell.TypeCheck.FunctionalDependency
import GHC.Haskell.TypeCheck.FamilyInstance
import GHC.Types.FamilyInstance
import GHC.Types.Type.Unify ( tcUnifyTyWithTFs )

import GHC.Haskell.TypeCheck.Evidence
import GHC.Utils.Outputable

import GHC.Haskell.TypeCheck.Types
import GHC.Haskell.TypeCheck.Constraint.Solve
import GHC.Data.Bag
...
the unflattening that takes place in step (1). See GHC.Haskell.TypeCheck.Flatten,
...
we keep?  More subtle than you might think!
  ...
  * Constraints come from different levels (different_level_strategy)
      ...
      - For everything else, we want to keep the outermost one.  Reason: that
        ...
        in GHC.Haskell.TypeCheck.Constraint.Simplify.
  ...
  * Constraints coming from the same level (i.e. same implication)
       ...
       - Always get rid of InstSC ones if possible, since they are less
         ...
         See Note [Solving superclass constraints] in GHC.Haskell.TypeCheck.Instance
       ...
       - Keep the one that has a non-trivial evidence binding.
         ...
         GHC.Haskell.TypeCheck.Constraint.Simplify again.
...
See also Note [Injective type families] in GHC.Types.TyCon
...
--     See GHC.Haskell.TypeCheck.Types.Ct invariants.
--
...
GHC.Haskell.TypeCheck.Constraint.Solve; avoiding double unifications is
...
GHC.Haskell.TypeCheck.FunctionalDependency (nicer now!).
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
c.f. Note [The flattening story] in GHC.Haskell.TypeCheck.Flatten
...
* For type-nat stuff the derived constraints include type families;
  ...
  (GHC.Haskell.TypeCheck.Flatten.unflatten).
...
see Note [Simplifiable given constraints] in GHC.Haskell.TypeCheck.Validity.
-}
...
matchInstEnv dflags clas tys loc
   ...
   where
     ...
     match_one :: SafeOverlapping -> DFunId -> [DFunInstType] -> TcS LookupInstResult
                  -- See Note [DFunInstType: instantiating types] in
                  -- GHC.Types.Instance
...
-- in GHC.Haskell.TypeCheck.Evidence.  The coercion happens in 2 steps:
--
