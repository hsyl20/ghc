...
module GHC.Haskell.TypeCheck.Constraint.Solve (
    ...
    -- GHC.Haskell.TypeCheck.Constraint.Simplify. I am wondering if the
...
import qualified GHC.Haskell.TypeCheck.Instantiation as TcM
import GHC.Types.Instance
import GHC.Haskell.TypeCheck.FamilyInstance as FamInst
import GHC.Types.FamilyInstance

import qualified GHC.Haskell.TypeCheck as TcM
import qualified GHC.Haskell.TypeCheck.MutableType as TcM
...
import GHC.Haskell.TypeCheck.Error   ( solverDepthErrorTcS )

import GHC.Types.Name
import GHC.Types.RdrName ( GlobalRdrEnv, GlobalRdrElt )
import qualified GHC.Haskell.Rename.Environment as TcM
...
The InertCans represents a collection of constraints with the following properties:
  ...
  * CTyEqCan equalities: see Note [Applying the inert substitution]
                         in GHC.Haskell.TypeCheck.Flatten
...
GHC.Haskell.TypeCheck.Constraint.Solve.kickOutRewritable
...
rewrite Wanteds] in GHC.Haskell.TypeCheck.Types), we may miss some
...
-- in GHC.Haskell.TypeCheck.Constraint.Interact.
...
panicTcS doc = pprPanic "GHC.Haskell.TypeCheck.Constraint.Canonicalise" doc
...
-- Getters and setters of GHC.Haskell.TypeCheck.Environment fields
-- ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
-- See Note [Bind new Givens immediately] in GHC.Haskell.TypeCheck.Types
...
-- --------- Check done in GHC.Haskell.TypeCheck.Constraint.Interact.selectNewWorkItem???? ---------
...
from which we get the implication
   (forall a. t1 ~ t2)
See GHC.Haskell.TypeCheck.Constraint.Solve.deferTcSForAllEq
-}
