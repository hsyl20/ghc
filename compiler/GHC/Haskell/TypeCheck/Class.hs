...
module GHC.Haskell.TypeCheck.Class ( tcClassSigs, tcClassDecl2,
...
import GHC.CoreTypes.Type                       ( getClassPredTys_maybe
                                             , piResultTys )
...
and so it is. See GHC.Haskell.TypeCheck.Bind.tcMonoBinds (with type-sig
case).
