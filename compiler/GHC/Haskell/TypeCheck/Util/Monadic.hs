...
module GHC.Haskell.TypeCheck.Util.Monadic (
...
See Note [TcLevel assignment] in GHC.Haskell.TypeCheck.Util.CoreType.
-}
  ...
  = ASSERT2( isMetaTyVar tv, ppr tv )
    do  { when debugIsOn (check_empty tv)
        ...
        ; let uniq        = getUnique tv
                ...
                -- important for GHC.Haskell.TypeCheck.Type.splitTelescopeTvs to work properly
...
GHC.Haskell.TypeCheck.Simplify.tcSimplifyInferCheck).
...
GHC.Haskell.TypeCheck.Simplify.tcSimplifyTop.
...
-- smart constructors. See Note [Type-checking inside the knot] in
...
zonkTyCoVar tv | isTcTyVar tv = zonkTcTyVar tv
   ...
   -- GHC.Haskell.TypeCheck.Type.tcTyClTyVars, but it seems
...
Why?, for example:
- For CDictCan, the
  @GHC.Haskell.TypeCheck.Simplify.expandSuperClasses@ step,
...
@GHC.Haskell.TypeCheck.Solver.Canonicalise@ even if they come in as
...
-- See Note [SigSkol SkolemInfo] in GHC.Haskell.TypeCheck.Util
...
See Note [Levity polymorphism checking] in GHC.HaskellToCore.Monad
