...
module GHC.Haskell.TypeCheck.Bind
...
@tcBindsAndThen@ typechecks a @GHC.Haskell.Syntax.Bind@.  The "and then"
...
tc_group top_lvl sig_fn prag_fn (Recursive, binds) closed thing_inside
  =     -- To maximise polymorphism, we do a new
        ...
        -- See Note [Polymorphic recursion] in GHC.Haskell.Syntax.Bind.
  ...
  = checkNoErrs $  -- The checkNoErrs ensures that if the type is ambiguous
    ...
    do { fam_envs <- tcGetFamInstEnvs
       ; let (_co, mono_ty') = normaliseType fam_envs Nominal mono_ty
               ...
               -- GHC.Haskell.TypeCheck.Solver.Flatten) so do it here to make it
...
tcVect (HsVectTypeOut _ _ _)
  = panic "GHC.Haskell.TypeCheck.Bind.tcVect: Unexpected 'HsVectTypeOut'"
...
tcVect (HsVectClassOut _)
  = panic "GHC.Haskell.TypeCheck.Bind.tcVect: Unexpected 'HsVectClassOut'"
...
tcVect (HsVectInstOut _)
  = panic "GHC.Haskell.TypeCheck.Bind.tcVect: Unexpected 'HsVectInstOut'"
