...
module GHC.Haskell.TypeCheck.ClassDeclaration ( tcClassSigs, tcClassDecl2,
...
import GHC.Types.Type                       ( getClassPredTys_maybe
                                             , piResultTys )
...
and so it is. See GHC.Haskell.TypeCheck.Binding.tcMonoBinds (with type-sig
case).
