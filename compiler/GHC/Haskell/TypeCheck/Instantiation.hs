...
module GHC.Haskell.TypeCheck.Instantiation (
       deeplySkolemise,
...
import {-# SOURCE #-} GHC.Haskell.TypeCheck.Unify
                        ( unifyType, unifyKind, noThing )

import GHC.Types.BasicTypes ( IntegralLit(..), SourceText(..) )
...
import GHC.Types.Var               ( EvVar, mkTyVar, tyVarName, TyVarBndr(..) )
...
-- See Note [DFunInstType: instantiating types] in GHC.Types.Instance
...
-- newOverloadedLit in GHC.Haskell.TypeCheck.Unify
...
newClsInst overlap_mode dfun_name tvs theta clas tys
  = do { (subst, tvs') <- freshenTyVarBndrs tvs
       ...
       ; let tys' = substTys subst tys
             ...
             --     an InstInfo, and in
             --     GHC.Haskell.TypeCheck.Environment.pprInstInfoDetails
