...
import GHC.CoreTypes.Instance( roughMatchTcs )
...
import GHC.CoreTypes.DataCon ( dataConName )
...
certain that the modules in our `GHC.CoreTypes.Base.dep_finsts' are consistent.)
