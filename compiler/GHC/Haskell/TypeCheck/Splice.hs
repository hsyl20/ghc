...
module GHC.Haskell.TypeCheck.Splice(
...
import GHC.Haskell.Rename.Splice ( traceSplice, SpliceInfo(..) )
...
import GHC.Haskell.TypeCheck.Constraint.Simplify
import GHC.Types.Type as Type
import GHC.Types.Kind
import GHC.Types.Name.Set
import GHC.Haskell.TypeCheck.MutableType
import GHC.Haskell.TypeCheck.UserType
...
import GHC.Types.OccName as OccName
...
import GHC.Types.DataCon as DataCon
import GHC.Haskell.TypeCheck.Evidence( TcEvBinds(..) )
import GHC.Types.Id
...
import GHC.Types.Var.Set ( isEmptyVarSet, filterVarSet, mkVarSet, elemVarSet )
import Data.List          ( find )
import Data.Maybe
import GHC.Data.FastString
import GHC.Types.BasicTypes hiding( SuccessFlag(..) )
import qualified GHC.Types.BasicTypes as BasicTypes
...
very straightforwardly:
  ...
  2. runMetaT: desugar, compile, run it, and convert result back to
     GHC.Haskell RdrName (of the appropriate flavour, eg HsType RdrName,
     HsExpr RdrName etc)
...
In both cases, desugaring happens like this:
  * HsTcBracketOut is desugared by GHC.Compiler.HaskellToCore.Splice.dsBracket.  It
  ...
  * When GHC.Compiler.HaskellToCore.Splice (used to desugar the body of the
    ...
    (GHC.Compiler.HaskellToCore.Splice.repSplice).
...
tcSpliceExpr splice@(HsTypedSplice _ name expr) res_ty
  = addErrCtxt (spliceCtxtDoc splice) $
    ...
    ; case stage of
          ...
          RunSplice _          ->
            -- See Note [RunSplice ThLevel] in GHC.Haskell.TypeCheck.Types
...
"GHC.Haskell.Rename.Splice"). Thus after executing the splice, we move the
...
runMeta' show_code ppr_hs run_and_convert expr
  = do  { traceTc "About to run" (ppr expr)
        ...
        ; either_hval <- tryM $ liftIO $
                         GHC.Driver.Main.hscCompileCoreExpr hsc_env src_span
                                                             ds_expr
        ; case either_hval of {
...
like that.  Here's how it's processed:
  ...
  * The TcM monad is an instance of Quasi (see
    GHC.Haskell.TypeCheck.Splice), and it implements (qReport True s) by
...
-- GHC.Haskell.TypeCheck.Environment.tcLookup; specialised mainly in that
...
annotThType :: Bool   -- True <=> annotate
            -> GHC.Types.TypeAndCoercion.Type -> TH.Type -> TcM TH.Type
      ...
      DataFamilyInst rep_tc ->
        do { let rep_tvs = tyConTyVars rep_tc
                 fam' = reifyName fam
                   ...
                   -- in GHC.Haskell.TypeCheck.Instance
...
------------------------------
reifyType :: GHC.Types.TypeAndCoercion.Type -> TcM TH.Type
...
reify_for_all :: GHC.Types.TypeAndCoercion.Type -> TcM TH.Type
reify_for_all ty
  = do { cxt' <- reifyCxt cxt;
       ; tau' <- reifyType tau
...
reifyTyLit :: GHC.Types.TypeAndCoercion.TyLit -> TcM TH.TyLit
...
reify_kc_app :: TyCon -> [GHC.Types.TypeAndCoercion.Kind] -> TcM TH.Kind
reify_kc_app kc kis
...
reifyPred :: GHC.Types.TypeAndCoercion.PredType -> TcM TH.Pred
reifyPred ty
