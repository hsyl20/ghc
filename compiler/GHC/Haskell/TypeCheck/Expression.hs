...
\section[GHC.Haskell.TypeCheck.Expression]{Typecheck an expression}
-}
...
module GHC.Haskell.TypeCheck.Expression
...
import GHC.Haskell.TypeCheck.Binding       ( chooseInferredQuantifiers
                                           , tcLocalBinds )
import GHC.Haskell.TypeCheck.Signature     ( tcUserTypeSig, tcInstSig )
...
import GHC.Haskell.TypeCheck.FamilyInstance( tcGetFamInstEnvs
                                           , tcLookupDataFamInst )
import GHC.Types.FamilyInstance            ( FamInstEnvs )
...
import GHC.Haskell.TypeCheck.Matches
import GHC.Haskell.TypeCheck.UserType
import GHC.Haskell.TypeCheck.PatternSynonym( tcPatSynBuilderOcc
                                           , nonBidirectionalErr )
import GHC.Haskell.TypeCheck.Pattern
import GHC.Haskell.TypeCheck.MutableType
import GHC.Haskell.TypeCheck.Type as TcType
...
import GHC.Utils
import GHC.Types.Var.Environment         ( emptyTidyEnv, mkInScopeSet )
import GHC.Data.List.SetOps
import GHC.Data.Maybe
import GHC.Utils.Outputable as Outputable
import GHC.Data.FastString
import Control.Monad
import GHC.Types.Class                   (classTyCon)
import GHC.Data.UniqueSet              ( nonDetEltsUniqSet )
...
See also Note [seqId magic] in GHC.Types.Id.Make
-}
...
tcExpr (HsIf Nothing pred b1 b2) res_ty    -- Ordinary 'if'
  = do { pred' <- tcMonoExpr pred (mkCheckExpType boolTy)
       ; res_ty <- tauifyExpType res_ty
           ...
           -- in GHC.Haskell.TypeCheck.Matches (See #10619)
...
tcExpr (HsMultiIf _ alts) res_ty
  = do { res_ty <- if isSingleton alts
             ...
             -- Just like GHC.Haskell.TypeCheck.Matches
...
GHC.Haskell.TypeCheck.TypeAndClassDeclaration), at least in the case of
GADTs. Consider
  ...
  = ASSERT( notNull rbnds )
    do  { -- STEP -2: typecheck the record_expr, the record to be updated
        ...
        ; let fixed_tvs = getFixedTyVars upd_fld_occs con1_tvs relevant_cons
              ...
              --   c.f. GHC.Haskell.TypeCheck.MutableType.newMetaTyVars
...
tcExpr (PArrSeq _ _) _
  = panic "GHC.Haskell.TypeCheck.Expression.tcExpr: Infinite parallel array!"
...
-- 'GHC.Haskell.Rename.Splice.rnSpliceExpr'.
...
tcInferFun fun
  = tcInferSigma fun
      -- NB: tcInferSigma; see GHC.Haskell.TypeCheck.Unify
...
just like in GHC.Haskell.TypeCheck.Binding.decideGeneralisationPlan
...
--
-- This is similar to checkCrossStageLifting in GHC.Haskell.Rename.Splice,
...
See also Note [HsRecField and HsRecUpdField] in GHC.Haskell.Syntax.Pattern.
-}
...
mixedSelectors _ _ =
  panic "GHC.Haskell.TypeCheck.Expression: mixedSelectors emptylists"
