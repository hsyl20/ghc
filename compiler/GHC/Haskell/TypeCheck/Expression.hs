...
import GHC.Haskell.TypeCheck.Bind       ( chooseInferredQuantifiers
                                           , tcLocalBinds )
...
import GHC.Haskell.TypeCheck.Match
...
tcExpr (HsIf Nothing pred b1 b2) res_ty    -- Ordinary 'if'
  = do { pred' <- tcMonoExpr pred (mkCheckExpType boolTy)
       ; res_ty <- tauifyExpType res_ty
           ...
           -- in GHC.Haskell.TypeCheck.Match (See #10619)
...
tcExpr (HsMultiIf _ alts) res_ty
  = do { res_ty <- if isSingleton alts
             ...
             -- Just like GHC.Haskell.TypeCheck.Match
...
GHC.Haskell.TypeCheck.TypeDecl), at least in the case of
GADTs. Consider
  ...
  = ASSERT( notNull rbnds )
    do  { -- STEP -2: typecheck the record_expr, the record to be updated
        ...
        ; let fixed_tvs = getFixedTyVars upd_fld_occs con1_tvs relevant_cons
              ...
              --   c.f. GHC.Haskell.TypeCheck.Util.Monadic.newMetaTyVars
...
just like in GHC.Haskell.TypeCheck.Bind.decideGeneralisationPlan
