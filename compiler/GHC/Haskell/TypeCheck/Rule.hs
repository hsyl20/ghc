...
import GHC.Haskell.TypeCheck.Evidence   ( mkTcCoVarCo )
import GHC.Types.Type
import GHC.Types.Id
import GHC.Types.Var                        ( EvVar )
import GHC.Types.BasicTypes                 ( RuleName )
...
tcRule (HsRule name act hs_bndrs lhs fv_lhs rhs fv_rhs)
  = addErrCtxt (ruleCtxt $ snd $ unLoc name)  $
    do { traceTc "---- Rule ------" (pprFullRuleName name)
       ...
       -- c.f. GHC.Haskell.TypeCheck.Constraint.Simplify.simplifyInfer
       ...
       -- during zonking (see GHC.Haskell.TypeCheck.Syntax.zonkRule)
