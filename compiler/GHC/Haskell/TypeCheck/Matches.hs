...
GHC.Haskell.TypeCheck.Matches: Typecheck some @Matches@
-}
...
module GHC.Haskell.TypeCheck.Matches
...
import GHC.Types.BasicTypes (LexicalFixity(..))
...
See Note [sig_tau may be polymorphic] in GHC.Haskell.TypeCheck.Pattern.
-}
...
tcMatchLambda :: SDoc -- see Note [Herald for matchExpectedFunTys]
                      -- in GHC.Haskell.TypeCheck.Unify
              -> TcMatchCtxt HsExpr
              -> MatchGroup GhcRn (LHsExpr GhcRn)
...
tcLcStmt m_tc ctxt (TransStmt { trS_form = form, trS_stmts = stmts
  ...
  = do { let (bndr_names, n_bndr_names) = unzip bindersMap
       ...
       ; let mk_n_bndr :: Name -> TcId -> TcId
             ...
             -- See Note [GroupStmt binder map] in
