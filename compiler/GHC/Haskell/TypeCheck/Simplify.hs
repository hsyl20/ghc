...
module GHC.Haskell.TypeCheck.Simplify(
...
captureTopConstraints thing_inside
  = do { static_wc_var <- TcM.newTcRef emptyWC ;
       ...
       -- See GHC.Haskell.TypeCheck.Monad Note [Constraints and errors]
       ...
       ; case mb_res of
           ...
           Left {}   -> do { _ <- reportUnsolved lie; failM } }
                ...
                -- this function is here instead of GHC.Haskell.TypeCheck.Monad
...
How is this implemented? It's complicated! So we'll step through it all:
 ...
 2) `GHC.Haskell.TypeCheck.Solver.Interact.matchClassInst`
 ...
 3) `GHC.Haskell.TypeCheck.Solver.Interact.doTopReactDict`
 ...
 4) `GHC.Haskell.TypeCheck.Simplify.simplifyTop`:
 ...
 * Gather the constraints for the RHS with ambient level *one more than*
   ...
   in GHC.Haskell.TypeCheck.Bind.tcPolyInfer
...
growThetaTyVars theta tvs
  ...
  where
    ...
    (ips, non_ips) = partition isIPPred theta
                         ...
                         -- GHC.Haskell.TypeCheck.Util.CoreType
...
-- See Note [The superclass story] in GHC.Haskell.TypeCheck.Solver.Canonicalise
...
*  To find (a), when we have two Given constraints,
   ...
   GHC.Haskell.TypeCheck.Solver.Interact.solveOneFromTheOther
...
* We don't report redundant givens for *every* implication; only for those which
  reply True to
  GHC.Haskell.TypeCheck.Simplify.warnRedundantGivens:
   ...
   - More subtly, in a function definition
     ...
     other set False in
        - GHC.Haskell.TypeCheck.Bind.tcSpecPrag
        - GHC.Haskell.TypeCheck.Bind.tcTySig
...
GHC.Haskell.TypeCheck.Util.CoreType.  for the leftover implication.
...
GHC.Haskell.TypeCheck.Simplify prior to Oct 2014).
