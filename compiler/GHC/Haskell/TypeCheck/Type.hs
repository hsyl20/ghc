...
module GHC.Haskell.TypeCheck.Type (
  --------------------------------
  -- Types
...
-- See Note [ExpType] in GHC.Haskell.TypeCheck.MutableType, where you'll
...
data InferResult
  = IR { ir_uniq :: Unique  -- For debugging only
       , ir_lvl  :: TcLevel -- See Note [TcLevel of ExpType] 
                            -- in GHC.Haskell.TypeCheck.MutableType
...
-- See Note [Binding when looking up instances] in GHC.Types.Instance
...
-- GHC.Haskell.TypeCheck.Constraint.Canonicalise for details.
...
-- equality] (in GHC.Types.TypeAndCoercion) as `eqType`, but Type.eqType
...
tc_eq_type view_fun orig_ty1 orig_ty2 = go True orig_env orig_ty1 orig_ty2
  where
    ...
    go vis env (FunTy arg res) ty
      ...
      -- See Note [Equality on AppTys] in GHC.Types.Type
...
-- because it is called from GHC.Haskell.TypeCheck.Constraint.Simplify,
...
See also GHC.Haskell.TypeCheck.TypeDeclaration.checkClassCycles.
...
-- GHC.Haskell.TypeCheck.Constraint.Canonicalise for the motivation for
-- this function.
