...
import GHC.Haskell.TypeCheck.Simplify ( solveEqualities )
...
import GHC.CoreTypes.RdrName                     ( lookupLocalRdrOcc )
...
--
-- See also Note [Associated type tyvar names] in GHC.CoreTypes.Class
--
...
-- pass in GHC.Haskell.TypeCheck.TypeDecl. (Never in
