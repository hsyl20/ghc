...
module GHC.Haskell.TypeCheck.Solver.Flatten(
   FlattenMode(..),
...
import GHC.CoreTypes.Type.Internal   -- performs delicate algorithm on types
...
import GHC.CoreTypes.BasicTypes( SwapFlag(..) )

import GHC.Util
import GHC.Data.Bag
import GHC.Data.Pair
import Control.Monad
import GHC.Util.Monad ( zipWithAndUnzipM )
...
GHC.Haskell.TypeCheck.Solver.Canonicalise.canEqTyVar.
...
GHC.Haskell.TypeCheck.Solver.Canonicalise.homogeniseRhsKind).
...
GHC.Haskell.TypeCheck.Solver.Interact.kick_out, by only kicking out an
inert only if 
