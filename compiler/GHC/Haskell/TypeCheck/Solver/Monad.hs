...
module GHC.Haskell.TypeCheck.Solver.Monad (
    ...
    -- GHC.Haskell.TypeCheck.Simplify. I am wondering if the
...
import GHC.CoreTypes.RdrName ( GlobalRdrEnv, GlobalRdrElt )
...
The InertCans represents a collection of constraints with the following properties:
  ...
  * CTyEqCan equalities: see Note [Applying the inert substitution]
                         in GHC.Haskell.TypeCheck.Solver.Flatten
...
GHC.Haskell.TypeCheck.Solver.Monad.kickOutRewritable
...
rewrite Wanteds] in GHC.Haskell.TypeCheck.Util), we may miss some
...
panicTcS doc = pprPanic "GHC.Haskell.TypeCheck.Solver.Canonicalise" doc
...
-- See Note [Bind new Givens immediately] in GHC.Haskell.TypeCheck.Util
...
-- --------- Check done in GHC.Haskell.TypeCheck.Solver.Interact.selectNewWorkItem???? ---------
...
from which we get the implication
   (forall a. t1 ~ t2)
See GHC.Haskell.TypeCheck.Solver.Monad.deferTcSForAllEq
-}
