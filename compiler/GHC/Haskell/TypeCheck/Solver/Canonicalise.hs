...
module GHC.Haskell.TypeCheck.Solver.Canonicalise(
     canonicalize,
     unifyDerived,
...
import GHC.CoreTypes.Type.Internal   -- cleverly decomposes types,
...
(see type Ct in GHC.Haskell.TypeCheck.Util).
...
1. Eagerly generate superclasses for given (but not wanted)
   ...
   Note [Expanding superclasses] in GHC.Haskell.TypeCheck.Util.CoreType.
...
3. If we have any remaining unsolved wanteds
   (see Note [When superclasses help] in GHC.Haskell.TypeCheck.Util)
   ...
   GHC.Haskell.TypeCheck.Simplify.expandSuperClasses.

4. Go round to (2) again.  This loop (2,3,4) is implemented
   in GHC.Haskell.TypeCheck.Simplify.simpl_loop.
...
Note [Instance and Given overlap] in GHC.Haskell.TypeCheck.Solver.Interact.
...
GHC.CoreTypes.Type.Internal, we can't use NthCo on representational coercions
...
See Note [Rewrite insolubles] in GHC.Haskell.TypeCheck.Solver.Monad.
And if we don't do this there is a bad danger that
GHC.Haskell.TypeCheck.Simplify.applyTyVarDefaulting will find
