...
module GHC.Haskell.TypeCheck.Solver.Interact (
...
import GHC.Haskell.TypeCheck.Util.Monadic (newMetaTyVars)
...
import GHC.Haskell.TypeCheck.Solver.Monad
import GHC.Data.Bag
...
the unflattening that takes place in step (1). See GHC.Haskell.TypeCheck.Solver.Flatten,
...
we keep?  More subtle than you might think!
  ...
  * Constraints come from different levels (different_level_strategy)
      ...
      - For everything else, we want to keep the outermost one.  Reason: that
        ...
        in GHC.Haskell.TypeCheck.Simplify.
  ...
  * Constraints coming from the same level (i.e. same implication)
       ...
       - Keep the one that has a non-trivial evidence binding.
         ...
         GHC.Haskell.TypeCheck.Simplify again.
...
--     See GHC.Haskell.TypeCheck.Util.Ct invariants.
--
...
GHC.Haskell.TypeCheck.Solver.Monad; avoiding double unifications is
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
c.f. Note [The flattening story] in GHC.Haskell.TypeCheck.Solver.Flatten
...
* For type-nat stuff the derived constraints include type families;
  ...
  (GHC.Haskell.TypeCheck.Solver.Flatten.unflatten).
