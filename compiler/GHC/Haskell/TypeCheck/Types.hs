...
Various types used during typechecking, please see GHC.Haskell.TypeCheck as
...
module GHC.Haskell.TypeCheck.Types(
...
import GHC.Types.TyCon  ( TyCon, tyConKind )
import GHC.Types.Coercion         ( Coercion, mkHoleCo )
import GHC.Types.ConLike  ( ConLike(..) )
import GHC.Types.DataCon  ( DataCon, dataConUserType, dataConOrigArgTys )
import GHC.Types.PatternSynonym   ( PatSyn, pprPatSynType )
...
import GHC.Compiler.HaskellToCore.Match.Expression
import GHC.Utils.Monad.IOEnv
import GHC.Types.RdrName
import GHC.Types.Name
import GHC.Types.Name.Environment
import GHC.Types.Name.Set
import GHC.Types.Available
import GHC.Types.Var
import GHC.Types.Var.Free as FV
...
-- (see 'GHC.Interface.Rename').  Specifically, a 'NameShape' for
...
*                                                                      *
    ...
    All the combinators for the monad can be found in GHC.Haskell.TypeCheck
*                                                                      *
************************************************************************
...
--
-- This data type really should be in GHC.Types.Base, but it needs
...
--        Similarly, in GHC.Haskell.Rename.ImportExport we check for
...
data TcGblEnv
  = TcGblEnv {
        ...
        tcg_type_env :: TypeEnv,
          ...
          -- Note [The interactive package] in GHC.Types.Base
        ...
        -- For the latter, see Note [The interactive package] in GHC.Types.Base
...
data ThStage    
  ...
  | RunSplice (TcRef [ForeignRef (TH.Q ())])
      ...
      -- [Delaying modFinalizers in untyped splices] in "GHC.Haskell.Rename.Splice".
      --
      ...
      --
      -- See Note [Collecting modFinalizers in typed splices] in
      -- GHC.Haskell.TypeCheck.Splice.
...
type ThLevel = Int
    -- NB: see Note [Template Haskell levels] in GHC.Haskell.TypeCheck.Splice
...
data PromotionErr
  ...
  | RecDataConPE     -- Data constructor in a recursive loop
                     -- See Note [Recursion and promoting data constructors] in
                     -- GHC.Haskell.TypeCheck.TypeAndClassDeclaration
...
--    GHC.Haskell.TypeCheck.Expression.checkClosedInStaticForm and
-- b) to figure out when a nested binding can be generalised, in
--    GHC.Haskell.TypeCheck.Binding.decideGeneralisationPlan.
--
...
data ImportAvails
   = ImportAvails {
        imp_mods :: ImportedMods,
          ...
          --
          -- See the documentation on ImportedModsVal in GHC.Types.Base for
...
-- GHC.Haskell.TypeCheck.Constraint.Simplify uses them, and
-- GHC.Haskell.TypeCheck.Constraint.Simplify is fairly low down in the
-- module hierarchy
...
data TcIdSigInst
  = TISI { sig_inst_sig :: TcIdSigInfo
         ...
         , sig_inst_skols :: [(Name, TcTyVar)]
               ...
               -- GHC.Haskell.TypeCheck.Signature
...
It happens, too!  See Note [Polymorphic methods] in GHC.Haskell.TypeCheck.ClassDeclaration.
...
-- (GHC.Haskell.TypeCheck.Constraint.Canonicalise)
...
data Ct
  ...
  | CTyEqCan {  -- tv ~ rhs
       ...
       --     equalities] in GHC.Haskell.TypeCheck.Constraint.Canonicalise
  ...
  | CFunEqCan {  -- F xis ~ fsk
      ...
      cc_fsk    :: TcTyVar  -- [Given]  always a FlatSkolTv
        ...
        -- See Note [The flattening story] in GHC.Haskell.TypeCheck.Flatten
    }

  | CNonCanonical {        -- See Note [NonCanonical Semantics] 
                           -- in GHC.Haskell.TypeCheck.Constraint.Solve
      cc_ev  :: CtEvidence
    }
...
built (in GHC.Haskell.TypeCheck.Constraint.Canonicalise).
...
-- set. See Note [Deterministic FV] in GHC.Types.Var.Free.
tyCoVarsOfCts :: Cts -> TcTyCoVarSet
tyCoVarsOfCts = fvVarSet . tyCoFVsOfCts

-- | Returns free variables of a bag of constraints as a deterministically
-- odered list. See Note [Deterministic FV] in GHC.Types.Var.Free.
tyCoVarsOfCtsList :: Cts -> [TcTyCoVar]
tyCoVarsOfCtsList = fvVarList . tyCoFVsOfCts

-- | Returns free variables of a bag of constraints as a composable FV
-- computation. See Note [Deterministic FV] in GHC.Types.Var.Free.
tyCoFVsOfCts :: Cts -> FV
...
-- ordered list. See Note [Deterministic FV] in GHC.Types.Var.Free.
...
*                                                                      *
                Wanted constraints
     These are forced to be in GHC.Haskell.TypeCheck.Types because
...
the implication in
GHC.Haskell.TypeCheck.Constraint.Simplify.floatEqualities or
GHC.Haskell.TypeCheck.Constraint.Simplify.approximateImplications
...
a coercion that is used in a type. (See the comments in Note [Flattening] in GHC.Haskell.TypeCheck.Flatten
...
data TcEvDest
  ...
  | HoleDest  CoercionHole  -- ^ fill in this hole with the evidence
              ...
              -- See Note [Coercion holes] in GHC.Types.TypeAndCoercion
...
"shadow" [D] in GHC.Haskell.TypeCheck.Constraint.Solve.maybeEmitShadow.
...
-- Note [Flavours with roles] in GHC.Haskell.TypeCheck.Constraint.Solve
...
GHC.Haskell.TypeCheck.Constraint.Interact.
...
data SkolemInfo
  ...
  | ArrowSkol           -- An arrow form (see GHC.Haskell.TypeCheck.Arrow)
...
* Then when tidying in GHC.Haskell.TypeCheck.MutableType.tidySkolemInfo, we
