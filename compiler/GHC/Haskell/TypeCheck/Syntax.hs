...
import GHC.CoreTypes.TyCon   ( isUnboxedTupleTyCon )
...
************************************************************************
*                                                                      *
\subsection[BackSubst-HsBinds]{Running a substitution over @GHC.Haskell.Syntax.Bind@}
*                                                                      *
************************************************************************
...
GHC.Haskell.TypeCheck.Util.Monadic.instSkolTyCoVarX.)
...
{- Note [Zonking the LHS of a RULE]
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
See also GHC.HaskellToCore.Bind Note [Free tyvars on rule LHS]
...
* In GHC.HaskellToCore.Bind, we quantify over it.
  See GHC.HaskellToCore.Bind Note [Free tyvars on rule LHS]
