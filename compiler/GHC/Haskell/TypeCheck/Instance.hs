...
module GHC.Haskell.TypeCheck.Instance
   ( tcInstDecls1
   , tcInstDeclsDeriv
   , tcInstDecls2
   )
...
import GHC.Core.Inliner ( mkInlineUnfoldingWithArity
                                       , mkDFunUnfolding )
...
import GHC.Utils
import GHC.Data.BoolFormula ( isUnsatisfied, pprBooleanFormulaNice )
 ...
 * We make GHC.Core.Inliner.exprIsConApp_maybe spot a
...
tcDataFamInstDecl mb_clsinfo
           ...
           do { let ty_binders = mkTyConBindersPreferAnon full_tvs res_kind'
              ...
              ; let axiom  = mkSingleCoAxiom Representational
                    ...
                    parent = DataFamInstTyCon axiom fam_tc all_pats
                      ...
                      -- the end of Note [Data type families] in GHC.Types.TyCon
  ...
  where
    ...
    -- See Note [Eta reduction for data families] in GHC.Types.FamilyInstance
...
tcInstDecls2 tycl_decls inst_decls
  = do  { -- (a) Default methods from class decls
        ...
        ; let dm_ids = collectHsBindsBinders dm_binds
              ...
              -- GHC.Haskell.TypeCheck.TypeDeclaration.tcAddImplicits)
 ...
 * Overall instance implication. There is an overall enclosing
   ...
   and superclasses.
   See GHC.Haskell.TypeCheck.Constraint.Simplify Note [Tracking redundant
   constraints]
...
GHC.Haskell.TypeCheck.Validity.sizeTypes.
...
Answer:
  ...
  * (sc2) ScOrigin wanted constraints can't be solved from a
    ...
    implemented by
    GHC.Haskell.TypeCheck.Constraint.Interact.prohibitedSuperClassSolve
  ...
  * When we make a superclass selection from InstSkol we use
    ...
    in GHC.Haskell.TypeCheck.Constraint.Canonicalise.newSCWorkFromFlavored
...
tcMethod
- Make the method bindings, as a [(NonRec, GHC.Haskell.Syntax.Binding)], one
  per method
