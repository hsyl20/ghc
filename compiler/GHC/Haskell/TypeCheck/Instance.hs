...
import GHC.Haskell.TypeCheck.Bind
import GHC.Haskell.TypeCheck.TypeDecl
...
tcDataFamInstDecl mb_clsinfo
           ...
           do { let ty_binders = mkTyConBindersPreferAnon full_tvs res_kind'
              ...
              ; let axiom  = mkSingleCoAxiom Representational
                    ...
                    parent = DataFamInstTyCon axiom fam_tc all_pats
                      ...
                      -- the end of Note [Data type families] in GHC.CoreTypes.TyCon
  ...
  where
    ...
    -- See Note [Eta reduction for data families] in GHC.CoreTypes.FamilyInstance
...
tcInstDecls2 tycl_decls inst_decls
  = do  { -- (a) Default methods from class decls
        ...
        ; let dm_ids = collectHsBindsBinders dm_binds
              ...
              -- GHC.Haskell.TypeCheck.TypeDeclUtil.tcAddImplicits)
 ...
 * Overall instance implication. There is an overall enclosing
   ...
   and superclasses.
   See GHC.Haskell.TypeCheck.Simplify Note [Tracking redundant
   constraints]
...
Answer:
  ...
  * (sc2) ScOrigin wanted constraints can't be solved from a
    ...
    implemented by
    GHC.Haskell.TypeCheck.Solver.Interact.prohibitedSuperClassSolve
  ...
  * When we make a superclass selection from InstSkol we use
    ...
    in GHC.Haskell.TypeCheck.Solver.Canonicalise.newSCWorkFromFlavored
...
tcMethod
- Make the method bindings, as a [(NonRec, GHC.Haskell.Syntax.Bind)], one
  per method
