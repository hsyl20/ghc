...
import GHC.CoreTypes.Type                   ( mkEmptyTCvSubst, tidyTyVarBinders
                                        , tidyTypes, tidyType )
...
import GHC.CoreTypes.Id.Info           ( RecSelParent(..), setLevityInfoWithType )
  ...
  = addPatSynCtxt lname $
    do { let decl_arity = length arg_names
       ...
       ; let skol_info = SigSkol (PatSynCtxt name) pat_ty []
                         ...
                         -- See GHC.Haskell.TypeCheck.Util
  ...
  = do { rr_name <- newNameAt (mkTyVarOcc "rep") loc
       ...
       ; let matcher_tau   = mkFunTys [pat_ty, cont_ty, fail_ty] res_ty
             ...
             matcher_id    = mkExportedVanillaId matcher_name matcher_sigma
                             -- See Note [Exported LocalIds] in GHC.CoreTypes.Id
...
GHC.HaskellToCore.Expression if you want to avoid difficult to decipher
core lint errors!
 -}
