...
module GHC.Haskell.TypeCheck.PatternSynonym
...
import GHC.Types.Type                   ( mkTyVarBinders, mkEmptyTCvSubst
...
import GHC.Haskell.TypeCheck.Syntax ( zonkTyVarBindersX, zonkTcTypeToTypes
  ...
  = addPatSynCtxt lname $
    do { let decl_arity = length arg_names
       ...
       ; let skol_info = SigSkol (PatSynCtxt name) pat_ty []
                         ...
                         -- See GHC.Haskell.TypeCheck.Types
