...
import GHC.CoreTypes.Name ( isSystemName )
...
-- See also Note [ExpType] in GHC.Haskell.TypeCheck.Util.Monadic
...
GHC.Haskell.TypeCheck.Solver.Interact, function @occ_check_ok@.
...
with "tc" in GHC.Haskell.TypeCheck.TypeDecl"). By this time,
