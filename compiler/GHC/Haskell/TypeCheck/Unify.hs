...
module GHC.Haskell.TypeCheck.Unify (
...
-- question. (See GHC.Haskell.TypeCheck.Expression.tcArgs.) This argument
...
-- See also Note [ExpType] in GHC.Haskell.TypeCheck.MutableType
...
* ir_inst = False: do not instantiate
  ...
  We'll call GHC.Haskell.TypeCheck.Expression.tcInferFun to infer the type
...
buildImplication skol_info skol_tvs given thing_inside
  = do { tc_lvl <- getTcLevel
      ...
      -- in GHC.Haskell.TypeCheck.Error.
         else
...
GHC.Haskell.TypeCheck.Constraint.Interact, function @occ_check_ok@.

Note [Non-TcTyVars in GHC.Haskell.TypeCheck.Unify]
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
with "tc" in GHC.Haskell.TypeCheck.TypeAndClassDeclaration"). By this time,
...
GHC.Haskell.TypeCheck.Unify.checkTauTvUpdate, which wants to prevent
