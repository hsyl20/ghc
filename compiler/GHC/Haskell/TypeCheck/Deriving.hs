...
module GHC.Haskell.TypeCheck.Deriving
   ( tcDeriving
   , DerivInfo(..)
   , mkDerivInfos
   )
...
import GHC.Haskell.TypeCheck.ClassDeclaration ( tcATDefault, tcMkDeclCtxt)
import GHC.Haskell.TypeCheck.Environment
import GHC.Haskell.Derive.BasicClasses         -- Deriv stuff
...
import GHC.Haskell.Rename.Binding
...
import GHC.Types.Type.Unify                             ( tcUnifyTy )
import GHC.Types.BasicTypes                       ( DerivStrategy(..) )
...
import qualified GHC.Types.Var.Free as FV
...
when the dict is constructed in GHC.Haskell.TypeCheck.Instance.tcInstDecl2
...
tcDeriving deriv_infos deriv_decls
  = recoverM (do { g <- getGblEnv
    ...
    do  {       -- Fish the "deriving"-related information out of the GHC.Haskell.TypeCheck.Environment
    ...
    do { traceTc "Standalone deriving decl for" (ppr deriv_ty)
       ...
       ; traceTc "Standalone deriving;" $ vcat
              ...
              , text "tys:" <+> ppr inst_tys ]
                -- C.f. GHC.Haskell.TypeCheck.Instance.tcLocalInstDecl1
...
GHC.Haskell.TypeCheck.Instance to handle the empty instance declaration
case).
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Much of the code in GHC.Haskell.TypeCheck.Deriving assumes that deriving
