...
import GHC.CoreTypes.Base         ( Warnings(..), plusWarns )
...
import GHC.Data.Bag
import GHC.CoreTypes.BasicTypes   ( DerivStrategy, RuleName, pprRuleName )
import GHC.Data.Maybe         ( orElse )
import GHC.Data.FastString
import GHC.CoreTypes.SrcLoc
import GHC.Config.Flags
import GHC.Util              ( debugIsOn, filterOut, lengthExceeds, partitionWith )
import GHC.CoreTypes.Base         ( HscEnv, hsc_dflags )
