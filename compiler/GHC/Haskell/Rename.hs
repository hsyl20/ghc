...
\section[GHC.Haskell.Rename]{Main pass of renamer}
-}
...
import GHC.Types.Base         ( Warnings(..), plusWarns )
import GHC.Types.Class        ( FunDep )
...
import GHC.Data.Bag
import GHC.Types.BasicTypes   ( DerivStrategy, RuleName, pprRuleName )
import GHC.Data.Maybe         ( orElse )
import GHC.Data.FastString
import GHC.Types.SrcLoc
import GHC.Config.Flags
import GHC.Utils              ( debugIsOn, filterOut, lengthExceeds, partitionWith )
import GHC.Types.Base         ( HscEnv, hsc_dflags )
...
rnHsVectDecl (HsVectTypeOut _ _ _)
  = panic "GHC.Haskell.Rename.rnHsVectDecl: Unexpected 'HsVectTypeOut'"
rnHsVectDecl (HsVectClassIn s cls)
  = do { cls' <- lookupLocatedOccRn cls
       ; return (HsVectClassIn s cls', unitFV (unLoc cls'))
       }
rnHsVectDecl (HsVectClassOut _)
  = panic "GHC.Haskell.Rename.rnHsVectDecl: Unexpected 'HsVectClassOut'"
...
rnHsVectDecl (HsVectInstOut _)
  = panic "GHC.Haskell.Rename.rnHsVectDecl: Unexpected 'HsVectInstOut'"
...
* Increase kind polymorphism.
  See GHC.Haskell.TypeCheck.TypeAndClassDeclaration
...
rnTyClDecl (ClassDecl { tcdCtxt = context, tcdLName = lcls,
  ...
  = do  { lcls' <- lookupLocatedTopBndrRn lcls
        ...
        -- GHC.Haskell.Rename.ImportExport.extendGlobalRdrEnvRn
        ...
        ; (mbinds', sigs', meth_fvs)
            <- rnMethodBinds True cls' (hsAllLTyVarNames tyvars') mbinds sigs
                ...
                -- since that is done by
                -- GHC.Haskell.Rename.ImportExport.extendGlobalRdrEnvRn and
...
add_bind _ (ValBindsOut {})     = panic "GHC.Haskell.Parser.Syntax:add_bind"

add_sig :: LSig a -> HsValBinds a -> HsValBinds a
add_sig s (ValBindsIn bs sigs) = ValBindsIn bs (s:sigs)
add_sig _ (ValBindsOut {})     = panic "GHC.Haskell.Parser.Syntax:add_sig"
