...
-}
module GHC.Haskell.Rename.Fixity
   ( MiniFixityEnv
   , addLocalFixities
...
import GHC.CoreTypes.BasicTypes ( Fixity(..), FixityDirection(..), minPrecedence
...
* Top-level fixity decls in this module may be for Names that are
  ...
  (See notes with GHC.Haskell.Rename.ImportExport.getLocalDeclBinders for
