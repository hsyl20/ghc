...
module GHC.Haskell.Rename.Type (
        -- Type related stuff
...
import GHC.Builtin.Types                    ( starKindTyConName
...
import GHC.Utils
import GHC.Types.BasicTypes ( compareFixity, funTyFixity, negateFixity
...
{-
These type renamers are in a separate module, rather than in (say) GHC.Haskell.Rename,
...
bindHsQTyVars :: forall a b.
              ...
              -> (LHsQTyVars GhcRn -> NameSet -> RnM (b, FreeVars))
                  ...
                  -- signatures] in GHC.Haskell.Syntax.Declaration
              -> RnM (b, FreeVars)
...
GHC.Haskell.Rename.ImportExport.getLocalNonValBinders), so we just take the
list as an argument, build a map and look them up.
-}

rnConDeclFields :: HsDocContext -> [FieldLabel] -> [LConDeclField GhcPs]
                -> RnM ([LConDeclField GhcRn], FreeVars)
-- Also called from GHC.Haskell.Rename
...
-- See GHC.Haskell.Rename.Expression.rnUnboundVar
...
See also Note [HsBSig binder lists] in GHC.Haskell.Syntax.Type
-}
