...
\section[GHC.Haskell.Rename.Bind]{Renaming and dependency analysis of bindings}
...
module GHC.Haskell.Rename.Bind (
...
import GHC.CoreTypes.RdrName     ( RdrName, rdrNameOcc )
import GHC.CoreTypes.SrcLoc
import GHC.Data.List.SetOps      ( findDupsEq )
import GHC.CoreTypes.BasicTypes  ( RecFlag(..) )
...
depAnalBinds binds_w_dus
  ...
  where
    sccs = depAnal (\(_, defs, _) -> defs)
                   ...
                   -- Note [depAnal determinism] in GHC.CoreTypes.Name.Environment.
