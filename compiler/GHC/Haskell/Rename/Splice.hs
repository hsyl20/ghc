...
module GHC.Haskell.Rename.Splice (
        rnTopSpliceDecls,
...
import GHC.Haskell.Rename.Type          ( rnLHsType )
...
[5] 'GHC.Haskell.TypeCheck.UserType.tc_hs_type' ('HsSpliceTy' ('HsSpliced' ...))
...
GHC.Haskell.Rename.Type.rnHsSigWcType
...
GHC.Haskell.Rename.Pattern, through the CpsRn monad. We don't wish to be in
...
GHC.Haskell.Rename.Pattern, in the CpsRn monad.
