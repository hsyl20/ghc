...
\section[GHC.Haskell.Rename.Expression]{Renaming of expressions}
...
module GHC.Haskell.Rename.Expression (
...
rnExpr (OpApp e1 op  _ e2)
  = do  { (e1', fv_e1) <- rnLExpr e1
        ...
        -- more, so I've removed the test.  Adding HsPars in
        -- GHC.Haskell.Derive.BasicClasses should prevent bad things
        -- happening.
        ; fixity <- case op' of
...
---------------------------------------------
--      Sections
-- See Note [Parsing sections] in GHC.Haskell.Parser
...
wired-in. See the Notes about the NameSorts in GHC.Types.Name
-}
...
rnCmd (HsCmdArrApp arrow arg _ ho rtl)
  ...
  where
    select_arrow_scope tc = case ho of
        ...
        -- See Note [Escaping the arrow scope] in GHC.Haskell.TypeCheck.Types
...
-- Neither is ArrowExpr, which has its own desugarer in
