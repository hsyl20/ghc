...
-- Functions over GHC.Haskell specialised to RdrName.

{-# LANGUAGE CPP #-}
{-# LANGUAGE FlexibleContexts #-}
{-# LANGUAGE TypeFamilies #-}

module GHC.Haskell.Parser.Syntax (
        mkHsOpApp,
...
import GHC.Types.TyCon  ( TyCon, isTupleTyCon
                                   , tyConSingleDataCon_maybe )
import GHC.Types.DataCon  ( DataCon, dataConTyCon )
import GHC.Types.ConLike  ( ConLike(..) )
import GHC.Types.Coercion.Axiom   ( Role, fsFromRole )
...
{- **********************************************************************
  ...
  #cvBinds-etc# Converting to @GHC.Haskell.Syntax.Binding@, etc.
...
has_args [] = panic "GHC.Haskell.Parser.Syntax:has_args"
...
mkInlinePragma src (inl, match_info) mb_act
  = InlinePragma { inl_src = src -- Note [Pragma source text] in
