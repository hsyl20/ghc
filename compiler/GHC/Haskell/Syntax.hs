...
module GHC.Haskell.Syntax (
        module GHC.Haskell.Syntax.Binding,
        module GHC.Haskell.Syntax.Declaration,
        module GHC.Haskell.Syntax.Expression,
        module GHC.Haskell.Syntax.ImportExport,
...
import GHC.Types.BasicTypes       ( Fixity, WarningTxt )
