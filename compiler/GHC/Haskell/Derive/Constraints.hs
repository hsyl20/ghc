...
module GHC.Haskell.Derive.Constraints
   ( inferConstraints
...
Specifically, we use GHC.Haskell.Derive.BasicClasses.box to box the Int#
...
simplifyInstanceContexts infer_specs
  ...
  where
    ...
    iterate_deriv n current_solns
      ...
      -- (See GHC.Haskell.TypeCheck.Constraint.Simplify.tcSimplifyDeriv.)
