...
(equivalent to the code in GHC.Haskell.Derive.BasicClasses, for other
classes)
-}
...
module GHC.Haskell.Derive.Generic
   ( canDoGenerics
   , canDoGenerics1
   , GenericKind(..)
   , gen_Generic_binds
...
import GHC.Types.FamilyInstance     ( FamInst, FamFlavor(..), mkSingleCoAxiom )
...
-- called by GHC.Haskell.Derive.inferConstraints; generates a list of types,
...
See Note [Unify kinds in deriving] in GHC.Haskell.Derive.
