...
import GHC.IR.Core.Analyser.FreeVars     ( exprsSomeFreeVarsList )
import GHC.IR.Core.Transformer.Simple    ( simpleOptPgm, simpleOptExpr )
...
import GHC.Entity.Coercion               ( mkCoVarCo )
...
import GHC.Entity.BasicTypes             ( Activation(.. ), competesWith
                                         , pprRuleName )
...
See GHC.Compiler.HaskellToCore.Expression.dsExplicitList.
...
See also Note [Getting the map/coerce RULE to work] in
