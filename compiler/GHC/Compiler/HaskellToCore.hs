...
import GHC.Entity.BasicTypes       ( Activation(.. ), competesWith, pprRuleName )
...
See also Note [Getting the map/coerce RULE to work] in GHC.IR.Core.Transformer.Substitution.
