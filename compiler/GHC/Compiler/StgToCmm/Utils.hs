...
module GHC.Compiler.StgToCmm.Utils (
        cgLit, mkSimpleLit,
...
import GHC.IR.Cmm.Syntax.Graph as MkGraph
...
import GHC.Entity.Unique.Supply (MonadUnique(..))
...
-- GHC.IR.Cmm.Syntax.Node. Right now the workaround is to avoid inlining across
...
baseRegOffset _      reg            =
   pprPanic "GHC.Compiler.StgToCmm.Utils.baseRegOffset:" (ppr reg)
