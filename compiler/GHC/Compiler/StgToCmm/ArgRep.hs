...
import GHC.Entity.TypeConstructor    ( PrimRep(..), primElemRepSizeB )
import GHC.Entity.BasicTypes         ( RepArity )
...
-- cyclic dependency between GHC.Compiler.StgToCmm.Layout and
-- GHC.Compiler.StgToCmm.Profiling.Ticky.
--
-- NSF 18 Feb 2013
