...
module GHC.Compiler.StgToCmm.Closure (
...
import GHC.IR.Cmm.Printer.Expression()
...
-- GHC.Compiler.StgToCmm.Monad, but we define them here because some functions
-- in this module need to have access to them as well
...
-- See Note [Post-unarisation invariants] in GHC.IR.Stg.Transformer.Unariser.
...
in GHC.IR.Haskell.Deriver.BasicClasses.) -}
...
getCallMethod dflags _ id _ n_args v_args _cg_loc
  ...
  -- self-recursive tail calls] in GHC.Compiler.StgToCmm.Expression for more details
