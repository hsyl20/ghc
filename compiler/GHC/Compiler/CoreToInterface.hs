...
import GHC.Entity.Id.Make          ( noinlineIdName )
...
import GHC.Entity.Demand           ( isTopSig )
...
toIfaceIdInfo id_info
  = case catMaybes [arity_hsinfo, caf_hsinfo, strict_hsinfo,
       ...
       infos -> HasInfo infos
               ...
               -- See GHC.IR.Interface.TypeChecker.tcUnfolding
  where
    ------------  Arity  --------------
...
toIfUnfolding lb (CoreUnfolding { uf_tmpl = rhs
  ...
  = Just $ HsUnfold lb $
    case src of
        ...
        -- GHC.IR.Interface.Transformer.Tidier would have stuck in NoUnfolding.
        -- For supercompilation we want to see that unfolding!
  where
