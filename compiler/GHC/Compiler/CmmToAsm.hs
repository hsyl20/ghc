...
import GHC.Cmm.ConstantFolder ( cmmMachOpFold )
...
import GHC.Types.BasicTypes       ( Alignment )
...
module.  Before entering machine-dependent land, we do some machine-independent
optimisations (defined below) on the 'CmmStmts's.
...
data NcgImpl statics instr jumpDest = NcgImpl {
    ...
    -- See Note [What is this unwinding business?] in
...
data NativeGenAcc statics instr
  = NGS { ngs_imports     :: ![[CLabel]]
        ...
        , ngs_unwinds     :: !(LabelMap [UnwindPoint])
             ...
             -- and Note [What is this unwinding business?] in
             -- GHC.Cmm.Syntax.DebugBlock.
        }
...
See also Note [What is this unwinding business?] in GHC.Cmm.Syntax.DebugBlock
-}
...
x86fp_kludge :: NatCmmDecl (Alignment, CmmStatics) X86.Instr
