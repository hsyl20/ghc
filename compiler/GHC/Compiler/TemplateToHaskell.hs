...
import qualified GHC.Entity.Class as Class
import GHC.Entity.RdrName
import qualified GHC.Entity.Name as Name
import GHC.Entity.Module
import GHC.IR.Haskell.Parser.Syntax
import qualified GHC.Entity.OccName as OccName
...
import GHC.Entity.BasicTypes as Hs
...
cvtDec (ClassD ctxt cl tvs fds decs)
  ...
  where
    ...
    -- Very similar to what happens in GHC.IR.Haskell.Parser.Syntax.mkClassDecl
    cvt_at_def decl = case GHC.IR.Haskell.Parser.Syntax.mkATDefault decl of
...
cvtForD (ImportF callconv safety from nm ty)
  ...
  -- and are inserted verbatim, analogous to mkImport in GHC.IR.Haskell.Parser.Syntax
...
specially in GHC.Compiler.HaskellToCore.Splices,
GHC.Compiler.TemplateToHaskell, and GHC.IR.Haskell.TypeChecker.Splice:

   (a) When desugaring a pattern synonym from GHC.IR.Haskell to TH.Dec in
       GHC.Compiler.HaskellToCore.Splices, we represent its *full* type
       signature in TH, i.e.:
   ...
   (c) When reifying a pattern synonym in `GHC.IR.Haskell.TypeChecker.Splice`,
