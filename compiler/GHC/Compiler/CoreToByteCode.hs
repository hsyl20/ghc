...
import GHC.Types.Kind              ( isLiftedTypeKind )
...
import GHC.Compiler.StgToCmm.Closure ( NonVoid(..), fromNonVoid, nonVoidIds )
...
maybe_is_tagToEnum_call app
  ...
  where
    extract_constr_Names ty
           ...
           -- the DataCon.  See GHC.Types.DataCon for details.
           | otherwise
