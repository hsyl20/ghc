...
import GHC.Types.CostCentre      ( noCCS )
import GHC.Types.Var.Environment
import GHC.Types.Module
import GHC.Types.Name            ( isExternalName, nameOccName )
import GHC.Types.OccName         ( occNameFS )
  ...
  where
    vars_alt (con, binders, rhs)
      ...
      = -- This case is a bit smelly.
        -- See Note [Nullary unboxed tuple] in GHC.Types.Type
