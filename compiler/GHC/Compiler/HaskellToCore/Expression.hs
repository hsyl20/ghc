...
dsLExpr (L loc e)
  = putSrcSpanDs loc $
   ...
   -- uncomment this check to test the hsExprType function in GHC.IR.Haskell.TypeChecker.Syntax
    ...
    mk_alt upd_fld_env con
      = do { let (univ_tvs, ex_tvs, eq_spec,
           ...
           ; let field_labels = conLikeFieldLabels con
                 ...
                 -- The order here is because of the order in `GHC.IR.Haskell.TypeChecker.PatternSynonym`.
