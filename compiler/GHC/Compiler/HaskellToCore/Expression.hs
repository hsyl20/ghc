...
import GHC.Types.FamilyInstance( topNormaliseType )
import GHC.Compiler.HaskellToCore.Splice
...
ds_val_bind (is_rec, binds) body
  = do  { MASSERT( isRec is_rec || isSingletonBag binds )
        ...
        -- See notes with GHC.Haskell.TypeCheck.Constraint.Simplify.inferLoop [NO TYVARS]
