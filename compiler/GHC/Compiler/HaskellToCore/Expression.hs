...
module GHC.Compiler.HaskellToCore.Expression
   ( dsExpr
   , dsLExpr
   , dsLExprNoLP
   , dsLocalBinds
...
import GHC.Entity.FamilyInstance( topNormaliseType )
...
ds_val_bind (is_rec, binds) body
  = do  { MASSERT( isRec is_rec || isSingletonBag binds )
        ...
        -- See notes with GHC.IR.Haskell.TypeChecker.Constraint.Simplifier.inferLoop [NO TYVARS]
...
{-
Desugar 'do' and 'mdo' expressions (NOT list comprehensions, they're handled in
GHC.Compiler.HaskellToCore.ListComp).  Basically does the translation given in
