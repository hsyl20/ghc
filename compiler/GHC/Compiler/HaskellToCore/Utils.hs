...
import GHC.Haskell.TypeCheck.Type( tcSplitTyConApp )
...
In fact, even GHC.Core.Substitution.simplOptExpr will do this,
...
mkPatSynCase var ty alt fail = do
  ...
  where
    ...
    -- See Note [Matchers and builders for pattern synonyms] in
    -- GHC.Types.PatternSynonym on these extra Void# arguments
...
mkCoreAppDs s fun arg = mkCoreApp s fun arg
                        -- The rest is done in GHC.Core.Syntax.Make
