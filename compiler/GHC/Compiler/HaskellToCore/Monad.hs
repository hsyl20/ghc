...
import GHC.Haskell.TypeCheck.MutableType ( checkForLevPolyX
                                              , formatLevPolyErr )
...
import GHC.Data.UniqueFM ( lookupWithDefaultUFM )
...
--
-- c.f. GHC.Haskell.TypeCheck.askNoErrs
...
-- Very like GHC.Haskell.TypeCheck.Environment.tcLookupGlobal
dsLookupGlobal name
  = do  { env <- getGblEnv
