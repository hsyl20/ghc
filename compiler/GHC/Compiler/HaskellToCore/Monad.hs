...
@GHC.Compiler.HaskellToCore.Monad@: monadery used in desugaring
-}

{-# LANGUAGE FlexibleInstances, FlexibleContexts #-}
{-# OPTIONS_GHC -fno-warn-orphans #-}  -- instance MonadThings is necessarily an orphan

module GHC.Compiler.HaskellToCore.Monad (
...
import GHC.IR.Haskell.TypeChecker.MutableType ( checkForLevPolyX, formatLevPolyErr )
...
import GHC.Entity.Var (EvVar)
import qualified GHC.LanguageExtensions as LangExt
import GHC.Entity.Unique.FiniteMap ( lookupWithDefaultUFM )
...
mkDsEnvs dflags mod rdr_env type_env fam_inst_env msg_var pmvar
  ...
  = let if_genv = IfGblEnv { if_doc       = text "mkDsEnvs",
        ...
        gbl_env = DsGblEnv { ds_mod     = mod
                           ...
                           , ds_parr_bi = panic "GHC.Compiler.HaskellToCore.Monad: uninitialised ds_parr_bi"
...
of cases; see calls to GHC.Compiler.HaskellToCore.Monad.dsNoLevPoly and friends.
...
but we can't, because of the fixM in GHC.Compiler.HaskellToCore.Arrow. It's all OK, though:
...
-- of the fixM used in GHC.Compiler.HaskellToCore.Arrow. See Note [Levity polymorphism checking]
...
--
-- c.f. GHC.IR.Haskell.TypeChecker.askNoErrs
...
dsLoadModule doc mod
  = do { env    <- getGblEnv
       ...
       ; case iface of
           Failed err      -> pprPanic "GHC.Compiler.HaskellToCore.Monad.dsLoadModule: failed to load" (err $$ doc)
...
-- Very like GHC.IR.Haskell.TypeChecker.Environment.tcLookupGlobal
dsLookupGlobal name
  = do  { env <- getGblEnv
