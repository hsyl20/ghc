...
import GHC.Types.Coercion             ( eqCoercion )
import GHC.Haskell.TypeCheck.Type ( toTcTypeBag )
import GHC.Types.TyCon      ( isNewTyCon )
...
import GHC.Types.BasicTypes           ( isGenerated, il_value, fl_value )
...
See also Note [Case elimination: lifted case] in
GHC.Core.Simplify.
...
--            GHC.Haskell types in the recursion
--
