...
module GHC.Compiler.HaskellToCore.Match.TermEqOracle (

        -- re-exported from GHC.Compiler.HaskellToCore.Match.Expression
...
extendSubstAndSolve x e (standby, (unhandled, env))
  ...
  where
    ...
    -- See Note [Representation of Term Equalities] in
    -- GHC.Compiler.HaskellToCore.Match.Check
