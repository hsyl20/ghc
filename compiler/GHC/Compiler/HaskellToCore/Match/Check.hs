...
import GHC.Types.Type.Unify( tcMatchTy )
...
import GHC.Builtin.Primitive.Types (tYPETyCon)
...
import GHC.Types.Base (CompleteMatch(..))

import GHC.Compiler.HaskellToCore.Monad
import GHC.Haskell.TypeCheck.Constraint.Simplify (tcCheckSatisfiability)
import GHC.Haskell.TypeCheck.Type (toTcType, isStringTy, isIntTy, isWordTy)
import GHC.Data.Bag
...
1. We normalise the outermost type family redex, data family redex or newtype,
   using pmTopNormaliseType_maybe (in GHC.Types.FamilyInstance). This computes 3
   things:
...
in GHC.Compiler.HaskellToCore.Match.Expression.
