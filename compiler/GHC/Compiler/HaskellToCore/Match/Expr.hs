...
module GHC.Compiler.HaskellToCore.Match.Expr (
...
impact of this is the following:
  ...
  * We have instant equality check for overloaded literals (we do not rely on
    ...
    `uncovered` and `divergent` in GHC.Compiler.HaskellToCore.Match.Check and
    effectively addresses #11161.
...
-- GHC.Compiler.HaskellToCore.Monad:397:dsLookupDataCon :: Name -> DsM DataCon
--
...
GHC.Compiler.HaskellToCore.Match.Check) to be more precice.
-}
