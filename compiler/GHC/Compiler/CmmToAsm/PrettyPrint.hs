...
module GHC.Compiler.CmmToAsm.PrettyPrint (
...
pprGNUSectionHeader t suffix = sdocWithDynFlags $ \dflags ->
  ...
  where
    header dflags = case t of
      ...
      OtherSection _ ->
        panic "GHC.Compiler.CmmToAsm.PrettyPrint.pprGNUSectionHeader: unknown section type"
...
pprXcoffSectionHeader t = text $ case t of
     ...
     OtherSection _          ->
       panic "GHC.Compiler.CmmToAsm.PrettyPrint.pprXcoffSectionHeader: unknown section type"
...
pprDarwinSectionHeader t =
  ptext $ case t of
     ...
     OtherSection _ ->
       panic "GHC.Compiler.CmmToAsm.PrettyPrint.pprDarwinSectionHeader: unknown section type"
