...
releaseReg _ _
        = panic "GHC.Compiler.CmmToAsm.Register.Allocator.Linear.X86.FreeRegs.releaseReg: no reg"
...
allocateReg _ _
        = panic "GHC.Compiler.CmmToAsm.Register.Allocator.Linear.X86.FreeRegs.allocateReg: no reg"
