...
--   See GHC.Compiler.CmmToAsm.Register.Allocator.Graph.TrivColorable for the
--   actual trivColorable function used in GHC.
--
module GHC.Compiler.CmmToAsm.Register.Allocator.Graph.ArchX86 (
        classOfReg,
        regsOfClass,
        regName,
        regAlias,
...
import GHC.Compiler.CmmToAsm.Register.Allocator.Graph.ArchBase  (Reg(..), RegSub(..), RegClass(..))
