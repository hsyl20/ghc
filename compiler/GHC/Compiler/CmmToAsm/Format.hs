...
--              GHC.Compiler.CmmToAsm.Monad need to know about it to make a
--              VReg. It would be better to have architecture specific formats,
--              and do the overloading properly. eg SPARC doesn't care about
--              FF80.
--
