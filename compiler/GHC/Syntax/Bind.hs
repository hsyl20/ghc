...
data HsBindLR idL idR
  = -- | Function-like Binding
    ...
    --           'GHC.TypeCheck.Bind.tcMonoBinds'.
    --
  ...
  | AbsBinds {                      -- Binds abstraction; TRANSLATION
       ...
       -- to have the right type
        ...
        -- | Evidence bindings
        -- Why a list? See GHC.TypeCheck.Instance
...
variables.  The action happens in GHC.TypeCheck.Bind.mkExport.
...
a) Dependency analysis prior to type checking
    (see GHC.TypeCheck.Bind.tc_group)

b) Deciding whether we can do generalisation of the binding
    (see GHC.TypeCheck.Bind.decideGeneralisationPlan)

c) Deciding whether the binding can be used in static forms
    (see GHC.TypeCheck.Expression.checkClosedInStaticForm for the
    HsStatic case and GHC.TypeCheck.Bind.isClosedBndrGroup).
...
plusHsValBinds _ _
  = panic "GHC.Syntax.Bind.plusHsValBinds"
...
data Sig pass
  =   -- | An ordinary type signature
      ...
      -- For details on above see note [Api annotations] in GHC.Syntax.Annotation
    TypeSig
