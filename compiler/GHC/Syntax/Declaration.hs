...
import {-# SOURCE #-} GHC.Syntax.Expression
...
~~~~~~~~~~~~~~~
 ...
 - If there is a default method name at all, it's recorded in
   the ClassOpSig (in GHC.Syntax.Bind), in the DefMethInfo field.
...
GHC.TypeCheck.Instance.tcInstDecls1).  So we can't generate the
