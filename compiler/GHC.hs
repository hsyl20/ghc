...
module GHC (
        ...
        GHC.Interactive.Eval.compileExpr, dynCompileExpr,
        ForeignHValue,
        ...
        GHC.Interactive.Eval.back,
        GHC.Interactive.Eval.forward,
...
import GHC.IR.Haskell.TypeChecker.Module   ( runTcInteractive )
...
import GHC.Monad
import GHC.IR.Haskell.TypeChecker          ( finalSafeMode, fixSafeInstances )
import GHC.IR.Haskell.TypeChecker.Types
import GHC.Packages
import GHC.Entity.Name.Set
import GHC.Entity.RdrName
import GHC.IR.Haskell.Syntax
import GHC.Entity.Type                 hiding( typeKind )
import GHC.IR.Haskell.TypeChecker.Type hiding( typeKind )
...
import GHC.Entity.FamilyInstance           ( famInstEnvElts )
...
{- ToDo: Move the primary logic here to GHC.Packages
...
-- ToDo:
--   - Data and Typeable instances for GHC.IR.Haskell.
...
-- Throws a 'GHC.Entity.Types.SourceError' on parse error.
...
getHistorySpan h = withSession $ \hsc_env ->
    return $ GHC.Interactive.Eval.getHistorySpan hsc_env h

obtainTermFromVal :: GhcMonad m => Int ->  Bool -> Type -> a -> m Term
obtainTermFromVal bound force ty a = withSession $ \hsc_env ->
    liftIO $ GHC.Interactive.Eval.obtainTermFromVal hsc_env bound force ty a

obtainTermFromId :: GhcMonad m => Int -> Bool -> Id -> m Term
obtainTermFromId bound force id = withSession $ \hsc_env ->
    liftIO $ GHC.Interactive.Eval.obtainTermFromId hsc_env bound force id
