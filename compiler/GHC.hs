...
{-
  ...
  * inline bits of GHC.Driver.Main here to simplify layering: hscTcExpr,
    hscStmt.
-}
...
import GHC.Monad
import GHC.Haskell.TypeCheck          ( finalSafeMode, fixSafeInstances )
import GHC.Haskell.TypeCheck.Types
import GHC.Packages
import GHC.Types.Name.Set
import GHC.Types.RdrName
import GHC.Haskell.Syntax
import GHC.Types.Type                 hiding( typeKind )
import GHC.Haskell.TypeCheck.Type hiding( typeKind )
import GHC.Types.Id
...
import GHC.Types.FamilyInstance           ( famInstEnvElts )
...
-- ToDo:
--   - Data and Typeable instances for GHC.Haskell.

-- ToDo: check for small transformations that happen to the syntax in
-- the typechecker (eg. -e ==> negate e, perhaps for fromIntegral)

-- ToDo: maybe use TH syntax instead of GHC.Interface.Syntax?  There's
-- already a way to get from TyCons, Ids etc. to TH syntax (reify).
...
-- Throws a 'GHC.Types.Base.SourceError' on parse error.
