...
data HsWrapper
  ...
  | WpFun HsWrapper HsWrapper TcType SDoc
       ...
       -- the desugarer. See Note [Levity polymorphism checking] in GHC.Compilers.SyntaxToCore.Monad
...
- An EvCallStack term desugars to a CoreExpr of type `IP "some str" CallStack`.
  ...
  call-site onto a given stack (See GHC.Compilers.SyntaxToCore.Binding.dsEvCallStack)
