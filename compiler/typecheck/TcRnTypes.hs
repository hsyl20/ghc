...
-- in GHC.IR.Haskell.Renamer.Main
...
data TcIdSigInfo   -- See Note [Complete and partial type signatures]
  ...
  | PartialSig     -- A partial type signature (i.e. includes one or more
      ...
      , psig_hs_ty :: LHsSigWcType Name  -- The original partial signature in GHC.IR.Haskell form
...
data TcPatSynInfo
  = TPSI {
        ...
        patsig_implicit_bndrs :: [TyVarBinder], -- Implicitly-bound kind vars (Inferred) and
          ...
          -- See Note [The pattern-synonym signature splitting rule] in GHC.IR.Haskell.TypeSystem.PatternSynonym
