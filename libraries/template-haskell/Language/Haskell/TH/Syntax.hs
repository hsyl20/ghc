...
-- GHC.Compiler.HaskellToCore.Splices when desugaring brackets.
...
-- Used in GHC.IR.Haskell.TypeChecker.Expression to short-circuit the lifting
-- for strings
...
But if the original GHC.IR.Haskell used prefix application, we won't use
