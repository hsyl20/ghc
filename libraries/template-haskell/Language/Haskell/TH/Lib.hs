...
-- must be defined here for GHC.Compiler.HaskellToCore.Splices to find it
type Role                = TH.Role
...
--   GHC.Compiler.HaskellToCore.Splices, GHC.Compiler.TemplateToHaskell,
--   GHC.IR.Haskell.TypeChecker.Splice (follows from 3)
