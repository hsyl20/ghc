 ...
 * BuiltInRules in GHC.IR.Core.Transform.ConstantFolding.hs; e.g.
...
* the rules in GHC.IR.Core.Transform.ConstantFolding will fire when the string is let-bound.
  E.g. the eqString rule in GHC.IR.Core.Transform.ConstantFolding
...
-- It also has a BuiltInRule in GHC.IR.Core.Transform.ConstantFolding.hs:
