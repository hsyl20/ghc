 ...
 * BuiltInRules in GHC.IR.Core.Transformer.ConstantFolder.hs; e.g.
...
* the rules in GHC.IR.Core.Transformer.ConstantFolder will fire when the string
  is let-bound.
  E.g. the eqString rule in GHC.IR.Core.Transformer.ConstantFolder
...
-- It also has a BuiltInRule in GHC.IR.Core.Transformer.ConstantFolder.hs:
