...
necessary. See [FFI type roles] in GHC.IR.Haskell.TypeSystem.Foreign.  -}
...
-- 'TypeRep'.  See Note [Representing TyCon kinds: KindRep] in GHC.IR.Haskell.TypeSystem.Deriving.Typeable.
