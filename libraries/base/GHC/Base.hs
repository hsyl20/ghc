...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
The Integer type is special because GHC.IR.Inteface.Transformer.Tidier uses
...
-- eqString also has a BuiltInRule in GHC.IR.Core.Transformer.ConstantFolder:
...
-- There's a built-in rule (in GHC.IR.Core.Transformer.ConstantFolder) for
