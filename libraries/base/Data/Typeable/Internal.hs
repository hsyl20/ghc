...
-- it is extremely important that this fingerprint computation remains in sync
-- with that in GHC.IR.Haskell.Deriver.Typeable to ensure that type equality is
-- correct.
...
-- GHC.IR.Haskell.Deriver.Typeable.mkTyConRepTyConRHS.
